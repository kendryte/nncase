...
class Compiler:
    ...
    def __process_compile_options(self, compile_options: CompileOptions) -> ClCompileOptions:
        ...
        self._compile_options.dump_flags = _nncase.DumpFlags.Nothing if not compile_options.dump_ir else _nncase.DumpFlags(int(_nncase.DumpFlags.Rewrite) | int(_nncase.DumpFlags.EGraphCost) | int(_nncase.DumpFlags.PassIR))
