...
class RefPagedAttentionScheduler:
    def __init__(self, arg0: PagedAttentionConfig, arg1: int, arg2: int, arg3: list[int]) -> None: ...
    def schedule(self, arg0: list[int], arg1: list[int]) -> RefPagedAttentionKVCache: ...
