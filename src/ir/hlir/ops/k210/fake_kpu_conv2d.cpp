...
void fake_kpu_conv2d::compile(hlir_compile_context &context)
{
    auto l_c = context.graph.emplace<llir::k210::fake_kpu_conv2d>(input().shape(), is_depthwise(), filter_type(), pool_type(), weights(), bias(), fused_activation());
