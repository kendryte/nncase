...
void resize_image::compile(hlir_compile_context &context)
{
    auto l_c = context.graph.emplace<llir::resize_image>(input().type(), mode(), input().shape(), new_size(), align_corners());
