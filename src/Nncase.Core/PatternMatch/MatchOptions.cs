...
public class MatchOptions
{
    ...
    public MatchOptions()
    {
        SuppressedPatterns = new Dictionary<BaseExpr, HashSet<IPattern>>(ReferenceEqualityComparer.Instance);
    }

    /// <summary>
    /// Gets suppressed patterns.
    /// </summary>
    public Dictionary<BaseExpr, HashSet<IPattern>> SuppressedPatterns { get; }

    /// <summary>
    /// check the expr and pattern in the suppressed pattern dict.
    /// </summary>
    public bool IsSuppressedPattern(BaseExpr expr, IPattern pattern)
    {
    ...
    /// </summary>
    public void SuppressPattern(BaseExpr expr, IPattern pattern)
    {
        if (!SuppressedPatterns.TryGetValue(expr, out var patterns))
        {
    ...
    /// </summary>
    public void InheritSuppressPatterns(BaseExpr source, BaseExpr dest)
    {
