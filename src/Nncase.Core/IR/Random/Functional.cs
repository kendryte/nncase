...
public static class Random
{
    ...
    public static Call Normal(DataType type, Expr mean, Expr scale, Expr seed, Shape shape) =>
        new Call(new Normal(type), mean, scale, seed, shape);

    public static Call Normal(DataType type, Shape shape) => Normal(type, 0, 1, Rand.Next(1, 1000), shape);

    public static Call Normal(Shape shape) => Normal(DataTypes.Float32, shape);
    ...
    public static Call Uniform(DataType type, Expr high, Expr low, Expr seed, Shape shape) =>
