...
public static class NN
{
    ...
    public static Expr Qwen3MoE(Expr q, Expr moeGateW, Expr moeExpertGateProjW, Expr moeExpertGateProjScale, Expr moeExpertDownProjW, Expr moeExpertDownProjScale, Expr moeExpertUpProjW, Expr moeExpertUpProjScale, long layerId, long hiddenSize, long intermediateSize, long moeIntermediateSize, long numExpert, long numTopK, bool isNormTopkProb) => new Call(new Qwen3MoE(layerId, hiddenSize, intermediateSize, moeIntermediateSize, numExpert, numTopK, isNormTopkProb), q, moeGateW, moeExpertGateProjW, moeExpertGateProjScale, moeExpertDownProjW, moeExpertDownProjScale, moeExpertUpProjW, moeExpertUpProjScale);
}
