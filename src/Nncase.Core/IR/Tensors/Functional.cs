...
public static class Tensors
{
    ...
    public static Call Cast(Expr input, DataType newType, CastMode castMode = CastMode.KDefault, IRArray<int> vectorizeAxes = default, Expr? postOps = null) =>
        new Call(new Cast(newType, castMode, vectorizeAxes), input, postOps ?? None.Default);
