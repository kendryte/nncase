...
namespace Nncase.TIR
{
    ...
    public sealed record LetStmt(Var Var, Expr Value, Stmt Body) : Stmt
    {
    ...
    public sealed record SeqStmtNode(IRArray<Stmt> Seq) : Stmt
    {
    ...
    public sealed record Evaluate(Expr Value) : Stmt { }
    ...
    public sealed record For(Var LoopVar, Expr Min, Expr Extent, ForMode Kind, Stmt Body, IterVar? ThreadBinding = null) : Stmt
    {
