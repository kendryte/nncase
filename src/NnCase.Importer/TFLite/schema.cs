...
#if ENABLE_SPAN_T
  public Span<byte> GetCustomSpan() { return __p.__vector_as_span<byte>(4); }
#else
...
#if ENABLE_SPAN_T
  public Span<float> GetMinSpan() { return __p.__vector_as_span<float>(4); }
#else
...
#if ENABLE_SPAN_T
  public Span<float> GetMaxSpan() { return __p.__vector_as_span<float>(6); }
#else
...
#if ENABLE_SPAN_T
  public Span<float> GetScaleSpan() { return __p.__vector_as_span<float>(8); }
#else
...
#if ENABLE_SPAN_T
  public Span<long> GetZeroPointSpan() { return __p.__vector_as_span<long>(10); }
#else
...
#if ENABLE_SPAN_T
  public Span<int> GetShapeSpan() { return __p.__vector_as_span<int>(4); }
#else
...
#if ENABLE_SPAN_T
  public Span<byte> GetNameSpan() { return __p.__vector_as_span<byte>(10); }
#else
...
#if ENABLE_SPAN_T
  public Span<int> GetNumColumnsPerChannelSpan() { return __p.__vector_as_span<int>(6); }
#else
...
#if ENABLE_SPAN_T
  public Span<int> GetEmbeddingDimPerChannelSpan() { return __p.__vector_as_span<int>(8); }
#else
...
#if ENABLE_SPAN_T
  public Span<int> GetNewShapeSpan() { return __p.__vector_as_span<int>(4); }
#else
...
#if ENABLE_SPAN_T
  public Span<int> GetSqueezeDimsSpan() { return __p.__vector_as_span<int>(4); }
#else
...
#if ENABLE_SPAN_T
  public Span<byte> GetCustomCodeSpan() { return __p.__vector_as_span<byte>(6); }
#else
...
#if ENABLE_SPAN_T
  public Span<int> GetInputsSpan() { return __p.__vector_as_span<int>(6); }
#else
...
#if ENABLE_SPAN_T
  public Span<int> GetOutputsSpan() { return __p.__vector_as_span<int>(8); }
#else
...
#if ENABLE_SPAN_T
  public Span<byte> GetCustomOptionsSpan() { return __p.__vector_as_span<byte>(14); }
#else
...
#if ENABLE_SPAN_T
  public Span<bool> GetMutatingVariableInputsSpan() { return __p.__vector_as_span<bool>(18); }
#else
...
#if ENABLE_SPAN_T
  public Span<byte> GetNameSpan() { return __p.__vector_as_span<byte>(12); }
#else
...
#if ENABLE_SPAN_T
  public Span<byte> GetDataSpan() { return __p.__vector_as_span<byte>(4); }
#else
...
#if ENABLE_SPAN_T
  public Span<byte> GetDescriptionSpan() { return __p.__vector_as_span<byte>(10); }
#else
...
#if ENABLE_SPAN_T
  public Span<int> GetMetadataBufferSpan() { return __p.__vector_as_span<int>(14); }
#else
