...
public class GraphConvertor : ExprVisitor<Vertex, Unit, GraphContext>
{
    ...
    protected override Vertex VisitLeafBaseFunction(BaseFunction expr, GraphContext context) => null!;

    protected override Vertex VisitLeafOp(Op expr, GraphContext context) => null!;
    ...
    protected override Vertex DefaultVisitLeaf(Expr expr, GraphContext context)
    {
        ...
        foreach (var operand in expr.Operands)
        {
            ...
            {
                context.Graph.AddEdge(new Edge(source, target));
            }
        }
