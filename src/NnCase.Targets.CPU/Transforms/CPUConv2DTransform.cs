...
{
    public class CPUConv2DTransform : Transform
    {
        ...
        public override void Process(TransformContext context)
        {
            ...
            var conv2d = context.Graph.AddNode(new CPUConv2D(preTp.Output.Shape, newWeights, oldConv2D.Bias, oldConv2D.PaddingH, oldConv2D.PaddingW, oldConv2D.StrideH, oldConv2D.StrideW, oldConv2D.DilationH, oldConv2D.DilationW, oldConv2D.FusedActivation));
