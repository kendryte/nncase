...
{
    public class CPUQuantizedDepthwiseConv2D : Node
    {
        ...
        public CPUQuantizedDepthwiseConv2D(Shape inputShape, DenseTensor<byte> weights, DenseTensor<int> bias, Padding paddingH, Padding paddingW, int strideH, int strideW, int dilationH, int dilationW, int inputOffset, int filterOffset, int outputMul, int outputShift, int outputOffset)
        {
            Weights = weights;
            Bias = bias;
            PaddingH = paddingH;
