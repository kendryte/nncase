...
public partial class CompileOptionViewModel : ViewModelBase
{
    ...
    [ObservableProperty] private string _dumpDir;

    // 带有参数的正则验证？？？
    [ObservableProperty] private bool _preprocess;

    [ObservableProperty] private bool _quantize = true;

    [ObservableProperty] private string _inputFormat;
