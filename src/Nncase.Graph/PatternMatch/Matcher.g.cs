...
internal partial class Matcher
{
    ...
    {
        if (pattern is ConstPattern exprPattern)
        {
            return exprPattern.MatchLeaf(expr)
            ;
        }
    ...
    /// <inheritdoc/>
    protected override bool VisitDimension(Dimension expr, IPattern pattern)
    {
        if (pattern is DimensionPattern exprPattern)
        {
            return exprPattern.MatchLeaf(expr)
            ;
        }
