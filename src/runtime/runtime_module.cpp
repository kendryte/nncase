...
result<void> runtime_module::initialize_before_functions(runtime_module_init_context &context) noexcept
{
    return ok();
}

result<void> runtime_module::initialize_after_functions(runtime_module_init_context &context) noexcept
{
    return ok();
}
