...
bool runtime_tensor_impl::can_copy_to_without_staging(const runtime_tensor &dest) const noexcept
{
    if (dest.empty()
...
bool runtime_tensor_impl::can_copy_from_different_type(NNCASE_UNUSED const runtime_tensor_impl &src) const noexcept
{
    return false;
}

bool runtime_tensor_impl::can_copy_to_different_type(NNCASE_UNUSED const runtime_tensor_impl &dest) const noexcept
{
    return false;
}

result<void> runtime_tensor_impl::copy_to_same_type(NNCASE_UNUSED runtime_tensor_impl &dest) noexcept
{
    return err(std::errc::not_supported);
}

result<void> runtime_tensor_impl::copy_from_different_type(NNCASE_UNUSED runtime_tensor_impl &src) noexcept
{
    return err(std::errc::not_supported);
}

result<void> runtime_tensor_impl::copy_to_different_type(NNCASE_UNUSED runtime_tensor_impl &dest) noexcept
{
    return err(std::errc::not_supported);
}

result<void> runtime_tensor_impl::copy_from_host(NNCASE_UNUSED runtime_tensor_impl &src) noexcept
{
    return err(std::errc::not_supported);
}

result<void> runtime_tensor_impl::copy_to_host(NNCASE_UNUSED runtime_tensor_impl &dest) noexcept
{
    return err(std::errc::not_supported);
}
