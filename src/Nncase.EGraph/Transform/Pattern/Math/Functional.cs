...
namespace Nncase.Transform.Pattern.F
{
    ...
    public static class Math
    {
        ...
        {
            return new CallPattern(new ClampPattern(), min, max);
        }
        ...
        public static CallPattern Clamp<T>(ExprPattern input, ValueRange<T> range)
            where T : unmanaged
        {
            return new CallPattern(new ClampPattern(), new ConstPattern(Const.FromScalar(range.Min)), new ConstPattern(Const.FromScalar(range.Max)));
        }
