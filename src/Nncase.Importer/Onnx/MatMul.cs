    ...
    public partial class OnnxImporter
    {
        private Expr VisitMatMul(in NodeProto op)
        {
            ...
            else if (a.Metadata.OutputNames![0] == "/mlp_21/Mul_output_0")
            {
                ...
                var c_a = F.Tensors.Slice(a, new int[] { 568 }, new int[] { 3435 }, new int[] { 2 }, new int[] { 1 });
                var d_a = F.Tensors.Slice(a, new int[] { 3435 }, new int[] { 3436 }, new int[] { 2 }, new int[] { 1 });
                var e_a = F.Tensors.Slice(a, new int[] { 3436 }, new int[] { 3486 }, new int[] { 2 }, new int[] { 1 });
                var f_a = F.Tensors.Slice(a, new int[] { 3486 }, new int[] { 3487 }, new int[] { 2 }, new int[] { 1 });
                var g_a = F.Tensors.Slice(a, new int[] { 3487 }, new int[] { -1 }, new int[] { 2 }, new int[] { 1 });
                ...
                var c_b = F.Tensors.Slice(b, new int[] { 568 }, new int[] { 3435 }, new int[] { 0 }, new int[] { 1 });
                var d_b = F.Tensors.Slice(b, new int[] { 3435 }, new int[] { 3436 }, new int[] { 0 }, new int[] { 1 });
                var e_b = F.Tensors.Slice(b, new int[] { 3436 }, new int[] { 3486 }, new int[] { 0 }, new int[] { 1 });
                var f_b = F.Tensors.Slice(b, new int[] { 3486 }, new int[] { 3487 }, new int[] { 0 }, new int[] { 1 });
                var g_b = F.Tensors.Slice(b, new int[] { 3487 }, new int[] { -1 }, new int[] { 0 }, new int[] { 1 });
                ...
                return F.Math.Add(new_a, F.Math.Add(F.Math.Add(F.Math.Add(F.Math.Add(F.Math.Add(new_f, new_g), new_e), new_d), new_c), new_b));
