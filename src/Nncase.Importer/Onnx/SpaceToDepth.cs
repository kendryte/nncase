...
namespace Nncase.Importer
{
    public partial class OnnxImporter
    {
        private Expr VisitSpaceToDepth(in NodeProto op)
        {
            ...
            var beforeNewShape = new Shape(shape0, shape1, shape2 / blockSize, blockSize, shape3 / blockSize, blockSize);
            var afterNewShape = new Shape(shape0, shape1 * blockSize * blockSize, shape2 / blockSize, shape3 / blockSize);
