...
public sealed partial class OnnxImporter : BaseImporter
{
    ...
    private void Visit(NodeProto op)
    {
        ...
        var output = op.OpType switch
        {
            ...
            "AveragePool" => VisitReduceWindow2D(op, ReduceOp.Mean, 0),
            ...
            "Gemm" => VisitGemm(op),
            "GlobalAveragePool" => VisitReduceWindow2D(op, ReduceOp.Mean, 0, true),
            ...
            "ReduceMean" => VisitReduce(op, ReduceOp.Mean, 0),
            "ReduceMin" => VisitReduce(op, ReduceOp.Min, float.MaxValue),
            "ReduceProd" => VisitReduce(op, ReduceOp.Prod, 1),
            "ReduceSum" => VisitReduce(op, ReduceOp.Sum, 0),
