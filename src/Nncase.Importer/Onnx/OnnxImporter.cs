    ...
    public sealed partial class OnnxImporter
    {
        ...
        private void Visit(NodeProto op)
        {
            var output = op.OpType switch
            {
                ...
                // "Acosh" => VisitAcosh(op),
                // "And" => VisitAnd(op),
                // "ArgMax" => VisitArgMax(op),
                // "ArgMin" => VisitArgMin(op),
                // "Asin" => VisitAsin(op),
                // "Asinh" => VisitAsinh(op),
                ...
                // "Conv" => VisitConv(op),
                // "ConvTranspose" => VisitConvTranspose(op),
                // "Cos" => VisitCos(op),
                // "Cosh" => VisitCosh(op),
                ...
                // "ReduceMax" => VisitReduceMax(op),
                // "ReduceMean" => VisitReduceMean(op),
                // "ReduceMin" => VisitReduceMin(op),
                // "ReduceSum" => VisitReduceSum(op),
