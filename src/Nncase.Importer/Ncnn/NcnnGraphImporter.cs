...
/// Ncnn importer.
/// </summary>
public sealed partial class NcnnGraphImporter : BaseGraphImporter
{
    ...
    /// <summary>
    /// Initializes a new instance of the <see cref="NcnnGraphImporter"/> class.
    /// </summary>
    ...
    public NcnnGraphImporter(Stream ncnnParam, Stream ncnnBin, CompileSession compileSession, IRModule module)
        : base("main", compileSession, module)
    {
