...
void op_builder::tensor_reduce_arg_(datatype_t datatype, uint8_t rshape_src, uint8_t rstride_src, uint8_t rstride_dest, reduce_arg_op_t reduce_arg_op, uint8_t rshape_axis, bool keep_dims, bool select_last_idx)
{
    op_writer<tensor_reduce_arg_op_t>()(tensor_reduce_arg_op_t(datatype, rshape_src, rstride_src, rstride_dest, reduce_arg_op, rshape_axis, keep_dims, select_last_idx), writer_);
}
