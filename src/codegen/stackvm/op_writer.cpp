...
void op_builder::tensor_random_normal_(datatype_t datatype_dest, uint8_t rshape_dst, float mean, float std, float seed)
{
    op_writer<tensor_random_normal_op_t>()(tensor_random_normal_op_t(datatype_dest, rshape_dst, mean, std, seed), writer_);
}
