...
void op_builder::tensor_concat_(datatype_t datatype, uint8_t num_src, uint8_t axis, uint8_t rshape_dims, uint8_t rshape_dest, uint8_t rstride_dest)
{
    op_writer<tensor_concat_op_t>()(tensor_concat_op_t(datatype, num_src, axis, rshape_dims, rshape_dest, rstride_dest), writer_);
}
