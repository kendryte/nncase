...
void op_builder::tensor_hardmax_(datatype_t datatype, uint8_t rshape_src, uint8_t rstride_src, uint8_t rstride_dest, int32_t axis)
{
    op_writer<tensor_hardmax_op_t>()(tensor_hardmax_op_t(datatype, rshape_src, rstride_src, rstride_dest, axis), writer_);
}
