...
void op_builder::tensor_reduce_(datatype_t datatype, uint8_t rshape_src, uint8_t rstride_src, uint8_t rstride_dest, reduce_op_t reduce_op, uint8_t rshape_axis)
{
    op_writer<tensor_reduce_op_t>()(tensor_reduce_op_t(datatype, rshape_src, rstride_src, rstride_dest, reduce_op, rshape_axis), writer_);
}
