/* This file is generated by tools/stackvm_gen/IsaGen at 2021/1/23 19:38:23 +08:00.
 *
...
void op_builder::ldarga_(uint32_t index)
{
    op_writer<ldarga_op_t>()(ldarga_op_t(index), writer_);
}
...
void op_builder::tensor_batch_to_space_(uint8_t rshape_src, uint8_t rshape_block, uint8_t rpaddings)
{
    op_writer<tensor_batch_to_space_op_t>()(tensor_batch_to_space_op_t(rshape_src, rshape_block, rpaddings), writer_);
}

void op_builder::tensor_conv2d_(uint8_t rshape_src, uint8_t rshape_kernel, uint16_t groups, uint16_t stride_h, uint16_t stride_w, uint16_t dilation_h, uint16_t dilation_w, float fused_clamp_low, float fused_clamp_high)
{
    op_writer<tensor_conv2d_op_t>()(tensor_conv2d_op_t(rshape_src, rshape_kernel, groups, stride_h, stride_w, dilation_h, dilation_w, fused_clamp_low, fused_clamp_high), writer_);
}

void op_builder::tensor_reduce_(uint8_t rshape_src, reduce_op_t reduce_op, uint8_t rshape_axis)
{
    op_writer<tensor_reduce_op_t>()(tensor_reduce_op_t(rshape_src, reduce_op, rshape_axis), writer_);
}

void op_builder::tensor_binary_(uint8_t rshape_src1, uint8_t rshape_src2, binary_op_t binary_op, float fused_clamp_low, float fused_clamp_high)
{
    op_writer<tensor_binary_op_t>()(tensor_binary_op_t(rshape_src1, rshape_src2, binary_op, fused_clamp_low, fused_clamp_high), writer_);
}

void op_builder::tensor_unary_(uint8_t rshape_src, unary_op_t unary_op)
{
    op_writer<tensor_unary_op_t>()(tensor_unary_op_t(rshape_src, unary_op), writer_);
}
