...
void op_builder::tensor_reduce_prod_(uint8_t rshape_src, uint8_t rshape_dest, uint8_t rshape_axes)
{
    op_writer<tensor_reduce_prod_op_t>()(tensor_reduce_prod_op_t(rshape_src, rshape_dest, rshape_axes), writer_);
}
