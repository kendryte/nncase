...
void op_builder::tensor_matmul_(uint8_t rshape_src1, uint8_t rshape_src2, float fused_clamp_low, float fused_clamp_high)
{
    op_writer<tensor_matmul_op_t>()(tensor_matmul_op_t(rshape_src1, rshape_src2, fused_clamp_low, fused_clamp_high), writer_);
}
...
void op_builder::tensor_sigmoid_(datatype_t datatype, uint8_t rshape_src, uint8_t rstride_src)
{
    op_writer<tensor_sigmoid_op_t>()(tensor_sigmoid_op_t(datatype, rshape_src, rstride_src), writer_);
}
