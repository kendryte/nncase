...
namespace targets
{
    namespace neutral
    {
        struct reduce_window2d_options : simple_node_body<runtime::rop_reduce_window2d, reduce_window2d_options>
        {
            memory_range input;
            memory_range output;
            reduce_op reduce_op;
        ...
        runtime::kernel_call_result reduce_window2d(reduce_window2d_options &options, runtime::interpreter &interpreter, runtime::interpreter_step_t step)
        {
