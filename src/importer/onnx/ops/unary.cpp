...
void onnx_importer::convert_op_Sqrt([[maybe_unused]] const onnx::NodeProto &node)
{
...
void onnx_importer::convert_unary([[maybe_unused]] const onnx::NodeProto &node,[[maybe_unused]] const unary_op_t unary_op)
{
