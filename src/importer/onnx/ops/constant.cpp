...
// template <>
// constant *onnx_importer::emplace_constant<TensorProto>([[maybe_unused]] const optional<TensorProto> &value)
// {
    // if (!value)
    //     return nullptr;
...
void onnx_importer::convert_op_Constant([[maybe_unused]] const NodeProto &node)
{
