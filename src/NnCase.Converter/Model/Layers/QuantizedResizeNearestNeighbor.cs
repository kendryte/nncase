...
{
    public class QuantizedResizeNearestNeighbor : Layer
    {
        ...
        public QuantizedResizeNearestNeighbor(ReadOnlySpan<int> dimensions, int outputWidth, int outputHeight, bool alignCorners = false)
        {
