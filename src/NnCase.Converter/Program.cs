...
namespace NnCase.Converter
{
    class Program
    {
        ...
        {
            var file = File.ReadAllBytes(@"D:\Work\Repository\models\fuckerFacenet2.tflite");
            ...
            await k210c.ConvertAsync(new ImageDataset(@"D:\Work\Repository\models\test", new[] { 3, 128, 128 }, 1, PostprocessMethods.NormalizeMinus1To1), ctx);

            using (var f = File.Open(@"D:\Work\Repository\models\fuckerFacenet2.pb", FileMode.Create, FileAccess.Write))
