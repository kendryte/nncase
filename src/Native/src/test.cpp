...
// 1
{
    ...
    ntt::tensor<float, ntt::ranked_shape<1>> ta(shape), tb(shape), tc(shape);
    std::fill(ta.elements().begin(), ta.elements().end(), 1.f);
    ntt::unary<ntt::ops::sin>(ta, tb.view());
...
// nocontigious copy
{
    ...
    ntt::tensor_copy(
        tc.view(ntt::make_ranked_shape(0, 3), ntt::fixed_shape<2, 3>{}), td);
...
// im2col packed on ic
{
    ...
    ntt::tensor<ntt::vector<float, 4>, ntt::fixed_shape<9, 16>> packed_output;
    ntt::im2col(packed_input, ntt::fixed_shape<3, 3>{},
                ntt::fixed_shape<1, 1>{}, ntt::fixed_shape<1, 1, 1, 1>{},
                ntt::fixed_shape<1>{}, ntt::fixed_shape<0>{}, packed_output);
...

{
    ...
    ntt::tensor<float, ntt::ranked_shape<2>> tc(ntt::make_ranked_shape(1, 4));
    ntt::matmul<true>(ta, tb, tc, ntt::fixed_shape<1>{}, ntt::fixed_shape<>{},
