...
{
template <class T>
result<void> gather_nd_impl(const T *input, T *output, const dims_t &in_shape, NNCASE_UNUSED const dims_t &out_shape,
    const dims_t &in_strides, NNCASE_UNUSED const dims_t &out_strides, const int64_t *indices, const dims_t &indices_shape, size_t batch_dims,
...
result<void> optimized::gather_nd(datatype_t type, const gsl::byte *input, gsl::byte *output, const dims_t &in_shape, const dims_t &out_shape,
