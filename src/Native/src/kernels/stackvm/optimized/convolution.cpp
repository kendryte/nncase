...
result<void> conv2d_1x1_s1(
    ...
    gsl::span<const size_t> in_shape, NNCASE_UNUSED gsl::span<const size_t> in_strides,
    NNCASE_UNUSED gsl::span<const size_t> w_shape, NNCASE_UNUSED gsl::span<const size_t> w_strides,
...
result<void> optimized::conv2d(
    const float *input, const float *weights, const float *bias, float *output,
    gsl::span<const size_t> in_shape, gsl::span<const size_t> in_strides, gsl::span<const size_t> w_shape,
