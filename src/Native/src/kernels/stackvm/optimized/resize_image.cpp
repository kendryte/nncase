...
template <class T>
result<void> resize_bilinear_impl(const T *input, T *output, const dims_t &in_shape, NNCASE_UNUSED const dims_t &in_strides,
    NNCASE_UNUSED const dims_t &out_strides, int32_t out_h, int32_t out_w, bool align_corners, NNCASE_UNUSED bool half_pixel_centers, NNCASE_UNUSED kernel_context &context) noexcept
{
...
#endif
        for (int oc = 0; (size_t)oc < in_shape[1]; oc++)
        {
...
template <class T>
result<void> resize_nearest_neighbor_impl(const T *input, T *output, const dims_t &in_shape, NNCASE_UNUSED const dims_t &in_strides,
    NNCASE_UNUSED const dims_t &out_strides, int32_t out_h, int32_t out_w, bool align_corners, bool half_pixel_centers, NNCASE_UNUSED kernel_context &context) noexcept
{
    auto scales = kernels::detail::get_resize_scales(in_shape, out_h, out_w, align_corners);
    auto height_scale = scales.first;
    auto width_scale = scales.second;
...
inline result<void> gnne_resize_nearest_neighbor(const bfloat16 *input, bfloat16 *output,
    ...
    NNCASE_UNUSED const dims_t &out_strides, int32_t out_h, int32_t out_w, NNCASE_UNUSED bool align_corners, NNCASE_UNUSED bool half_pixel_centers, NNCASE_UNUSED kernel_context &context)
{
...
inline result<void> resize_bilinear_impl(const bfloat16 *input, bfloat16 *output, const dims_t &in_shape, NNCASE_UNUSED const dims_t &in_strides,
...
result<void> optimized::resize_bilinear(typecode_t type, const gsl::byte *input, gsl::byte *output, const dims_t &in_shape,
    const dims_t &in_strides, const dims_t &out_strides, int32_t out_h, int32_t out_w, bool align_corners, bool half_pixel_centers,
    kernel_context &context) noexcept
{
    FP_OR_Q_IMPL(type, RESIZE_BILINEAR_IMPL);
}

result<void> optimized::resize_nearest_neighbor(typecode_t type, const gsl::byte *input, gsl::byte *output, const dims_t &in_shape,
    const dims_t &in_strides, const dims_t &out_strides, int32_t out_h, int32_t out_w, bool align_corners, bool half_pixel_centers,
    kernel_context &context) noexcept
{
