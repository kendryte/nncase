...
result<void> nncase::kernels::stackvm::reference::conv2d_transpose(const float *input, float *output, const float *weights, const float *bias, const dims_t &in_shape,
                      int32_t groups, const dims_t &out_shape, int32_t filter_h, int32_t filter_w, int32_t stride_h, int32_t stride_w, int32_t dilation_h, int32_t dilation_w,
                      const padding &padding_h, const padding &padding_w, [[maybe_unused]] const value_range<float> &fused_activation) noexcept
{
