...
conv2d_transpose(const float *input, float *output, const float *weights,
                 const float *bias, gsl::span<const size_t> in_shape, int32_t groups,
...
lstm(const float *input, const float *w_xc, const float *w_rc,
     ...
     gsl::span<const size_t> w_rc_shape, runtime::stackvm::lstmdirection_t direction);
...
one_hot(datatype_t type, datatype_t indices_type, const gsl::byte *indices,
        ...
        gsl::span<const size_t> out_strides, size_t depth, gsl::byte *values,
...
reduce(typecode_t typecode, nncase::runtime::stackvm::reduce_op_t op,
       ...
       gsl::span<const size_t> in_shape, gsl::span<const size_t> axis, gsl::span<const size_t> in_strides,
...
NNCASE_API result<void> reverse_sequence(
    ...
    gsl::span<const size_t> in_shape, gsl::span<const size_t> sequence_lens, int64_t batch_axis,
...
result<void> split(datatype_t type, const gsl::byte *input,
                   gsl::span<gsl::byte *> output, gsl::span<const size_t> in_shape,
                   gsl::span<const size_t> in_strides,
