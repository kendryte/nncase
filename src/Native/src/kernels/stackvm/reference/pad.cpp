...
dims_t get_in_index(const dims_t &index, const dims_t &in_shape,
    const paddings_t &paddings, pad_mode_t mode, bool &pad_element)
{
...
template <class T>
result<void> pad_impl(const T *input, T *output, const dims_t &in_shape, const dims_t &out_shape,
    const strides_t &in_strides, const strides_t &out_strides, const paddings_t &paddings, pad_mode_t mode, T pad_value, NNCASE_UNUSED kernel_context &context) noexcept
{
...
template <class T>
result<void> interior_pad_impl(const T *input, T *output, NNCASE_UNUSED const dims_t &in_shape, const dims_t &out_shape,
    NNCASE_UNUSED const strides_t &in_strides, const strides_t &out_strides, const paddings_t &paddings, T pad_value, NNCASE_UNUSED kernel_context &context) noexcept
{
    size_t idx = 0;
