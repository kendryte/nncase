...
result<void> visit(const tensor_allocate_op_t &op) noexcept override;
result<void> visit(const tensor_allocate_buffer_view_op_t &op) noexcept override;
result<void> visit(const tensor_base_ment_of_op_t &op) noexcept override;
...
result<void> visit(const tensor_broadcast_shape_op_t &op) noexcept override;
result<void> visit(const tensor_bucket_pad_op_t &op) noexcept override;
result<void> visit(const tensor_buffer_index_of_op_t &op) noexcept override;
result<void> visit(const tensor_buffer_load_op_t &op) noexcept override;
result<void> visit(const tensor_buffer_store_op_t &op) noexcept override;
result<void> visit(const tensor_buffer_subview_op_t &op) noexcept override;
...
result<void> visit(const tensor_conv2d_shape_op_t &op) noexcept override;
result<void> visit(const tensor_conv2d_transpose_op_t &op) noexcept override;
result<void> visit(const tensor_conv2d_transpose_shape_op_t &op) noexcept override;
result<void> visit(const tensor_cum_sum_op_t &op) noexcept override;
result<void> visit(const tensor_ddr_of_op_t &op) noexcept override;
...
result<void> visit(const tensor_get_paddings_op_t &op) noexcept override;
...
result<void> visit(const tensor_mat_mul_shape_op_t &op) noexcept override;
result<void> visit(const tensor_match_buffer_op_t &op) noexcept override;
...
result<void> visit(const tensor_reshape_shape_op_t &op) noexcept override;
...
result<void> visit(const tensor_squeeze_shape_op_t &op) noexcept override;
result<void> visit(const tensor_stack_op_t &op) noexcept override;
result<void> visit(const tensor_stride_of_op_t &op) noexcept override;
...
result<void> visit(const tensor_transpose_shape_op_t &op) noexcept override;
...
result<void> visit(const tensor_uninitialized_op_t &op) noexcept override;
result<void> visit(const tensor_unsqueeze_op_t &op) noexcept override;
result<void> visit(const tensor_unsqueeze_shape_op_t &op) noexcept override;
