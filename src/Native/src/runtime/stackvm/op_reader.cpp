...
result<void> tensor_op_visitor::visit(tensor_function_t tensor_funct, span_reader &reader) noexcept
{
    ...
    case tensor_function_t::allocate_buffer_view:
        return visit(tensor_op_reader<tensor_function_t::allocate_buffer_view>()(reader));
    case tensor_function_t::base_ment_of:
        return visit(tensor_op_reader<tensor_function_t::base_ment_of>()(reader));
    ...
    case tensor_function_t::broadcast_shape:
        return visit(tensor_op_reader<tensor_function_t::broadcast_shape>()(reader));
    ...
    case tensor_function_t::buffer_index_of:
        return visit(tensor_op_reader<tensor_function_t::buffer_index_of>()(reader));
    case tensor_function_t::buffer_load:
        return visit(tensor_op_reader<tensor_function_t::buffer_load>()(reader));
    case tensor_function_t::buffer_store:
        return visit(tensor_op_reader<tensor_function_t::buffer_store>()(reader));
    case tensor_function_t::buffer_subview:
        return visit(tensor_op_reader<tensor_function_t::buffer_subview>()(reader));
    ...
    case tensor_function_t::conv2d_shape:
        return visit(tensor_op_reader<tensor_function_t::conv2d_shape>()(reader));
    ...
    case tensor_function_t::conv2d_transpose_shape:
        return visit(tensor_op_reader<tensor_function_t::conv2d_transpose_shape>()(reader));
    ...
    case tensor_function_t::get_paddings:
        return visit(tensor_op_reader<tensor_function_t::get_paddings>()(reader));
    ...
    case tensor_function_t::mat_mul_shape:
        return visit(tensor_op_reader<tensor_function_t::mat_mul_shape>()(reader));
    case tensor_function_t::match_buffer:
        return visit(tensor_op_reader<tensor_function_t::match_buffer>()(reader));
    ...
    case tensor_function_t::reshape_shape:
        return visit(tensor_op_reader<tensor_function_t::reshape_shape>()(reader));
    ...
    case tensor_function_t::squeeze_shape:
        return visit(tensor_op_reader<tensor_function_t::squeeze_shape>()(reader));
    ...
    case tensor_function_t::transpose_shape:
        return visit(tensor_op_reader<tensor_function_t::transpose_shape>()(reader));
    ...
    case tensor_function_t::uninitialized:
        return visit(tensor_op_reader<tensor_function_t::uninitialized>()(reader));
    ...
    case tensor_function_t::unsqueeze_shape:
        return visit(tensor_op_reader<tensor_function_t::unsqueeze_shape>()(reader));
