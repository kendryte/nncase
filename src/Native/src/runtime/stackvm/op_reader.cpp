...
result<void> op_visitor::next() noexcept {
    ...
    if (opcode == opcode_t::TENSOR) {
        ...
        case tensor_function_t::erf:
            return visit(op_reader<tensor_erf_op_t>()(reader_));
        ...
        case tensor_function_t::gelu:
            return visit(op_reader<tensor_gelu_op_t>()(reader_));
        ...
        case tensor_function_t::layer_norm:
            return visit(op_reader<tensor_layer_norm_op_t>()(reader_));
        ...
        case tensor_function_t::swish:
            return visit(op_reader<tensor_swish_op_t>()(reader_));
