...
class stackvm_runtime_function : public runtime_function, private op_visitor {
  ...
  protected:
    ...
    result<void> visit(const ststrides_op_t &op) noexcept override;
    result<void> visit(const ldtuple_elem_op_t &op) noexcept override;
    result<void> visit(const sttuple_op_t &op) noexcept override;
    ...
    // result<void> visit(const tensor_random_normal_op_t &op) noexcept
    // override; result<void> visit(const tensor_random_uniform_op_t &op)
    // noexcept override;
