...
result<void> stackvm_runtime_function::visit([[maybe_unused]] const tensor_allocate_op_t &op) noexcept {
    ...
    dump_input(size);
    try_var(output, kernels::stackvm::allocate(op.elem_type, op.location, op.malloc, size, nullptr, module().kernel_context()));
    dump_output(output);
...
result<void> stackvm_runtime_function::visit([[maybe_unused]] const tensor_allocate_buffer_view_op_t &op) noexcept {
    ...
    dump_input(buffer);
    try_var(output, kernels::stackvm::allocate_buffer_view(buffer, nullptr, module().kernel_context()));
    dump_output(output);
    stack_.push(std::move(output));
    return ok();
}
...
result<void> stackvm_runtime_function::visit([[maybe_unused]] const tensor_buffer_load_op_t &op) noexcept {
    ...
    dump_input(indices);
    try_var(output, kernels::stackvm::buffer_load(input, indices, nullptr, module().kernel_context()));
    dump_output(output);
    stack_.push(std::move(output));
    return ok();
}
...
result<void> stackvm_runtime_function::visit([[maybe_unused]] const tensor_buffer_store_op_t &op) noexcept {
    ...
    dump_input(value);
    try_var(output, kernels::stackvm::buffer_store(input, indices, value, nullptr, module().kernel_context()));
    dump_output(output);
    stack_.push(std::move(output));
    return ok();
}
...
result<void> stackvm_runtime_function::visit([[maybe_unused]] const tensor_buffer_subview_op_t &op) noexcept {
    ...
    try_var(shape, pop_value());
    dump_input(shape);
    try_var(output, kernels::stackvm::buffer_subview(buffer, offset, shape, nullptr, module().kernel_context()));
    dump_output(output);
    stack_.push(std::move(output));
    return ok();
}
...
result<void> stackvm_runtime_function::visit([[maybe_unused]] const tensor_condition_op_t &op) noexcept {
    ...
    try_var(value, pop_value());
    dump_input(value);
    try_var(output, kernels::stackvm::condition(predicate, value, nullptr, module().kernel_context()));
    dump_output(output);
    stack_.push(std::move(output));
    return ok();
}
...
result<void> stackvm_runtime_function::visit([[maybe_unused]] const tensor_ddr_of_op_t &op) noexcept {
    ...
    try_var(input, pop_value());
    dump_input(input);
    try_var(output, kernels::stackvm::ddr_of(input, nullptr, module().kernel_context()));
    dump_output(output);
    stack_.push(std::move(output));
    return ok();
}
...
result<void> stackvm_runtime_function::visit([[maybe_unused]] const tensor_match_buffer_op_t &op) noexcept {
    ...
    try_var(input, pop_value());
    dump_input(input);
    try_var(output, kernels::stackvm::match_buffer(input, nullptr, module().kernel_context()));
    dump_output(output);
    stack_.push(std::move(output));
    return ok();
}
