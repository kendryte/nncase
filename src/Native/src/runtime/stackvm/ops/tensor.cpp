/* This file is generated by tools/stackvm_gen/IsaGen at 03/24/2025 02:27:06
 * +00:00.
 *
...
result<void> stackvm_runtime_function::visit(
    [[maybe_unused]] const tensor_allocate_op_t &op) noexcept {
    dump_op("allocate");
    try_var(size, pop_value());
    dump_input(size);
    try_var(output, kernels::stackvm::allocate(op.elem_type, op.location,
                                               op.malloc, size, nullptr,
...
result<void> stackvm_runtime_function::visit(
    [[maybe_unused]] const tensor_allocate_buffer_view_op_t &op) noexcept {
    dump_op("allocate_buffer_view");
    try_var(buffer, pop_value());
    dump_input(buffer);
    try_var(output, kernels::stackvm::allocate_buffer_view(
                        buffer, nullptr, module().kernel_context()));
    dump_output(output);
    stack_.push(std::move(output));
    return ok();
}
...
result<void> stackvm_runtime_function::visit(
    [[maybe_unused]] const tensor_base_ment_of_op_t &op) noexcept {
    dump_op("base_ment_of");
    try_var(input, pop_value());
    dump_input(input);
    try_var(output, kernels::stackvm::base_ment_of(input, nullptr,
                                                   module().kernel_context()));
    dump_output(output);
    stack_.push(std::move(output));
    return ok();
...
result<void> stackvm_runtime_function::visit(
    [[maybe_unused]] const tensor_buffer_index_of_op_t &op) noexcept {
    dump_op("buffer_index_of");
    try_var(input, pop_value());
    dump_input(input);
    try_var(output, kernels::stackvm::buffer_index_of(
...
result<void> stackvm_runtime_function::visit(
    [[maybe_unused]] const tensor_buffer_load_op_t &op) noexcept {
    dump_op("buffer_load");
    try_var(input, pop_value());
    dump_input(input);
    try_var(indices, pop_value());
    dump_input(indices);
    try_var(output, kernels::stackvm::buffer_load(input, indices, nullptr,
                                                  module().kernel_context()));
    dump_output(output);
    stack_.push(std::move(output));
    return ok();
...
result<void> stackvm_runtime_function::visit(
    [[maybe_unused]] const tensor_buffer_store_op_t &op) noexcept {
    ...
    dump_input(value);
    try_var(output,
            kernels::stackvm::buffer_store(input, indices, value, nullptr,
                                           module().kernel_context()));
    dump_output(output);
    stack_.push(std::move(output));
    return ok();
...
result<void> stackvm_runtime_function::visit(
    [[maybe_unused]] const tensor_buffer_subview_op_t &op) noexcept {
    ...
    dump_input(shape);
    try_var(output,
            kernels::stackvm::buffer_subview(buffer, offset, shape, nullptr,
                                             module().kernel_context()));
    dump_output(output);
    stack_.push(std::move(output));
    return ok();
...
result<void> stackvm_runtime_function::visit(
    ...
    try_var(value, pop_value());
    dump_input(value);
    try_var(output, kernels::stackvm::condition(predicate, value, nullptr,
                                                module().kernel_context()));
    dump_output(output);
    stack_.push(std::move(output));
    return ok();
...
result<void> stackvm_runtime_function::visit(
    [[maybe_unused]] const tensor_ddr_of_op_t &op) noexcept {
    dump_op("ddr_of");
    try_var(input, pop_value());
    dump_input(input);
    try_var(output, kernels::stackvm::ddr_of(input, nullptr,
                                             module().kernel_context()));
    dump_output(output);
    stack_.push(std::move(output));
    return ok();
...
result<void> stackvm_runtime_function::visit(
    ...
    dump_input(bias);
    try_var(output,
            kernels::stackvm::layer_norm(op.axis, op.epsilon, op.use_mean,
                                         op.channel_first, input, scale, bias,
                                         nullptr, module().kernel_context()));
    dump_output(output);
    stack_.push(std::move(output));
    return ok();
...
result<void> stackvm_runtime_function::visit(
    [[maybe_unused]] const tensor_match_buffer_op_t &op) noexcept {
    dump_op("match_buffer");
    try_var(input, pop_value());
    dump_input(input);
    try_var(output, kernels::stackvm::match_buffer(input, nullptr,
                                                   module().kernel_context()));
    dump_output(output);
    stack_.push(std::move(output));
    return ok();
...
result<void> stackvm_runtime_function::visit(
    ...
    try_var(output, kernels::stackvm::reduce(op.reduce_op, input, axes,
...
result<void> stackvm_runtime_function::visit(
    ...
    dump_input(value);
    try_var(output,
            kernels::stackvm::require(op.message, predicate, value, nullptr,
                                      module().kernel_context()));
    dump_output(output);
    stack_.push(std::move(output));
    return ok();
...
result<void> stackvm_runtime_function::visit(
    [[maybe_unused]] const tensor_stride_of_op_t &op) noexcept {
    dump_op("stride_of");
    try_var(input, pop_value());
    dump_input(input);
    try_var(output, kernels::stackvm::stride_of(input, nullptr,
                                                module().kernel_context()));
    dump_output(output);
    stack_.push(std::move(output));
    return ok();
...
result<void> stackvm_runtime_function::visit(
    ...
    dump_input(upper);
    try_var(output, kernels::stackvm::trilu(input, k, upper, nullptr,
                                            module().kernel_context()));
    dump_output(output);
    stack_.push(std::move(output));
    return ok();
...
result<void> stackvm_runtime_function::visit(
    [[maybe_unused]] const tensor_uninitialized_op_t &op) noexcept {
    dump_op("uninitialized");
    try_var(shape, pop_value());
    dump_input(shape);
    try_var(output, kernels::stackvm::uninitialized(
                        op.dtype, op.memory_location, shape, nullptr,
                        module().kernel_context()));
    dump_output(output);
    stack_.push(std::move(output));
    return ok();
