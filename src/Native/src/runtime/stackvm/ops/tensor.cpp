...
result<void> stackvm_runtime_function::visit([[maybe_unused]] const tensor_allocate_op_t &op) noexcept {
    dump_op("allocate");
    try_var(size, pop_value());
    dump_input(size);
    try_var(output, kernels::stackvm::allocate(op.elem_type, op.location, op.malloc, op.can_fold_const_call, size, nullptr, module().kernel_context()));
    dump_output(output);
    stack_.push(std::move(output));
    return ok();
}

result<void> stackvm_runtime_function::visit([[maybe_unused]] const tensor_allocate_buffer_view_op_t &op) noexcept {
    dump_op("allocate_buffer_view");
    try_var(buffer, pop_value());
    dump_input(buffer);
    try_var(output, kernels::stackvm::allocate_buffer_view(op.can_fold_const_call, buffer, nullptr, module().kernel_context()));
    dump_output(output);
    stack_.push(std::move(output));
    return ok();
}

result<void> stackvm_runtime_function::visit([[maybe_unused]] const tensor_base_ment_of_op_t &op) noexcept {
    dump_op("base_ment_of");
    try_var(input, pop_value());
    dump_input(input);
    try_var(output, kernels::stackvm::base_ment_of(input, nullptr, module().kernel_context()));
    dump_output(output);
    stack_.push(std::move(output));
    return ok();
}
...
result<void> stackvm_runtime_function::visit([[maybe_unused]] const tensor_broadcast_shape_op_t &op) noexcept {
    dump_op("broadcast_shape");
    try_var(inputs, pop_value());
    dump_input(inputs);
    try_var(output, kernels::stackvm::broadcast_shape(inputs, nullptr, module().kernel_context()));
    dump_output(output);
    stack_.push(std::move(output));
    return ok();
}
...
result<void> stackvm_runtime_function::visit([[maybe_unused]] const tensor_buffer_index_of_op_t &op) noexcept {
    dump_op("buffer_index_of");
    try_var(input, pop_value());
    dump_input(input);
    try_var(output, kernels::stackvm::buffer_index_of(input, nullptr, module().kernel_context()));
    dump_output(output);
    stack_.push(std::move(output));
    return ok();
}

result<void> stackvm_runtime_function::visit([[maybe_unused]] const tensor_buffer_load_op_t &op) noexcept {
    dump_op("buffer_load");
    try_var(input, pop_value());
    dump_input(input);
    try_var(indices, pop_value());
    dump_input(indices);
    try_var(output, kernels::stackvm::buffer_load(op.can_fold_const_call, input, indices, nullptr, module().kernel_context()));
    dump_output(output);
    stack_.push(std::move(output));
    return ok();
}

result<void> stackvm_runtime_function::visit([[maybe_unused]] const tensor_buffer_store_op_t &op) noexcept {
    dump_op("buffer_store");
    try_var(input, pop_value());
    dump_input(input);
    try_var(indices, pop_value());
    dump_input(indices);
    ...
    dump_input(value);
    try_var(output, kernels::stackvm::buffer_store(op.can_fold_const_call, input, indices, value, nullptr, module().kernel_context()));
    dump_output(output);
    stack_.push(std::move(output));
    return ok();
}

result<void> stackvm_runtime_function::visit([[maybe_unused]] const tensor_buffer_subview_op_t &op) noexcept {
    dump_op("buffer_subview");
    try_var(buffer, pop_value());
    dump_input(buffer);
    try_var(offset, pop_value());
    dump_input(offset);
    try_var(shape, pop_value());
    dump_input(shape);
    try_var(output, kernels::stackvm::buffer_subview(op.can_fold_const_call, buffer, offset, shape, nullptr, module().kernel_context()));
    dump_output(output);
    stack_.push(std::move(output));
    return ok();
}
...
result<void> stackvm_runtime_function::visit([[maybe_unused]] const tensor_concat_op_t &op) noexcept {
    ...
    try_var(input, pop_value());
    dump_input(input);
    try_var(output, kernels::stackvm::concat(op.axis, input, nullptr, module().kernel_context()));
    dump_output(output);
    stack_.push(std::move(output));
    return ok();
}
...
result<void> stackvm_runtime_function::visit([[maybe_unused]] const tensor_conv2d_shape_op_t &op) noexcept {
    ...
    try_var(groups, pop_value());
    dump_input(groups);
    try_var(output, kernels::stackvm::conv2d_shape(input, weights, padding, stride, dilation, groups, nullptr, module().kernel_context()));
    dump_output(output);
    stack_.push(std::move(output));
    return ok();
}
...
result<void> stackvm_runtime_function::visit([[maybe_unused]] const tensor_conv2d_transpose_shape_op_t &op) noexcept {
    ...
    try_var(groups, pop_value());
    dump_input(groups);
    try_var(output, kernels::stackvm::conv2d_transpose_shape(input, weights, stride, dilation, padding, output_padding, groups, nullptr, module().kernel_context()));
    dump_output(output);
    stack_.push(std::move(output));
    return ok();
}
...
result<void> stackvm_runtime_function::visit([[maybe_unused]] const tensor_ddr_of_op_t &op) noexcept {
    dump_op("ddr_of");
    try_var(input, pop_value());
    dump_input(input);
    try_var(output, kernels::stackvm::ddr_of(op.can_fold_const_call, input, nullptr, module().kernel_context()));
    dump_output(output);
    stack_.push(std::move(output));
    return ok();
}
...
result<void> stackvm_runtime_function::visit([[maybe_unused]] const tensor_gather_op_t &op) noexcept {
    ...
    dump_input(index);
    try_var(output, kernels::stackvm::gather(op.axis, input, index, nullptr, module().kernel_context()));
    dump_output(output);
    stack_.push(std::move(output));
    return ok();
}
...
result<void> stackvm_runtime_function::visit([[maybe_unused]] const tensor_get_paddings_op_t &op) noexcept {
    ...
    dump_input(lower);
    try_var(output, kernels::stackvm::get_paddings(input_shape, weights_shape, strides, dilations, same, lower, nullptr, module().kernel_context()));
    dump_output(output);
    stack_.push(std::move(output));
    return ok();
}
...
result<void> stackvm_runtime_function::visit([[maybe_unused]] const tensor_layer_norm_op_t &op) noexcept {
    ...
    try_var(bias, pop_value());
    dump_input(bias);
    try_var(output, kernels::stackvm::layer_norm(op.axis, op.epsilon, op.use_mean, op.channel_first, input, scale, bias, nullptr, module().kernel_context()));
    dump_output(output);
    stack_.push(std::move(output));
    return ok();
}
...
result<void> stackvm_runtime_function::visit([[maybe_unused]] const tensor_mat_mul_shape_op_t &op) noexcept {
    dump_op("mat_mul_shape");
    try_var(lhs, pop_value());
    dump_input(lhs);
    try_var(rhs, pop_value());
    dump_input(rhs);
    try_var(output, kernels::stackvm::mat_mul_shape(lhs, rhs, nullptr, module().kernel_context()));
    dump_output(output);
    stack_.push(std::move(output));
    return ok();
}

result<void> stackvm_runtime_function::visit([[maybe_unused]] const tensor_match_buffer_op_t &op) noexcept {
    dump_op("match_buffer");
    try_var(input, pop_value());
    dump_input(input);
    try_var(output, kernels::stackvm::match_buffer(op.can_fold_const_call, input, nullptr, module().kernel_context()));
    dump_output(output);
    stack_.push(std::move(output));
    return ok();
}
...
result<void> stackvm_runtime_function::visit([[maybe_unused]] const tensor_reduce_op_t &op) noexcept {
    ...
    try_var(output, kernels::stackvm::reduce(op.reduce_op, input, axes, init_value, keep_dims, nullptr, module().kernel_context()));
    dump_output(output);
    stack_.push(std::move(output));
    return ok();
}
...
result<void> stackvm_runtime_function::visit([[maybe_unused]] const tensor_reshape_shape_op_t &op) noexcept {
    dump_op("reshape_shape");
    try_var(input_shape, pop_value());
    dump_input(input_shape);
    try_var(shape, pop_value());
    dump_input(shape);
    try_var(output, kernels::stackvm::reshape_shape(input_shape, shape, nullptr, module().kernel_context()));
    dump_output(output);
    stack_.push(std::move(output));
    return ok();
}
...
result<void> stackvm_runtime_function::visit([[maybe_unused]] const tensor_squeeze_shape_op_t &op) noexcept {
    dump_op("squeeze_shape");
    try_var(input_shape, pop_value());
    dump_input(input_shape);
    try_var(dim, pop_value());
    dump_input(dim);
    try_var(output, kernels::stackvm::squeeze_shape(input_shape, dim, nullptr, module().kernel_context()));
    dump_output(output);
    stack_.push(std::move(output));
    return ok();
}
...
result<void> stackvm_runtime_function::visit([[maybe_unused]] const tensor_stride_of_op_t &op) noexcept {
    dump_op("stride_of");
    try_var(input, pop_value());
    dump_input(input);
    try_var(output, kernels::stackvm::stride_of(input, nullptr, module().kernel_context()));
    dump_output(output);
    stack_.push(std::move(output));
    return ok();
}
...
result<void> stackvm_runtime_function::visit([[maybe_unused]] const tensor_swish_op_t &op) noexcept {
    ...
    try_var(beta, pop_value());
    dump_input(beta);
    try_var(output, kernels::stackvm::swish(input, beta, nullptr, module().kernel_context()));
    dump_output(output);
    stack_.push(std::move(output));
    return ok();
}
...
result<void> stackvm_runtime_function::visit([[maybe_unused]] const tensor_transpose_shape_op_t &op) noexcept {
    dump_op("transpose_shape");
    try_var(input_shape, pop_value());
    dump_input(input_shape);
    try_var(perm, pop_value());
    dump_input(perm);
    try_var(output, kernels::stackvm::transpose_shape(input_shape, perm, nullptr, module().kernel_context()));
    dump_output(output);
    stack_.push(std::move(output));
    return ok();
}

result<void> stackvm_runtime_function::visit([[maybe_unused]] const tensor_trilu_op_t &op) noexcept {
    dump_op("trilu");
    try_var(input, pop_value());
    dump_input(input);
    try_var(k, pop_value());
    dump_input(k);
    try_var(upper, pop_value());
    dump_input(upper);
    try_var(output, kernels::stackvm::trilu(input, k, upper, nullptr, module().kernel_context()));
    dump_output(output);
    stack_.push(std::move(output));
    return ok();
}
...
result<void> stackvm_runtime_function::visit([[maybe_unused]] const tensor_uninitialized_op_t &op) noexcept {
    dump_op("uninitialized");
    try_var(shape, pop_value());
    dump_input(shape);
    try_var(output, kernels::stackvm::uninitialized(op.dtype, op.memory_location, shape, nullptr, module().kernel_context()));
    dump_output(output);
    stack_.push(std::move(output));
    return ok();
}
...
result<void> stackvm_runtime_function::visit([[maybe_unused]] const tensor_unsqueeze_shape_op_t &op) noexcept {
    dump_op("unsqueeze_shape");
    try_var(input_shape, pop_value());
    dump_input(input_shape);
    try_var(dim, pop_value());
    dump_input(dim);
    try_var(output, kernels::stackvm::unsqueeze_shape(input_shape, dim, nullptr, module().kernel_context()));
    dump_output(output);
    stack_.push(std::move(output));
    return ok();
}
