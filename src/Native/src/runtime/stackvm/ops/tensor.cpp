...
result<void> stackvm_runtime_function::visit([[maybe_unused]] const tensor_reshape_shape_op_t &op) noexcept {
    ...
    try_var(shape, pop_value());
    dump_input(shape);
    try_var(output, kernels::stackvm::reshape_shape(input, shape, nullptr, module().kernel_context()));
    dump_output(output);
    stack_.push(std::move(output));
    return ok();
}
...
result<void> stackvm_runtime_function::visit([[maybe_unused]] const tensor_squeeze_shape_op_t &op) noexcept {
    ...
    try_var(dim, pop_value());
    dump_input(dim);
    try_var(output, kernels::stackvm::squeeze_shape(input, dim, nullptr, module().kernel_context()));
    dump_output(output);
    stack_.push(std::move(output));
    return ok();
}
...
result<void> stackvm_runtime_function::visit([[maybe_unused]] const tensor_transpose_shape_op_t &op) noexcept {
    ...
    try_var(perm, pop_value());
    dump_input(perm);
    try_var(output, kernels::stackvm::transpose_shape(input, perm, nullptr, module().kernel_context()));
    dump_output(output);
    stack_.push(std::move(output));
    return ok();
}
...
result<void> stackvm_runtime_function::visit([[maybe_unused]] const tensor_unsqueeze_shape_op_t &op) noexcept {
    ...
    try_var(dim, pop_value());
    dump_input(dim);
    try_var(output, kernels::stackvm::unsqueeze_shape(input, dim, nullptr, module().kernel_context()));
    dump_output(output);
    stack_.push(std::move(output));
    return ok();
}
