...
struct c_api_mt {
    ...
    void (*compiler_set_compile_service_options)(clr_object_handle_t compile_options);
...
int nncase_clr_compiler_set_compile_service_options(clr_object_handle_t compile_options) {
    g_c_api_mt.compiler_set_compile_service_options(compile_options);
    return 0;
}
