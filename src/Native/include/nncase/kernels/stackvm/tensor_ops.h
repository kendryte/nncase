...
NNCASE_API result<value_t>
grid_sample(runtime::stackvm::grid_sample_align_corners_t align_corners,
            runtime::stackvm::grid_sample_mode_t mode,
            runtime::stackvm::grid_sample_padding_mode_t padding_mode,
            value_t input, value_t grid, value_t output = nullptr,
            kernel_context &context = default_kernel_context());
