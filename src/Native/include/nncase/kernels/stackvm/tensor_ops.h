...
allocate(typecode_t elem_type, runtime::stackvm::memory_location_t location,
         bool malloc, value_t size, value_t output = nullptr,
         kernel_context &context = default_kernel_context());

NNCASE_API result<value_t>
allocate_buffer_view(value_t buffer, value_t output = nullptr,
                     kernel_context &context = default_kernel_context());

NNCASE_API result<value_t>
base_ment_of(value_t input, value_t output = nullptr,
             kernel_context &context = default_kernel_context());
...
NNCASE_API result<value_t>
bitcast(typecode_t type, typecode_t new_type, value_t input, value_t new_shape,
        value_t output = nullptr,
        kernel_context &context = default_kernel_context());
...
NNCASE_API result<value_t>
buffer_index_of(value_t input, value_t output = nullptr,
                kernel_context &context = default_kernel_context());

NNCASE_API result<value_t>
buffer_load(value_t input, value_t indices, value_t output = nullptr,
            kernel_context &context = default_kernel_context());

NNCASE_API result<value_t>
buffer_store(value_t input, value_t indices, value_t value,
             value_t output = nullptr,
             kernel_context &context = default_kernel_context());

NNCASE_API result<value_t>
buffer_subview(value_t buffer, value_t offset, value_t shape,
               value_t output = nullptr,
               kernel_context &context = default_kernel_context());
...
NNCASE_API result<value_t>
condition(value_t predicate, value_t value, value_t output = nullptr,
          kernel_context &context = default_kernel_context());
...
NNCASE_API result<value_t>
ddr_of(value_t input, value_t output = nullptr,
       kernel_context &context = default_kernel_context());
...
NNCASE_API result<value_t>
layer_norm(int32_t axis, float epsilon, bool use_mean, bool channel_first,
           value_t input, value_t scale, value_t bias, value_t output = nullptr,
           kernel_context &context = default_kernel_context());
...
NNCASE_API result<value_t>
match_buffer(value_t input, value_t output = nullptr,
             kernel_context &context = default_kernel_context());
...
NNCASE_API result<value_t>
reduce(runtime::stackvm::reduce_op_t reduce_op, value_t input, value_t axes,
...
NNCASE_API result<value_t>
stride_of(value_t input, value_t output = nullptr,
          kernel_context &context = default_kernel_context());

NNCASE_API result<value_t>
swish(value_t input, value_t beta, value_t output = nullptr,
      kernel_context &context = default_kernel_context());
