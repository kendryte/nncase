/* This file is generated by tools/stackvm_gen/IsaGen at 03/24/2025 02:27:05
 * +00:00.
 *
...
template <> struct tensor_op_reader<tensor_function_t::allocate> {
...
template <> struct tensor_op_reader<tensor_function_t::allocate_buffer_view> {
    tensor_allocate_buffer_view_op_t
...
template <> struct tensor_op_reader<tensor_function_t::base_ment_of> {
    tensor_base_ment_of_op_t
    operator()(NNCASE_UNUSED span_reader &reader) const {
...
template <> struct tensor_op_reader<tensor_function_t::buffer_index_of> {
    tensor_buffer_index_of_op_t
    operator()(NNCASE_UNUSED span_reader &reader) const {
...
template <> struct tensor_op_reader<tensor_function_t::buffer_load> {
    tensor_buffer_load_op_t
    operator()(NNCASE_UNUSED span_reader &reader) const {
...
template <> struct tensor_op_reader<tensor_function_t::buffer_store> {
    tensor_buffer_store_op_t
    operator()(NNCASE_UNUSED span_reader &reader) const {
...
template <> struct tensor_op_reader<tensor_function_t::buffer_subview> {
    tensor_buffer_subview_op_t
    operator()(NNCASE_UNUSED span_reader &reader) const {
...
template <> struct tensor_op_reader<tensor_function_t::ddr_of> {
...
template <> struct tensor_op_reader<tensor_function_t::match_buffer> {
    tensor_match_buffer_op_t
    operator()(NNCASE_UNUSED span_reader &reader) const {
...
template <> struct tensor_op_reader<tensor_function_t::stride_of> {
...
template <> struct tensor_op_reader<tensor_function_t::uninitialized> {
...
class NNCASE_API tensor_op_visitor {
  public:
    ...
    virtual result<void>
    visit(NNCASE_UNUSED const tensor_allocate_op_t &op) noexcept {
        return default_visit(tensor_function_t::allocate, &op);
    }
    virtual result<void>
    visit(NNCASE_UNUSED const tensor_allocate_buffer_view_op_t &op) noexcept {
        return default_visit(tensor_function_t::allocate_buffer_view, &op);
    }
    virtual result<void>
    visit(NNCASE_UNUSED const tensor_base_ment_of_op_t &op) noexcept {
        return default_visit(tensor_function_t::base_ment_of, &op);
    }
    virtual result<void>
    ...
    virtual result<void>
    visit(NNCASE_UNUSED const tensor_buffer_index_of_op_t &op) noexcept {
        return default_visit(tensor_function_t::buffer_index_of, &op);
    }
    virtual result<void>
    visit(NNCASE_UNUSED const tensor_buffer_load_op_t &op) noexcept {
        return default_visit(tensor_function_t::buffer_load, &op);
    }
    virtual result<void>
    visit(NNCASE_UNUSED const tensor_buffer_store_op_t &op) noexcept {
        return default_visit(tensor_function_t::buffer_store, &op);
    }
    virtual result<void>
    visit(NNCASE_UNUSED const tensor_buffer_subview_op_t &op) noexcept {
        return default_visit(tensor_function_t::buffer_subview, &op);
    }
    virtual result<void>
    ...
    virtual result<void>
    visit(NNCASE_UNUSED const tensor_ddr_of_op_t &op) noexcept {
        return default_visit(tensor_function_t::ddr_of, &op);
    }
    virtual result<void>
    ...
    virtual result<void>
    visit(NNCASE_UNUSED const tensor_match_buffer_op_t &op) noexcept {
        return default_visit(tensor_function_t::match_buffer, &op);
    }
    virtual result<void>
    ...
    virtual result<void>
    visit(NNCASE_UNUSED const tensor_stride_of_op_t &op) noexcept {
        return default_visit(tensor_function_t::stride_of, &op);
    }
    virtual result<void>
    ...
    virtual result<void>
    visit(NNCASE_UNUSED const tensor_uninitialized_op_t &op) noexcept {
        return default_visit(tensor_function_t::uninitialized, &op);
    }
    virtual result<void>
