/* This file is generated by tools/stackvm_gen/IsaGen at 2023/3/20 下午8:46:01
 * +08:00.
 *
...
template <> struct op_reader<ldshape_op_t> {
...
template <> struct op_reader<ldstrides_op_t> {
...
template <> struct op_reader<ldscalar_op_t> {
...
template <> struct op_reader<tensor_batch_normalization_op_t> {
    ...
    operator()(NNCASE_UNUSED span_reader &reader) const {
        ...
        op.opcode = static_cast<opcode_t>(reader.read_unaligned<uint8_t>());
        op.tensor_funct =
            static_cast<tensor_function_t>(reader.read_unaligned<uint16_t>());
        return op;
    }
};
...
template <> struct op_reader<tensor_erf_op_t> {
...
template <> struct op_reader<tensor_gelu_op_t> {
...
template <> struct op_reader<tensor_layer_norm_op_t> {
...
template <> struct op_reader<tensor_swish_op_t> {
...
class NNCASE_API op_visitor {
  public:
    ...
    virtual result<void> visit(NNCASE_UNUSED const nop_op_t &op) noexcept {
        return default_visit(op);
    }
    virtual result<void> visit(NNCASE_UNUSED const br_op_t &op) noexcept {
        return default_visit(op);
    }
    virtual result<void> visit(NNCASE_UNUSED const br_true_op_t &op) noexcept {
        return default_visit(op);
    }
    virtual result<void> visit(NNCASE_UNUSED const br_false_op_t &op) noexcept {
        return default_visit(op);
    }
    virtual result<void> visit(NNCASE_UNUSED const ret_op_t &op) noexcept {
        return default_visit(op);
    }
    virtual result<void> visit(NNCASE_UNUSED const call_op_t &op) noexcept {
        return default_visit(op);
    }
    virtual result<void> visit(NNCASE_UNUSED const ecall_op_t &op) noexcept {
        return default_visit(op);
    }
    virtual result<void> visit(NNCASE_UNUSED const extcall_op_t &op) noexcept {
        return default_visit(op);
    }
    virtual result<void> visit(NNCASE_UNUSED const cuscall_op_t &op) noexcept {
        return default_visit(op);
    }
    virtual result<void> visit(NNCASE_UNUSED const throw_op_t &op) noexcept {
        return default_visit(op);
    }
    virtual result<void> visit(NNCASE_UNUSED const break_op_t &op) noexcept {
        return default_visit(op);
    }
    virtual result<void> visit(NNCASE_UNUSED const ldc_i4_op_t &op) noexcept {
        return default_visit(op);
    }
    virtual result<void> visit(NNCASE_UNUSED const ldnull_op_t &op) noexcept {
        return default_visit(op);
    }
    virtual result<void> visit(NNCASE_UNUSED const ldc_i4_0_op_t &op) noexcept {
        return default_visit(op);
    }
    virtual result<void> visit(NNCASE_UNUSED const ldc_i4_1_op_t &op) noexcept {
        return default_visit(op);
    }
    virtual result<void> visit(NNCASE_UNUSED const ldc_r4_op_t &op) noexcept {
        return default_visit(op);
    }
    virtual result<void> visit(NNCASE_UNUSED const ldind_i1_op_t &op) noexcept {
        return default_visit(op);
    }
    virtual result<void> visit(NNCASE_UNUSED const ldind_i2_op_t &op) noexcept {
        return default_visit(op);
    }
    virtual result<void> visit(NNCASE_UNUSED const ldind_i4_op_t &op) noexcept {
        return default_visit(op);
    }
    virtual result<void> visit(NNCASE_UNUSED const ldind_i_op_t &op) noexcept {
        return default_visit(op);
    }
    virtual result<void> visit(NNCASE_UNUSED const ldind_u1_op_t &op) noexcept {
        return default_visit(op);
    }
    virtual result<void> visit(NNCASE_UNUSED const ldind_u2_op_t &op) noexcept {
        return default_visit(op);
    }
    virtual result<void> visit(NNCASE_UNUSED const ldind_u4_op_t &op) noexcept {
        return default_visit(op);
    }
    virtual result<void> visit(NNCASE_UNUSED const ldind_u_op_t &op) noexcept {
        return default_visit(op);
    }
    virtual result<void>
    visit(NNCASE_UNUSED const ldind_br2_op_t &op) noexcept {
        return default_visit(op);
    }
    virtual result<void> visit(NNCASE_UNUSED const ldind_r4_op_t &op) noexcept {
        return default_visit(op);
    }
    virtual result<void> visit(NNCASE_UNUSED const stind_i1_op_t &op) noexcept {
        return default_visit(op);
    }
    virtual result<void> visit(NNCASE_UNUSED const stind_i2_op_t &op) noexcept {
        return default_visit(op);
    }
    virtual result<void> visit(NNCASE_UNUSED const stind_i4_op_t &op) noexcept {
        return default_visit(op);
    }
    virtual result<void> visit(NNCASE_UNUSED const stind_i_op_t &op) noexcept {
        return default_visit(op);
    }
    virtual result<void>
    visit(NNCASE_UNUSED const stind_br2_op_t &op) noexcept {
        return default_visit(op);
    }
    virtual result<void> visit(NNCASE_UNUSED const stind_r4_op_t &op) noexcept {
        return default_visit(op);
    }
    virtual result<void> visit(NNCASE_UNUSED const lea_gp_op_t &op) noexcept {
        return default_visit(op);
    }
    virtual result<void>
    visit(NNCASE_UNUSED const ldelem_i1_op_t &op) noexcept {
        return default_visit(op);
    }
    virtual result<void>
    visit(NNCASE_UNUSED const ldelem_i2_op_t &op) noexcept {
        return default_visit(op);
    }
    virtual result<void>
    visit(NNCASE_UNUSED const ldelem_i4_op_t &op) noexcept {
        return default_visit(op);
    }
    virtual result<void> visit(NNCASE_UNUSED const ldelem_i_op_t &op) noexcept {
        return default_visit(op);
    }
    virtual result<void>
    visit(NNCASE_UNUSED const ldelem_u1_op_t &op) noexcept {
        return default_visit(op);
    }
    virtual result<void>
    visit(NNCASE_UNUSED const ldelem_u2_op_t &op) noexcept {
        return default_visit(op);
    }
    virtual result<void>
    visit(NNCASE_UNUSED const ldelem_u4_op_t &op) noexcept {
        return default_visit(op);
    }
    virtual result<void> visit(NNCASE_UNUSED const ldelem_u_op_t &op) noexcept {
        return default_visit(op);
    }
    virtual result<void>
    visit(NNCASE_UNUSED const ldelem_br2_op_t &op) noexcept {
        return default_visit(op);
    }
    virtual result<void>
    visit(NNCASE_UNUSED const ldelem_r4_op_t &op) noexcept {
        return default_visit(op);
    }
    virtual result<void>
    visit(NNCASE_UNUSED const stelem_i1_op_t &op) noexcept {
        return default_visit(op);
    }
    virtual result<void>
    visit(NNCASE_UNUSED const stelem_i2_op_t &op) noexcept {
        return default_visit(op);
    }
    virtual result<void>
    visit(NNCASE_UNUSED const stelem_i4_op_t &op) noexcept {
        return default_visit(op);
    }
    virtual result<void> visit(NNCASE_UNUSED const stelem_i_op_t &op) noexcept {
        return default_visit(op);
    }
    virtual result<void>
    visit(NNCASE_UNUSED const stelem_br2_op_t &op) noexcept {
        return default_visit(op);
    }
    virtual result<void>
    visit(NNCASE_UNUSED const stelem_r4_op_t &op) noexcept {
        return default_visit(op);
    }
    virtual result<void> visit(NNCASE_UNUSED const ldarg_op_t &op) noexcept {
        return default_visit(op);
    }
    virtual result<void> visit(NNCASE_UNUSED const ldarg_0_op_t &op) noexcept {
        return default_visit(op);
    }
    virtual result<void> visit(NNCASE_UNUSED const ldarg_1_op_t &op) noexcept {
        return default_visit(op);
    }
    virtual result<void> visit(NNCASE_UNUSED const ldarg_2_op_t &op) noexcept {
        return default_visit(op);
    }
    virtual result<void> visit(NNCASE_UNUSED const ldarg_3_op_t &op) noexcept {
        return default_visit(op);
    }
    virtual result<void> visit(NNCASE_UNUSED const ldarg_4_op_t &op) noexcept {
        return default_visit(op);
    }
    virtual result<void> visit(NNCASE_UNUSED const ldarg_5_op_t &op) noexcept {
        return default_visit(op);
    }
    virtual result<void> visit(NNCASE_UNUSED const ldshape_op_t &op) noexcept {
        return default_visit(op);
    }
    virtual result<void>
    visit(NNCASE_UNUSED const ldstrides_op_t &op) noexcept {
        return default_visit(op);
    }
    virtual result<void>
    visit(NNCASE_UNUSED const ldtuple_elem_op_t &op) noexcept {
        return default_visit(op);
    }
    virtual result<void> visit(NNCASE_UNUSED const ldtuple_op_t &op) noexcept {
        return default_visit(op);
    }
    virtual result<void>
    visit(NNCASE_UNUSED const lddatatype_op_t &op) noexcept {
        return default_visit(op);
    }
    virtual result<void> visit(NNCASE_UNUSED const ldtensor_op_t &op) noexcept {
        return default_visit(op);
    }
    virtual result<void> visit(NNCASE_UNUSED const ldlocal_op_t &op) noexcept {
        return default_visit(op);
    }
    virtual result<void> visit(NNCASE_UNUSED const stlocal_op_t &op) noexcept {
        return default_visit(op);
    }
    virtual result<void> visit(NNCASE_UNUSED const ldscalar_op_t &op) noexcept {
        return default_visit(op);
    }
    virtual result<void> visit(NNCASE_UNUSED const dup_op_t &op) noexcept {
        return default_visit(op);
    }
    virtual result<void> visit(NNCASE_UNUSED const pop_op_t &op) noexcept {
        return default_visit(op);
    }
    virtual result<void> visit(NNCASE_UNUSED const neg_op_t &op) noexcept {
        return default_visit(op);
    }
    virtual result<void> visit(NNCASE_UNUSED const add_op_t &op) noexcept {
        return default_visit(op);
    }
    virtual result<void> visit(NNCASE_UNUSED const sub_op_t &op) noexcept {
        return default_visit(op);
    }
    virtual result<void> visit(NNCASE_UNUSED const mul_op_t &op) noexcept {
        return default_visit(op);
    }
    virtual result<void> visit(NNCASE_UNUSED const div_op_t &op) noexcept {
        return default_visit(op);
    }
    virtual result<void> visit(NNCASE_UNUSED const div_u_op_t &op) noexcept {
        return default_visit(op);
    }
    virtual result<void> visit(NNCASE_UNUSED const rem_op_t &op) noexcept {
        return default_visit(op);
    }
    virtual result<void> visit(NNCASE_UNUSED const rem_u_op_t &op) noexcept {
        return default_visit(op);
    }
    virtual result<void> visit(NNCASE_UNUSED const and_op_t &op) noexcept {
        return default_visit(op);
    }
    virtual result<void> visit(NNCASE_UNUSED const or_op_t &op) noexcept {
        return default_visit(op);
    }
    virtual result<void> visit(NNCASE_UNUSED const xor_op_t &op) noexcept {
        return default_visit(op);
    }
    virtual result<void> visit(NNCASE_UNUSED const not_op_t &op) noexcept {
        return default_visit(op);
    }
    virtual result<void> visit(NNCASE_UNUSED const shl_op_t &op) noexcept {
        return default_visit(op);
    }
    virtual result<void> visit(NNCASE_UNUSED const shr_op_t &op) noexcept {
        return default_visit(op);
    }
    virtual result<void> visit(NNCASE_UNUSED const shr_u_op_t &op) noexcept {
        return default_visit(op);
    }
    virtual result<void> visit(NNCASE_UNUSED const clt_op_t &op) noexcept {
        return default_visit(op);
    }
    virtual result<void> visit(NNCASE_UNUSED const clt_u_op_t &op) noexcept {
        return default_visit(op);
    }
    virtual result<void> visit(NNCASE_UNUSED const cle_op_t &op) noexcept {
        return default_visit(op);
    }
    virtual result<void> visit(NNCASE_UNUSED const cle_u_op_t &op) noexcept {
        return default_visit(op);
    }
    virtual result<void> visit(NNCASE_UNUSED const ceq_op_t &op) noexcept {
        return default_visit(op);
    }
    virtual result<void> visit(NNCASE_UNUSED const cge_op_t &op) noexcept {
        return default_visit(op);
    }
    virtual result<void> visit(NNCASE_UNUSED const cge_u_op_t &op) noexcept {
        return default_visit(op);
    }
    virtual result<void> visit(NNCASE_UNUSED const cgt_op_t &op) noexcept {
        return default_visit(op);
    }
    virtual result<void> visit(NNCASE_UNUSED const cgt_u_op_t &op) noexcept {
        return default_visit(op);
    }
    virtual result<void> visit(NNCASE_UNUSED const cne_op_t &op) noexcept {
        return default_visit(op);
    }
    virtual result<void> visit(NNCASE_UNUSED const conv_i1_op_t &op) noexcept {
        return default_visit(op);
    }
    virtual result<void> visit(NNCASE_UNUSED const conv_i2_op_t &op) noexcept {
        return default_visit(op);
    }
    virtual result<void> visit(NNCASE_UNUSED const conv_i4_op_t &op) noexcept {
        return default_visit(op);
    }
    virtual result<void> visit(NNCASE_UNUSED const conv_i_op_t &op) noexcept {
        return default_visit(op);
    }
    virtual result<void> visit(NNCASE_UNUSED const conv_u1_op_t &op) noexcept {
        return default_visit(op);
    }
    virtual result<void> visit(NNCASE_UNUSED const conv_u2_op_t &op) noexcept {
        return default_visit(op);
    }
    virtual result<void> visit(NNCASE_UNUSED const conv_u4_op_t &op) noexcept {
        return default_visit(op);
    }
    virtual result<void> visit(NNCASE_UNUSED const conv_u_op_t &op) noexcept {
        return default_visit(op);
    }
    virtual result<void> visit(NNCASE_UNUSED const conv_br2_op_t &op) noexcept {
        return default_visit(op);
    }
    virtual result<void> visit(NNCASE_UNUSED const conv_r4_op_t &op) noexcept {
        return default_visit(op);
    }
  ...
  protected:
    virtual result<void>
    default_visit(NNCASE_UNUSED const op_base_t &op) noexcept {
