...
{
    stshape_op_t operator()(NNCASE_UNUSED span_reader &reader) const
    {
        stshape_op_t op;
        op.opcode = static_cast<opcode_t>(reader.read_unaligned<uint8_t>());
        return op;
...
template <>
struct op_reader<ststrides_op_t>
{
    ststrides_op_t operator()(NNCASE_UNUSED span_reader &reader) const
    {
        ststrides_op_t op;
        op.opcode = static_cast<opcode_t>(reader.read_unaligned<uint8_t>());
        return op;
...
template <>
struct op_reader<sttuple_op_t>
{
    sttuple_op_t operator()(NNCASE_UNUSED span_reader &reader) const
    {
        sttuple_op_t op;
        op.opcode = static_cast<opcode_t>(reader.read_unaligned<uint8_t>());
        return op;
...
public:
    ...
    virtual result<void> visit(NNCASE_UNUSED const stshape_op_t &op) noexcept { return default_visit(op); }
    virtual result<void> visit(NNCASE_UNUSED const ststrides_op_t &op) noexcept { return default_visit(op); }
    virtual result<void> visit(NNCASE_UNUSED const ldtuple_elem_op_t &op) noexcept { return default_visit(op); }
    virtual result<void> visit(NNCASE_UNUSED const sttuple_op_t &op) noexcept { return default_visit(op); }
