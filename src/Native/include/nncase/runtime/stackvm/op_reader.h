...
template <>
struct op_reader<ldscalar_op_t>
{
...
template <>
struct op_reader<tensor_erf_op_t>
{
...
template <>
struct op_reader<tensor_gelu_op_t>
{
...
template <>
struct op_reader<tensor_layer_norm_op_t>
{
...
template <>
struct op_reader<tensor_swish_op_t>
{
...
public:
    ...
    virtual result<void> visit(NNCASE_UNUSED const ldscalar_op_t &op) noexcept { return default_visit(op); }
    ...
    virtual result<void> visit(NNCASE_UNUSED const tensor_bitcast_op_t &op) noexcept { return default_visit(op); }
    ...
    virtual result<void> visit(NNCASE_UNUSED const tensor_condition_op_t &op) noexcept { return default_visit(op); }
    ...
    virtual result<void> visit(NNCASE_UNUSED const tensor_erf_op_t &op) noexcept { return default_visit(op); }
    ...
    virtual result<void> visit(NNCASE_UNUSED const tensor_gelu_op_t &op) noexcept { return default_visit(op); }
    ...
    virtual result<void> visit(NNCASE_UNUSED const tensor_layer_norm_op_t &op) noexcept { return default_visit(op); }
    ...
    virtual result<void> visit(NNCASE_UNUSED const tensor_swish_op_t &op) noexcept { return default_visit(op); }
    virtual result<void> visit(NNCASE_UNUSED const tensor_tile_op_t &op) noexcept { return default_visit(op); }
    virtual result<void> visit(NNCASE_UNUSED const tensor_top_k_op_t &op) noexcept { return default_visit(op); }
