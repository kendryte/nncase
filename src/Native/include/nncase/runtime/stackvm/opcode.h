/* This file is generated by tools/stackvm_gen/IsaGen at 2022/9/1 12:43:46 +08:00.
 *
...
enum class memory_location_t : uint8_t
{
    input = 0,
    output = 1,
    rdata = 2,
...
struct tensor_uninitialized_op_t : public tensor_op_base_t
{
    tensor_function_t tensor_funct;
    typecode_t dtype;
