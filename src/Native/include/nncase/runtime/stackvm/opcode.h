/* This file is generated by tools/stackvm_gen/IsaGen at 2022/7/14 20:43:24 +08:00.
 *
...
struct tensor_custom_call_op_t : public tensor_op_base_t
{
    std::string registered_name;
    int32_t field_size;
    gsl::span<const gsl::byte> fields;
    int32_t input_size;
};
...
inline std::string to_string(tensor_function_t tensor_funct)
{
    switch(tensor_funct)
    {
        ...
        case tensor_function_t::custom_call: return "custom_call";
