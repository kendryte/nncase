...
struct tensor_gelu_op_t : public tensor_op_base_t
{
    tensor_function_t tensor_funct;
};
...
struct tensor_swish_op_t : public tensor_op_base_t
{
    tensor_function_t tensor_funct;
};
...
inline std::string to_string(opcode_t code)
{
    switch(code)
    {
      ...
      case opcode_t::LDSHAPE: return "LDSHAPE";
      case opcode_t::LDSTRIDES: return "LDSTRIDES";
