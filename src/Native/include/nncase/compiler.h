...
NNCASE_API int nncase_clr_compiler_set_compile_service_options(clr_object_handle_t compile_options);
...
class compiler : public clr_object_base {
  public:
    ...
    void set_compile_service_options(const compile_options &options) {
        CHECK_CLR(nncase_clr_compiler_set_compile_service_options(options.get()));
    }
