...
{
    public TreeSolverBase(Solver solver, Dictionary<OpNode, OpNodeInfo<T>> opNodeMemo, Dictionary<TileNode, TileNodeInfo<T>> tileNodeMemo, Dictionary<ITileable, DomainInfo<T>> tileableNodeMemo, INTTTargetOptions targetOptions)
    {
        Solver = solver;
