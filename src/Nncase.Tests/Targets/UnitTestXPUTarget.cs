...
public class UnitTestXPUTarget : TestClassBase
{
    public UnitTestXPUTarget()
    {
    ...
    public void TestXPUTargetKind()
    {
        Assert.Equal("XPU", XPUTarget.Kind);
    }

    [Fact]
    [AutoSetupTestMethod(InitSession = false)]
    public void TestCreateXPUTarget()
    {
