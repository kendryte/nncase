...
public class UnitTestCustomOpScheme : TestClassBase
{
    ...
    {
        var scheme = new CustomOpScheme("1", "matmul", new CustomOpScheme.Node[] { new CustomOpScheme.Node(string.Empty, "Matmul", new[] { new[] { 32, 32 }, new[] { 32, 32 } }, new[] { new SBP[] { SBP.B, SBP.B, SBP.B }, new SBP[] { SBP.B, SBP.B, SBP.S(1) } }, 1, string.Empty) });
        var except = @"{
  ""Version"": ""1"",
  ""Model"": ""matmul"",
  ""Outputs"": [
