...
public class UnitTestFocusFull : TransformTestBase
{
    ...
    public void TestPositive()
    {
        ...
        var s2 = IR.F.Tensors.Slice(input, new long[] { 0, 1 }, new long[] { 640, 640 }, new[] { 2, 3 }, new[] { 2, 2 });
        var s3 = IR.F.Tensors.Slice(input, new long[] { 1, 1 }, new long[] { 640, 640 }, new[] { 2, 3 }, new[] { 2, 2 });
    ...
    public void TestNegative()
    {
        ...
        var s0 = IR.F.Tensors.Slice(input, new long[] { 0, 0 }, new long[] { 640, 640 }, new[] { 2, 3 }, new[] { 2, 2 });
        var s1 = IR.F.Tensors.Slice(input, new long[] { 1, 0 }, new long[] { 640, 640 }, new[] { 2, 3 }, new[] { 2, 2 });
        var s2 = IR.F.Tensors.Slice(input, new long[] { 0, 1 }, new long[] { 640, 280 }, new[] { 2, 3 }, new[] { 2, 2 });
        var s3 = IR.F.Tensors.Slice(input, new long[] { 1, 1 }, new long[] { 640, 640 }, new[] { 2, 3 }, new[] { 2, 2 });
        var rootPre = IR.F.Tensors.Concat(new IR.Tuple(s0, s1, s2, s3), 1);
