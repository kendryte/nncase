...
public class UnitTestReshapeBatchMatmul : TransformTestBase
{
    public static IEnumerable<object[]> TestReshapeBatchMatmulPositiveData =>
        new[]
        {
            new object[] { new long[] { 2, 1, 4 }, new long[] { 4, 6 } },
            new object[] { new long[] { 3, 1, 7 }, new long[] { 1, 7, 12 } },
            new object[] { new long[] { 1, 3, 1, 7 }, new long[] { 1, 1, 7, 12 } },
        };

    public static IEnumerable<object[]> TestReshapeBatchMatmulNegativeData =>
        new[]
        {
            new object[] { new long[] { 2, 1, 4 }, new[] { 4, Dimension.Unknown } },
        };

    [Theory]
    [MemberData(nameof(TestReshapeBatchMatmulPositiveData))]
    public void TestReshapeBatchMatmulPositive(long[] aShape, long[] bShape)
    {
    ...
    public void TestReshapeBatchMatmulNegative(long[] aShape, Dimension[] bShape)
    {
        var a = Random.Normal(DataTypes.Float32, 0, 1, 0, aShape);
