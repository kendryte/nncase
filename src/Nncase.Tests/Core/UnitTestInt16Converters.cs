...
public sealed class UnitTestInt16Converters
{
    public static unsafe IEnumerable<object[]> TestBoolData =>
        new[]
        {
            new object[] { new bool[] { true, false, true, false }, new short[] { 1, 0, 3, 0 }, CastMode.KDefault },
            new object[] { new bool[] { true, false, true, false }, new short[] { 1, 0, 3, 0 }, CastMode.CheckOverflow },
            new object[] { new bool[] { true, false, true, false }, new short[] { 1, 0, 3, 0 }, CastMode.Reinterpret },
        };

    [Theory]
    [MemberData(nameof(TestBoolData))]
    public void TestConvertToBool(bool[] expected, short[] src, CastMode mode)
    {
        var actual = new bool[src.Length];
        var c = new Int16Converters();
    ...
    {
        var a = new short[] { 1, 2, 3, short.MaxValue };
    ...
    {
        var a = new short[] { 1, 2, 3, 4 };
        var actual = new short[a.Length - 1];
        var c = new Int16Converters();

        Assert.Throws<ArgumentException>(() => c.ConvertTo(a, actual, CastMode.Exact));
    }
    ...
    {
        var a = new short[] { 1, 2, 3, short.MinValue };
