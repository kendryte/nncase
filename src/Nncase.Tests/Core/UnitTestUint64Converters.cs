...
public sealed class UnitTestUInt64Converters
{
    public static unsafe IEnumerable<object[]> TestBoolData =>
        new[]
        {
            new object[] { new bool[] { true, false, true, false }, new ulong[] { 1, 0, 3, 0 }, CastMode.KDefault },
            new object[] { new bool[] { true, false, true, false }, new ulong[] { 1, 0, 3, 0 }, CastMode.CheckOverflow },
            new object[] { new bool[] { true, false, true, false }, new ulong[] { 1, 0, 3, 0 }, CastMode.Reinterpret },
        };

    [Theory]
    [MemberData(nameof(TestBoolData))]
    public void TestConvertToBool(bool[] expected, ulong[] src, CastMode mode)
    {
        var actual = new bool[src.Length];
        var c = new UInt64Converters();
    ...
    {
        var a = new ulong[] { 1, 2, 3, ulong.MaxValue };
    ...
    {
        var a = new ulong[] { 1, 2, 3, 4 };
        var actual = new ulong[a.Length - 1];
        var c = new UInt64Converters();
