...
public class UnitTestExpression
{
    ...
    public void TestConstBufferNotEqual()
    {
        ...
        var ddr_ld_output = new TIR.BufferRegion(new TIR.Buffer("ddr_ld_input", DataTypes.Float32, new MemSpan(0, 0, MemoryLocation.Input), new Dimension[] { 1, 16, 64, 400 }, TensorUtilities.GetDefaultStrides(new Dimension[] { 1, 16, 64, 400 }), null), new(new TIR.Range[] { 0..1, 0..16, 0..31, 0..400 }));
    ...
    {
        var ddr_ld_input = new TIR.BufferRegion(new TIR.Buffer("ddr_ld_input", DataTypes.Float32, new MemSpan(0, 0, MemoryLocation.Input), new Dimension[] { 1, 16, 64, 400 }, TensorUtilities.GetDefaultStrides(new Dimension[] { 1, 16, 64, 400 }), null), new(new TIR.Range[] { 0..1, 0..16, 0..31, 0..400 }));
        var ddr_ld_output = new TIR.BufferRegion(new TIR.Buffer("ddr_ld_input", DataTypes.Float32, new MemSpan(0, 0, MemoryLocation.Input), new Dimension[] { 1, 16, 64, 400 }, TensorUtilities.GetDefaultStrides(new Dimension[] { 1, 16, 64, 400 }), null), new(new TIR.Range[] { 0..1, 0..16, 0..31, 0..400 }));
    ...
    {
        var ddr_ld_input = new TIR.BufferRegion(new TIR.Buffer("ddr_ld_input", DataTypes.Float32, new MemSpan(0, 0, MemoryLocation.Input), new Dimension[] { 1, 16, 64, 400 }, TensorUtilities.GetDefaultStrides(new Dimension[] { 1, 16, 64, 400 }), null), new(new TIR.Range[] { 0..1, 0..16, 0..31, 0..400 }));
        var glb_ld_output = new TIR.BufferRegion(new TIR.Buffer("glb_ld_output", DataTypes.BFloat16, new MemSpan(0, 0, MemoryLocation.Data), new Dimension[] { 1, 16, 64, 400 }, TensorUtilities.GetDefaultStrides(new Dimension[] { 1, 16, 64, 400 }), null), new(new TIR.Range[] { 0..1, 0..16, 0..31, 0..400 }));
