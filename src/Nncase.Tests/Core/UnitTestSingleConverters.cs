...
public sealed class UnitTestSingleConverters
{
    public static unsafe IEnumerable<object[]> TestBoolData =>
        new[]
        {
            new object[] { new bool[] { true, false, true, false }, new float[] { 1, 0, 3, 0 }, CastMode.KDefault },
            new object[] { new bool[] { true, false, true, false }, new float[] { 1, 0, 3, 0 }, CastMode.CheckOverflow },
            new object[] { new bool[] { true, false, true, false }, new float[] { 1, 0, 3, 0 }, CastMode.Reinterpret },
        };

    [Theory]
    [MemberData(nameof(TestBoolData))]
    public void TestConvertToBool(bool[] expected, float[] src, CastMode mode)
    {
        var actual = new bool[src.Length];
        var c = new SingleConverters();
    ...
    {
        var a = new float[] { 1, 2, 3, (float)sbyte.MaxValue + 1 };
    ...
    {
        var a = new float[] { 1, 2, 3, (float)byte.MaxValue + 1 };
    ...
    {
        var a = new float[] { 1, 2, 3, (float)short.MaxValue + 1 };
    ...
    {
        var a = new float[] { 1, 2, 3, (float)ushort.MaxValue + 1 };
    ...
    {
        var a = new float[] { 1, 2, 3, (float)int.MaxValue + 1 };
    ...
    {
        var a = new float[] { 1, 2, 3, (float)uint.MaxValue + 1F };
    ...
    {
        var a = new float[] { 1, 2, 3, (float)long.MaxValue + 1F };
    ...
    {
        var a = new float[] { 1, 2, 3, (float)ulong.MaxValue + 1F };
    ...
    {
        var a = new float[] { 1, 2, 3, 4 };
        var actual = new float[a.Length - 1];
        var c = new SingleConverters();
