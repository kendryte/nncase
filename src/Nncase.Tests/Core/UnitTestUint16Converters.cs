...
public sealed class UnitTestUInt16Converters
{
    public static unsafe IEnumerable<object[]> TestBoolData =>
        new[]
        {
            new object[] { new bool[] { true, false, true, false }, new ushort[] { 1, 0, 3, 0 }, CastMode.KDefault },
            new object[] { new bool[] { true, false, true, false }, new ushort[] { 1, 0, 3, 0 }, CastMode.CheckOverflow },
            new object[] { new bool[] { true, false, true, false }, new ushort[] { 1, 0, 3, 0 }, CastMode.Reinterpret },
        };

    [Theory]
    [MemberData(nameof(TestBoolData))]
    public void TestConvertToBool(bool[] expected, ushort[] src, CastMode mode)
    {
        var actual = new bool[src.Length];
        var c = new UInt16Converters();
    ...
    {
        var a = new ushort[] { 1, 2, 3, ushort.MaxValue };
    ...
    {
        var a = new ushort[] { 1, 2, 3, 4 };
        var actual = new ushort[a.Length - 1];
        var c = new UInt16Converters();
