...
public sealed class UnitTestInt8Converters
{
    public static unsafe IEnumerable<object[]> TestBoolData =>
        new[]
        {
            new object[] { new bool[] { true, false, true, false }, new sbyte[] { 1, 0, 3, 0 }, CastMode.KDefault },
            new object[] { new bool[] { true, false, true, false }, new sbyte[] { 1, 0, 3, 0 }, CastMode.CheckOverflow },
            new object[] { new bool[] { true, false, true, false }, new sbyte[] { 1, 0, 3, 0 }, CastMode.Reinterpret },
        };

    [Theory]
    [MemberData(nameof(TestBoolData))]
    public void TestConvertToBool(bool[] expected, sbyte[] src, CastMode mode)
    {
        var actual = new bool[src.Length];
        var c = new Int8Converters();
    ...
    {
        var a = new sbyte[] { 1, 2, 3, 4 };
        var actual = new sbyte[a.Length - 1];
        var c = new Int8Converters();
    ...
    {
        var a = new sbyte[] { 1, 2, 3, sbyte.MinValue };
