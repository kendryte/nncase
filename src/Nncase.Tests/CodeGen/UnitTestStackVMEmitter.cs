...
public class UnitTestStackVMEmitter
{
    ...
    public void TestStackVMEmitterGBinary()
    {
        ...
        var actual = memoryStream.ToArray();
        Assert.Equal(new byte[] { 100, 2, 0, 0 }, actual);
    }
    ...
    public void TestStackVMEmitterGBatchToSpace()
    {
        ...
        var actual = memoryStream.ToArray();
        Assert.Equal(new byte[] { 100, 1, 0 }, actual);
    }
    ...
    public void TestStackVMEmitterGBitcast()
    {
        ...
        var actual = memoryStream.ToArray();
        Assert.Equal(new byte[] { 100, 3, 0, 0, 0 }, actual);
    }
    ...
    public void TestStackVMEmitterGBroadcast()
    {
        ...
        var actual = memoryStream.ToArray();
        Assert.Equal(new byte[] { 100, 4, 0 }, actual);
    }
    ...
    public void TestStackVMEmitterGCast()
    {
        ...
        var actual = memoryStream.ToArray();
        Assert.Equal(new byte[] { 100, 5, 0, 11, 1, 0, 0, 0 }, actual);
    }
    ...
    public void TestStackVMEmitterGCelu()
    {
        ...
        tensorEmitter.Celu();
        var actual = memoryStream.ToArray();
        Assert.Equal(new byte[] { 100, 6, 0 }, actual);
    }
    ...
    public void TestStackVMEmitterGClamp()
    {
        ...
        tensorEmitter.Clamp();
        var actual = memoryStream.ToArray();
        Assert.Equal(new byte[] { 100, 7, 0 }, actual);
    }
    ...
    public void TestStackVMEmitterGCompare()
    {
        ...
        var actual = memoryStream.ToArray();
        Assert.Equal(new byte[] { 100, 8, 0, 0 }, actual);
    }
    ...
    public void TestStackVMEmitterGConcat()
    {
        ...
        var actual = memoryStream.ToArray();
        Assert.Equal(new byte[] { 100, 9, 0 }, actual);
    }
    ...
    public void TestStackVMEmitterGCondition()
    {
        ...
        var actual = memoryStream.ToArray();
        Assert.Equal(new byte[] { 100, 10, 0, 1 }, actual);
    }
    ...
    public void TestStackVMEmitterGConstantOfShape()
    {
        ...
        var actual = memoryStream.ToArray();
        Assert.Equal(new byte[] { 100, 11, 0 }, actual);
    }
    ...
    public void TestStackVMEmitterGConv2D()
    {
        ...
        var actual = memoryStream.ToArray();
        Assert.Equal(new byte[] { 100, 12, 0, 0 }, actual);
    }
    ...
    public void TestStackVMEmitterGConv2DTranspose()
    {
        ...
        var actual = memoryStream.ToArray();
        Assert.Equal(new byte[] { 100, 13, 0, 0 }, actual);
    }
    ...
    public void TestStackVMEmitterGCumSum()
    {
        ...
        var actual = memoryStream.ToArray();
        Assert.Equal(new byte[] { 100, 14, 0 }, actual);
    }
    ...
    public void TestStackVMEmitterGDequantize()
    {
        ...
        var actual = memoryStream.ToArray();
        Assert.Equal(new byte[] { 100, 15, 0, 0 }, actual);
    }
    ...
    public void TestStackVMEmitterGBatchNormalization()
    {
        ...
        var actual = memoryStream.ToArray();
        Assert.Equal(new byte[] { 100, 0, 0 }, actual);
    }
    ...
    public void TestStackVMEmitterGElu()
    {
        ...
        tensorEmitter.Elu();
        var actual = memoryStream.ToArray();
        Assert.Equal(new byte[] { 100, 16, 0 }, actual);
    }
    ...
    public void TestStackVMEmitterGErf()
    {
        ...
        tensorEmitter.Erf();
        var actual = memoryStream.ToArray();
        Assert.Equal(new byte[] { 100, 17, 0 }, actual);
    }
    ...
    public void TestStackVMEmitterGExpand()
    {
        ...
        var actual = memoryStream.ToArray();
        Assert.Equal(new byte[] { 100, 18, 0 }, actual);
    }
    ...
    public void TestStackVMEmitterGFakeDequantize()
    {
        ...
        var actual = memoryStream.ToArray();
        Assert.Equal(new byte[] { 100, 19, 0, 0 }, actual);
    }
    ...
    public void TestStackVMEmitterGFakeQuantize()
    {
        ...
        var actual = memoryStream.ToArray();
        Assert.Equal(new byte[] { 100, 20, 0, 0 }, actual);
    }
    ...
    public void TestStackVMEmitterGFlatten()
    {
        ...
        var actual = memoryStream.ToArray();
        Assert.Equal(new byte[] { 100, 21, 0 }, actual);
    }
    ...
    public void TestStackVMEmitterGGather()
    {
        ...
        var actual = memoryStream.ToArray();
        Assert.Equal(new byte[] { 100, 22, 0 }, actual);
    }
    ...
    public void TestStackVMEmitterGGatherND()
    {
        ...
        var actual = memoryStream.ToArray();
        Assert.Equal(new byte[] { 100, 23, 0 }, actual);
    }
    ...
    public void TestStackVMEmitterGGelu()
    {
        ...
        tensorEmitter.Gelu();
        var actual = memoryStream.ToArray();
        Assert.Equal(new byte[] { 100, 24, 0 }, actual);
    }
    ...
    public void TestStackVMEmitterGHardmax()
    {
        ...
        var actual = memoryStream.ToArray();
        Assert.Equal(new byte[] { 100, 26, 0 }, actual);
    }
    ...
    public void TestStackVMEmitterGHardSigmoid()
    {
        ...
        var actual = memoryStream.ToArray();
        Assert.Equal(new byte[] { 100, 27, 0 }, actual);
    }
    ...
    public void TestStackVMEmitterGHardSwish()
    {
        ...
        var actual = memoryStream.ToArray();
        Assert.Equal(new byte[] { 100, 28, 0 }, actual);
    }
    ...
    public void TestStackVMEmitterGInstanceNormalization()
    {
        ...
        var actual = memoryStream.ToArray();
        Assert.Equal(new byte[] { 100, 29, 0 }, actual);
    }
    ...
    public void TestStackVMEmitterGL2Normalization()
    {
        ...
        var actual = memoryStream.ToArray();
        Assert.Equal(new byte[] { 100, 30, 0 }, actual);
    }
    ...
    public void TestStackVMEmitterGLayerNorm()
    {
        ...
        var actual = memoryStream.ToArray();
        Assert.Equal(new byte[] { 100, 31, 0, 255, 255, 255, 255, 0, 0, 0, 0 }, actual);
    }
    ...
    public void TestStackVMEmitterGLeakyRelu()
    {
        ...
        var actual = memoryStream.ToArray();
        Assert.Equal(new byte[] { 100, 32, 0 }, actual);
    }
    ...
    public void TestStackVMEmitterGLogSoftmax()
    {
        ...
        var actual = memoryStream.ToArray();
        Assert.Equal(new byte[] { 100, 33, 0 }, actual);
    }
    ...
    public void TestStackVMEmitterGLpNormalization()
    {
        ...
        var actual = memoryStream.ToArray();
        Assert.Equal(new byte[] { 100, 34, 0 }, actual);
    }
    ...
    public void TestStackVMEmitterGLRN()
    {
        ...
        tensorEmitter.LRN();
        var actual = memoryStream.ToArray();
        Assert.Equal(new byte[] { 100, 35, 0 }, actual);
    }
    ...
    public void TestStackVMEmitterGLSTM()
    {
        ...
        var actual = memoryStream.ToArray();
        Assert.Equal(new byte[] { 100, 36, 0, 2, 0, 0, 0, 1, 0, 0, 0, 116, 97, 110, 104, 0, 0 }, actual);
    }
    ...
    public void TestStackVMEmitterGMatMul()
    {
        ...
        var actual = memoryStream.ToArray();
        Assert.Equal(new byte[] { 100, 37, 0 }, actual);
    }
    ...
    public void TestStackVMEmitterGNormal()
    {
        ...
        var actual = memoryStream.ToArray();
        Assert.Equal(new byte[] { 100, 38, 0, 0 }, actual);
    }
    ...
    public void TestStackVMEmitterGNormalLike()
    {
        ...
        var actual = memoryStream.ToArray();
        Assert.Equal(new byte[] { 100, 39, 0, 0 }, actual);
    }
    ...
    public void TestStackVMEmitterGOneHot()
    {
        ...
        var actual = memoryStream.ToArray();
        Assert.Equal(new byte[] { 100, 40, 0, 0 }, actual);
    }
    ...
    public void TestStackVMEmitterGPad()
    {
        ...
        var actual = memoryStream.ToArray();
        Assert.Equal(new byte[] { 100, 41, 0, 0 }, actual);
    }
    ...
    public void TestStackVMEmitterGPRelu()
    {
        ...
        tensorEmitter.PRelu();
        var actual = memoryStream.ToArray();
        Assert.Equal(new byte[] { 100, 42, 0 }, actual);
    }
    ...
    public void TestStackVMEmitterGProd()
    {
        ...
        tensorEmitter.Prod();
        var actual = memoryStream.ToArray();
        Assert.Equal(new byte[] { 100, 43, 0 }, actual);
    }
    ...
    public void TestStackVMEmitterGQuantize()
    {
        ...
        var actual = memoryStream.ToArray();
        Assert.Equal(new byte[] { 100, 44, 0, 0 }, actual);
    }
    ...
    public void TestStackVMEmitterGQuantParamOf()
    {
        ...
        var actual = memoryStream.ToArray();
        Assert.Equal(new byte[] { 100, 45, 0, 0, 0, 0, 0 }, actual);
    }
    ...
    public void TestStackVMEmitterGRange()
    {
        ...
        tensorEmitter.Range();
        var actual = memoryStream.ToArray();
        Assert.Equal(new byte[] { 100, 46, 0 }, actual);
    }
    ...
    public void TestStackVMEmitterGReduce()
    {
        ...
        var actual = memoryStream.ToArray();
        Assert.Equal(new byte[] { 100, 48, 0, 4 }, actual);
    }
    ...
    public void TestStackVMEmitterGReduceArg()
    {
        ...
        var actual = memoryStream.ToArray();
        Assert.Equal(new byte[] { 100, 49, 0, 1, 11 }, actual);
    }
    ...
    public void TestStackVMEmitterGReduceWindow2D()
    {
        ...
        var actual = memoryStream.ToArray();
        Assert.Equal(new byte[] { 100, 50, 0, 4 }, actual);
    }
    ...
    public void TestStackVMEmitterGRelu()
    {
        ...
        tensorEmitter.Relu();
        var actual = memoryStream.ToArray();
        Assert.Equal(new byte[] { 100, 51, 0 }, actual);
    }
    ...
    public void TestStackVMEmitterGRelu6()
    {
        ...
        tensorEmitter.Relu6();
        var actual = memoryStream.ToArray();
        Assert.Equal(new byte[] { 100, 52, 0 }, actual);
    }
    ...
    public void TestStackVMEmitterGRequire()
    {
        ...
        var actual = memoryStream.ToArray();
        Assert.Equal(new byte[] { 100, 53, 0, 0 }, actual);
    }
    ...
    public void TestStackVMEmitterGReshape()
    {
        ...
        var actual = memoryStream.ToArray();
        Assert.Equal(new byte[] { 100, 54, 0 }, actual);
    }
    ...
    public void TestStackVMEmitterGReverseSequence()
    {
        ...
        var actual = memoryStream.ToArray();
        Assert.Equal(new byte[] { 100, 56, 0 }, actual);
    }
    ...
    public void TestStackVMEmitterGResizeImage()
    {
        ...
        var actual = memoryStream.ToArray();
        Assert.Equal(new byte[] { 100, 55, 0, 0, 3, 0, 0, 0, 3, 0, 0, 0, 0 }, actual);
    }
    ...
    public void TestStackVMEmitterGSelect()
    {
        ...
        var actual = memoryStream.ToArray();
        Assert.Equal(new byte[] { 100, 57, 0 }, actual);
    }
    ...
    public void TestStackVMEmitterGSelu()
    {
        ...
        tensorEmitter.Selu();
        var actual = memoryStream.ToArray();
        Assert.Equal(new byte[] { 100, 58, 0 }, actual);
    }
    ...
    public void TestStackVMEmitterGShapeOf()
    {
        ...
        var actual = memoryStream.ToArray();
        Assert.Equal(new byte[] { 100, 59, 0 }, actual);
    }
    ...
    public void TestStackVMEmitterGSigmoid()
    {
        ...
        var actual = memoryStream.ToArray();
        Assert.Equal(new byte[] { 100, 60, 0 }, actual);
    }
    ...
    public void TestStackVMEmitterGSizeOf()
    {
        ...
        var actual = memoryStream.ToArray();
        Assert.Equal(new byte[] { 100, 61, 0 }, actual);
    }
    ...
    public void TestStackVMEmitterGSlice()
    {
        ...
        tensorEmitter.Slice();
        var actual = memoryStream.ToArray();
        Assert.Equal(new byte[] { 100, 62, 0 }, actual);
    }
    ...
    public void TestStackVMEmitterGSoftmax()
    {
        ...
        var actual = memoryStream.ToArray();
        Assert.Equal(new byte[] { 100, 63, 0 }, actual);
    }
    ...
    public void TestStackVMEmitterGSoftplus()
    {
        ...
        var actual = memoryStream.ToArray();
        Assert.Equal(new byte[] { 100, 64, 0 }, actual);
    }
    ...
    public void TestStackVMEmitterGSpaceToBatch()
    {
        ...
        var actual = memoryStream.ToArray();
        Assert.Equal(new byte[] { 100, 66, 0 }, actual);
    }
    ...
    public void TestStackVMEmitterGSplit()
    {
        ...
        tensorEmitter.Split();
        var actual = memoryStream.ToArray();
        Assert.Equal(new byte[] { 100, 67, 0 }, actual);
    }
    ...
    public void TestStackVMEmitterGSqueeze()
    {
        ...
        var actual = memoryStream.ToArray();
        Assert.Equal(new byte[] { 100, 68, 0 }, actual);
    }
    ...
    public void TestStackVMEmitterGStack()
    {
        ...
        tensorEmitter.Stack();
        var actual = memoryStream.ToArray();
        Assert.Equal(new byte[] { 100, 69, 0 }, actual);
    }
    ...
    public void TestStackVMEmitterGSwish()
    {
        ...
        tensorEmitter.Swish();
        var actual = memoryStream.ToArray();
        Assert.Equal(new byte[] { 100, 70, 0 }, actual);
    }
    ...
    public void TestStackVMEmitterGTile()
    {
        ...
        tensorEmitter.Tile();
        var actual = memoryStream.ToArray();
        Assert.Equal(new byte[] { 100, 71, 0 }, actual);
    }
    ...
    public void TestStackVMEmitterGTopK()
    {
        ...
        tensorEmitter.TopK();
        var actual = memoryStream.ToArray();
        Assert.Equal(new byte[] { 100, 72, 0 }, actual);
    }
    ...
    public void TestStackVMEmitterGTranspose()
    {
        ...
        var actual = memoryStream.ToArray();
        Assert.Equal(new byte[] { 100, 73, 0 }, actual);
    }
    ...
    public void TestStackVMEmitterGUniform()
    {
        ...
        var actual = memoryStream.ToArray();
        Assert.Equal(new byte[] { 100, 75, 0, 11 }, actual);
    }
    ...
    public void TestStackVMEmitterGUniformLike()
    {
        ...
        var actual = memoryStream.ToArray();
        Assert.Equal(new byte[] { 100, 76, 0, 11 }, actual);
    }
    ...
    public void TestStackVMEmitterGUnsqueeze()
    {
        ...
        var actual = memoryStream.ToArray();
        Assert.Equal(new byte[] { 100, 77, 0 }, actual);
    }
    ...
    public void TestStackVMEmitterGWhere()
    {
        ...
        var actual = memoryStream.ToArray();
        Assert.Equal(new byte[] { 100, 78, 0, 0 }, actual);
    }
    ...
    public void TestStackVMEmitterGSoftsign()
    {
        ...
        var actual = memoryStream.ToArray();
        Assert.Equal(new byte[] { 100, 65, 0 }, actual);
    }
}
