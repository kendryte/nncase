...
public unsafe struct CApiMT
{
    ...
    public delegate* unmanaged<IntPtr, AutoDistributedSearchStrategy> CpuTargetOptionsGetDistributedSearchStrategyPtr;
    public delegate* unmanaged<IntPtr, AutoDistributedSearchStrategy, void> CpuTargetOptionsSetDistributedSearchStrategyPtr;
...
public static unsafe class CApi
{
    ...
    public static void Initialize(CApiMT* mt)
    {
        ...
        mt->CpuTargetOptionsGetDistributedSearchStrategyPtr = &CpuTargetOptionsGetDistributedSearchStrategy;
        mt->CpuTargetOptionsSetDistributedSearchStrategyPtr = &CpuTargetOptionsSetDistributedSearchStrategy;
    ...
    [UnmanagedCallersOnly]
    private static AutoDistributedSearchStrategy CpuTargetOptionsGetDistributedSearchStrategy(IntPtr handle)
    {
        return Get<CpuTargetOptions>(handle).DistributedSearchStrategy;
    }

    [UnmanagedCallersOnly]
    private static void CpuTargetOptionsSetDistributedSearchStrategy(IntPtr handle, AutoDistributedSearchStrategy value)
    {
        Get<CpuTargetOptions>(handle).DistributedSearchStrategy = value;
    }
