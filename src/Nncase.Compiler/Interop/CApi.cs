...
public unsafe struct CApiMT
{
    ...
    public delegate* unmanaged<IntPtr, void> CompilerSetCompileServiceOptionPtr;
...
public static unsafe class CApi
{
    ...
    public static void Initialize(CApiMT* mt)
    {
        ...
        mt->CompilerSetCompileServiceOptionPtr = &CompilerSetCompileServiceOption;
    ...
    [UnmanagedCallersOnly]
    private static void CompilerSetCompileServiceOption(IntPtr compileOptionsHandle)
    {
        CompilerServices.CompileOptions = Get<CompileOptions>(compileOptionsHandle);
    }
