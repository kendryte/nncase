...
public unsafe struct CApiMT
{
    ...
    public delegate* unmanaged<IntPtr, IntPtr, void> CompileOptionsSetHuggingFaceOptionsPtr;
    ...
    public delegate* unmanaged<IntPtr, HierarchyKind> CpuTargetOptionsGetHierarchyKindPtr;
...
public static unsafe class CApi
{
    ...
    public static void Initialize(CApiMT* mt)
    {
        ...
        mt->CompileOptionsSetHuggingFaceOptionsPtr = &CompileOptionsSetHuggingFaceOptions;
        ...
        mt->CpuTargetOptionsSetModelNamePtr = &CpuTargetOptionsSetModelName;
        mt->CpuTargetOptionsSetPackingPtr = &CpuTargetOptionsSetPacking;
        mt->CpuTargetOptionsSetUnifiedMemoryArchPtr = &CpuTargetOptionsSetUnifiedMemoryArch;
        mt->CpuTargetOptionsGetMemoryAccessArchPtr = &CpuTargetOptionsGetMemoryAccessArch;
        mt->CpuTargetOptionsSetMemoryAccessArchPtr = &CpuTargetOptionsSetMemoryAccessArch;
        mt->CpuTargetOptionsGetNocArchPtr = &CpuTargetOptionsGetNocArch;
        mt->CpuTargetOptionsSetNocArchPtr = &CpuTargetOptionsSetNocArch;
        mt->CpuTargetOptionsGetHierarchyKindPtr = &CpuTargetOptionsGetHierarchyKind;
    ...
    [UnmanagedCallersOnly]
    private static void CompileOptionsSetHuggingFaceOptions(IntPtr compileOptionsHandle, IntPtr huggingFaceOptionsHandle)
    {
        Get<CompileOptions>(compileOptionsHandle).HuggingFaceOptions = Get<HuggingFaceOptions>(huggingFaceOptionsHandle);
    }
    ...
    {
        switch (outputAttentions)
        {
            case 0:
                Get<HuggingFaceOptions>(huggingFaceOptionsHandle).OutputAttentions = false;
                break;
            case 1:
                Get<HuggingFaceOptions>(huggingFaceOptionsHandle).OutputAttentions = true;
                break;
            default:
                throw new ArgumentException("Invalid OutputAttentions Flag");
        }
    }
    ...
    {
        switch (outputHiddenStates)
        {
            case 0:
                Get<HuggingFaceOptions>(huggingFaceOptionsHandle).OutputHiddenStates = false;
                break;
            case 1:
                Get<HuggingFaceOptions>(huggingFaceOptionsHandle).OutputHiddenStates = true;
                break;
            default:
                throw new ArgumentException("Invalid OutputHiddenStates Flag");
        }
    }
    ...
    private static void HuggingFaceOptionsUseCache(IntPtr huggingFaceOptionsHandle, byte useCache)
    {
        ...
        {
            case 0:
                Get<HuggingFaceOptions>(huggingFaceOptionsHandle).UseCache = false;
                break;
            case 1:
                Get<HuggingFaceOptions>(huggingFaceOptionsHandle).UseCache = true;
                break;
            default:
                throw new ArgumentException("Invalid UseCache Flag");
        }
    }
    ...
    {
        return GCHandle.ToIntPtr(GCHandle.Alloc(new CpuTargetOptions()));
    }

    [UnmanagedCallersOnly]
    private static void CpuTargetOptionsSetModelName(IntPtr handle, byte* value, nuint length)
    {
        Get<CpuTargetOptions>(handle).ModelName = ToString(value, length);
    }

    [UnmanagedCallersOnly]
    private static void CpuTargetOptionsSetPacking(IntPtr handle, byte value)
    {
        Get<CpuTargetOptions>(handle).Packing = value != 0;
    }

    [UnmanagedCallersOnly]
    private static void CpuTargetOptionsSetUnifiedMemoryArch(IntPtr handle, byte value)
    {
    ...
    {
        return Get<CpuTargetOptions>(handle).MemoryAccessArch;
    }

    [UnmanagedCallersOnly]
    private static void CpuTargetOptionsSetMemoryAccessArch(IntPtr handle, MemoryAccessArchitecture value)
    {
    ...
    {
        return Get<CpuTargetOptions>(handle).NocArch;
    }

    [UnmanagedCallersOnly]
    private static void CpuTargetOptionsSetNocArch(IntPtr handle, NocArchitecture value)
    {
    ...
    {
        return Get<CpuTargetOptions>(handle).HierarchyKind;
    }

    [UnmanagedCallersOnly]
    private static void CpuTargetOptionsSetHierarchyKind(IntPtr handle, HierarchyKind value)
    {
        Get<CpuTargetOptions>(handle).HierarchyKind = value;
    }

    [UnmanagedCallersOnly]
    private static void CpuTargetOptionsSetHierarchies(IntPtr handle, int* value, nuint shape0, nuint* shape1)
    {
        Get<CpuTargetOptions>(handle).Hierarchies = To2DArray(value, shape0, shape1);
    }

    [UnmanagedCallersOnly]
    private static void CpuTargetOptionsSetHierarchyNames(IntPtr handle, byte* value, nuint length)
    {
        Get<CpuTargetOptions>(handle).HierarchyNames = ToString(value, length);
    }
    ...
    [UnmanagedCallersOnly]
    private static void CpuTargetOptionsSetMemoryCapacities(IntPtr handle, int* value, nuint shape0)
    {
        Get<CpuTargetOptions>(handle).MemoryCapacities = To1DArray(value, shape0);
    }

    [UnmanagedCallersOnly]
    private static void CpuTargetOptionsSetMemoryBandWidths(IntPtr handle, int* value, nuint shape0)
    {
        Get<CpuTargetOptions>(handle).MemoryBandWidths = To1DArray(value, shape0);
    }

    [UnmanagedCallersOnly]
    private static void CpuTargetOptionsSetDistributedScheme(IntPtr handle, byte* value, nuint length)
    {
        Get<CpuTargetOptions>(handle).DistributedScheme = ToString(value, length);
    }

    [UnmanagedCallersOnly]
    private static void CpuTargetOptionsSetCustomOpScheme(IntPtr handle, byte* value, nuint length)
    {
        Get<CpuTargetOptions>(handle).CustomOpScheme = ToString(value, length);
    }
