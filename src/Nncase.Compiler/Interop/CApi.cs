...
public unsafe struct CApiMT
{
    ...
    public delegate* unmanaged<IntPtr, byte, void> NTTTargetOptionsSetPackingPtr;
    ...
    public delegate* unmanaged<nint, long*, long*, nuint, IntPtr> RefPagedAttentionSchedulePtr;
...
public static unsafe class CApi
{
    ...
    public static void Initialize(CApiMT* mt)
    {
        ...
        mt->NTTTargetOptionsSetPackingPtr = &NTTTargetOptionsSetPacking;
        ...
        mt->RefPagedAttentionSchedulePtr = &RefPagedAttentionSchedule;
    ...
    private static IntPtr ExprEvaluate(IntPtr exprHandle, IntPtr fnParamsHandle, IntPtr inputsHandle)
    {
        ...
        var fnParams = Get<IVar[]>(fnParamsHandle);
        var inputs = Get<RTValue[]>(inputsHandle); // switch to IValue
    ...
    [UnmanagedCallersOnly]
    private static void NTTTargetOptionsSetPacking(IntPtr handle, byte value)
    {
        Get<NTTTargetOptions>(handle).Packing = value != 0;
    }
    ...
    [UnmanagedCallersOnly]
    private static IntPtr RefPagedAttentionSchedule(IntPtr handle, [In] long* sessionIdsPtr, [In] long* queryLensPtr, nuint numQueries)
    {
