...
#else
static __inline __attribute__((__always_inline__)) void add_f32_vv_r(const float *input0, const float *input1, float *output, int size)
{
#if (1)
    asm volatile(
        "mv a3, %3;"
...
static __inline __attribute__((__always_inline__)) void add_f32_vf(const float *input0, const float input1, float *output, int size)
{
#if (1)
