...
void output_all_data(runtime_tensor &input, runtime_tensor &output_ref, runtime_tensor &output_opt)
{
...
void output_all_data(std::vector<runtime_tensor> &inputs, runtime_tensor &output_ref, runtime_tensor &output_opt)
{
    make_output_root_dir();
    auto dir_name = get_index_dir_path(output_index);
