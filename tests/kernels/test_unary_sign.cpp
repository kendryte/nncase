...
INSTANTIATE_TEST_SUITE_P(
    Unary, UnaryTest,
    testing::Combine(
        testing::Values(dt_float32, dt_int32, dt_int64, dt_float64, dt_float16), // onnx no support
...
TEST_P(UnaryTest, sign) {
    ...
    // expected
    auto output_ort = ortki_Sign(orts[0]);
    size_t size = 0;
    ...
    auto output = kernels::stackvm::unary(
                      nncase::runtime::stackvm::unary_op_t::sign, input.impl())
                      .expect("unary failed");
