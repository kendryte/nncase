...
TEST_P(ReduceSumTest, ReduceSum) {
    ...
    auto axis = hrt::create(dt_int64, {1},
                    ...
                    .expect("create tensor failed");
    auto output_ort =
        ortki_ReduceSum(runtime_tensor_2_ort_tensor(a),
                        runtime_tensor_2_ort_tensor(axis), keepDims_value, 0);
    ...
    // actual
    auto output = kernels::stackvm::reduce(runtime::stackvm::reduce_op_t::sum,
                                           a.impl(), axis.impl(),
    ...
    if (axis_arry1.size() == 2) {
        ...
        auto axis1 = hrt::create(dt_int64, {2},
                                 ...
                                 true, host_runtime_tensor::pool_cpu_only)
                         .expect("create tensor failed");
        auto output_ort1 = ortki_ReduceSum(runtime_tensor_2_ort_tensor(a),
                                           runtime_tensor_2_ort_tensor(axis1),
                                           keepDims_value, 0);
    ...
    if (axis_arry1.size() == 3) {
        ...
        auto axis2 = hrt::create(dt_int64, {3},
                                 ...
                                 true, host_runtime_tensor::pool_cpu_only)
                         .expect("create tensor failed");
        auto output_ort2 = ortki_ReduceSum(runtime_tensor_2_ort_tensor(a),
                                           runtime_tensor_2_ort_tensor(axis2),
                                           keepDims_value, 0);
    ...
    if (axis_arry1.size() == 4) {
        ...
        auto axis3 = hrt::create(dt_int64, {4},
                                 ...
                                 true, host_runtime_tensor::pool_cpu_only)
                         .expect("create tensor failed");
        auto output_ort3 = ortki_ReduceSum(runtime_tensor_2_ort_tensor(a),
                                           runtime_tensor_2_ort_tensor(axis3),
                                           keepDims_value, 0);
