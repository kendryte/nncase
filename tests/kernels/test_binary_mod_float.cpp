...
NNCASE_TESTSUITE_INIT(BinaryTest, Binary, 1, dt_float32, dims_t{1, 3, 16, 16},
                      dims_t{3, 16, 16}, dims_t{3, 16, 1}, dims_t{1, 16, 1},
                      dims_t{16, 16}, dims_t{16, 1}, dims_t{16}, dims_t{1},
                      dims_t{})
