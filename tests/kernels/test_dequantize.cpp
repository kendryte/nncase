...
class DequantizeTest : public KernelTest,
...
TEST_P(DequantizeTest, dequantize) {
    ...
    auto scale_ptr = hrt::create(nncase::dt_float32, {1},
                                ...
                                true, host_runtime_tensor::pool_cpu_only)
                        .expect("create tensor failed");
    auto output_ort = ortki_DequantizeLinear(l_ort, runtime_tensor_2_ort_tensor(zero_point_ptr), runtime_tensor_2_ort_tensor(scale_ptr), 0);
    size_t size = 0;
    ...
    auto dequant_param_ptr = hrt::create(nncase::dt_float32, {2},
                                 ...
                                 .expect("create tensor failed");
    auto output =
        kernels::stackvm::dequantize(dt_float32, lhs.impl(), dequant_param_ptr.impl())
