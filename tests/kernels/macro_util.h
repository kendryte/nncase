...
#define ORTKI_OP_2(op_a, op_b, ...) ORTKI_COMPUTE(op_a, ORTKI_COMPUTE(op_b, __VA_ARGS__))
...
#define NNCASE_TEST_BODY(test_class, test_name, op_fn, sub_op_name, ortki_op_num, format, ...) \
