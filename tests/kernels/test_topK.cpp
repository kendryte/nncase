...
#include <ortki/operators.h>
 ...
 TEST_P(TopKTest, TopK) {
    ...
    size_t size = 0;
    int64_t k_array[] = {1};
    auto k = hrt::create(dt_int64, {1},
                         {reinterpret_cast<gsl::byte *>(k_array), 8}, true,
