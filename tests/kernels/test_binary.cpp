...
NNCASE_TESTSUITE_INIT(BinaryTest, Binary, 
    ...
    dims_t{1}, dims_t{16}, dims_t{1, 16}, 
...
// NNCASE_TEST_BODY(BinaryTest, bitwise_and, kernels::stackvm::binary, binary_op_t::bitwise_and, 1, NORMAL, ortki_Mul)
// NNCASE_TEST_BODY(BinaryTest, bitwise_or, kernels::stackvm::binary, binary_op_t::bitwise_or, 1, NORMAL, ortki_Mul)
// NNCASE_TEST_BODY(BinaryTest, bitwise_xor, kernels::stackvm::binary, binary_op_t::bitwise_xor, 1, NORMAL, ortki_Mul)
...
// NNCASE_TEST_BODY(BinaryTest, left_shift, kernels::stackvm::binary, binary_op_t::left_shift, 1, NORMAL, ortki_Mul)
// NNCASE_TEST_BODY(BinaryTest, right_shift, kernels::stackvm::binary, binary_op_t::right_shift, 1, NORMAL, ortki_Mul)
