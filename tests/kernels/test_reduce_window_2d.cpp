...
class ReduceWindow2DTest
    : public KernelTest,
      public ::testing::TestWithParam<std::tuple<
          nncase::typecode_t, dims_t, axes_t, axes_t, axes_t, axes_t>> {
  public:
    void SetUp() override {
...
INSTANTIATE_TEST_SUITE_P(
    ReduceWindow2D, ReduceWindow2DTest,
    testing::Combine(testing::Values(dt_float32),
                     testing::Values(dims_t{1, 3, 16, 16}),
                     testing::Values(axes_t{1, 1}),
                     testing::Values(axes_t{3, 3} /*, axes_t{2,2}*/),
                     testing::Values(axes_t{1, 1} /*,axes_t{2,2}*/),
                     testing::Values(axes_t{1, 1, 1, 1}, axes_t{0, 0, 0, 0})));
