...
def test_resnet50_caffe2_v1_7(request):
    ...
    model_file = 'onnx-models/vision/classification/resnet/model/resnet50-caffe2-v1-7.onnx'
    runner.run(model_file)


if __name__ == "__main__":
    pytest.main(['-vv', 'test_resnet50-caffe2-v1-7.py'])
