...
class ConvTranspose2dModule(torch.nn.ConvTranspose2d):
    def __init__(self):
        super(ConvTranspose2dModule, self).__init__(1, 4, kernel_size=3)

module = ConvTranspose2dModule()
...
if __name__ == "__main__":
    test_conv_transpose()
    test_conv_transpose_k210()
    test_conv_transpose_quant()
