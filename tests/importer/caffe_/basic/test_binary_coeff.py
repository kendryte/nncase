...
def _make_module(model_path, n, i_channels, i_size, operation, coeff):
    ns = caffe.NetSpec()
    ...
    ns.ele = L.Eltwise(ns.data1, ns.data2, ns.data3, ns.data4, name="ele",
                       eltwise_param=dict(operation=operation, coeff=coeff))
...
if __name__ == "__main__":
    pytest.main(['-vv', 'test_binary_coeff.py'])
