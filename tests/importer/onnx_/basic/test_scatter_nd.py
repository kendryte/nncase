...
def _make_module(in_shape, indices, updates_shape):
    ...
    output = helper.make_tensor_value_info(
        'output', TensorProto.FLOAT, in_shape)
    initializers = []
...
@pytest.mark.parametrize('in_shape,indices,updates_shape', in_shapes_indices_updates_shapes)
def test_scatter_nd(in_shape, indices, updates_shape, request):
    model_def = _make_module(in_shape, indices, updates_shape)
...
if __name__ == "__main__":
    pytest.main(['-vv', 'test_scatter_nd.py'])
