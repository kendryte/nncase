...
def test_qwen2_1p5B_fp8_static(request):
    cfg = """
    [huggingface_options]
    output_logits = true
    ...
    model_name = "/compiler/share/huggingface_cache/hub/LLM-Research/Qwen2-1.5B-Instruct-FP8"
...
if __name__ == "__main__":
    pytest.main(['-vv', 'disabled_test_qwen2_1p5B_fp8_static.py'])
