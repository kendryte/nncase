...
def test_qwen2_72B_fp8_static(request):
    cfg = """
    [huggingface_options]
    output_logits = true
    ...
    model_name = "/compiler/share/huggingface_cache/hub/LLM-Research/Qwen2-72B-Instruct-FP8"
...
if __name__ == "__main__":
    pytest.main(['-vv', 'disabled_test_qwen2_72B_fp8_static.py'])
