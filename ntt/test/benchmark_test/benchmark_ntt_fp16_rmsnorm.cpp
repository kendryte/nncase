...
void benchmark_ntt_rmsnorm_fixed_reduceAxis1_noPack() {
    ...
    for (size_t i = 0; i < warmup_num; i++) {
        packed_rms_norm(buffer_0, buffer_1, buffer_2, ntt_output, half(1e-06),
...
void benchmark_ntt_rmsnorm_fixed_reduceAxis1_packAxis1() {
    ...
    // no pack
    for (size_t i = 0; i < warmup_num; i++) {
        packed_rms_norm(buffer_3, buffer_4, buffer_5, buffer_6, half(1E-06),
...
void benchmark_ntt_rmsnorm_fixed_reduceAxis2_packAxis2() {
    ...
    for (size_t i = 0; i < warmup_num; i++) {
        packed_rms_norm(input_packed, scale_packed, bias_packed, output_packed,
                        half(1E-06), 2_dim, ntt::fixed_shape_v<2>,
                        ntt::fixed_shape_v<>);
    }
...
void benchmark_ntt_rmsnorm_fixed_reduceAxis2_packAxis1() {
    ...
    // no pack
    for (size_t i = 0; i < warmup_num; i++) {
        packed_rms_norm(buffer_3, buffer_1, buffer_2, buffer_4, half(1E-06),
