    ...
    def __init__(self, target: str, bin_path: str, data_type: str = "f32"):
        ...
        if data_type == "f32":
            self.roofline_dict = {'binary': {'add': '2.0',
                                ...
                                'softmax': {'fixed_reduceAxis1_noPack': '11130',
                                            'fixed_reduceAxis2_noPack': '5780',
                                            'fixed_reduceAxis1_packAxis1': '1470',
                                            'fixed_reduceAxis2_packAxis2': '1150',
                                            'fixed_reduceAxis2_packAxis1': '1060',
                                            'fixed_reduceAxis1_packAxis2': '1080',
                                            'ranked_reduceAxis1_noPack': '6320',
                                            'ranked_reduceAxis2_noPack': '5140',
                                            'ranked_reduceAxis1_packAxis1': '1470',
                                            'ranked_reduceAxis2_packAxis2': '1190',
                                            'ranked_reduceAxis2_packAxis1': '1050',
                                            'ranked_reduceAxis1_packAxis2': '1070',},
                                'layernorm': {'fixed_reduceAxis1_noPack':'5330',
                                                'fixed_reduceAxis1_packAxis1':'1180',
                                                'fixed_reduceAxis1_packAxis2':'730',
                                                'fixed_reduceAxis2_noPack':'5040',
                                                'fixed_reduceAxis2_packAxis1':'580',
                                                'fixed_reduceAxis2_packAxis2':'1270',
                                                'ranked_reduceAxis1_noPack':'2800',
                                                'ranked_reduceAxis1_packAxis1':'740',
                                                'ranked_reduceAxis1_packAxis2':'740',
                                                'ranked_reduceAxis2_noPack':'1890',
                                                'ranked_reduceAxis2_packAxis1':'570',
                                                'ranked_reduceAxis2_packAxis2':'1270',},
                                'rmsnorm': {'fixed_reduceAxis1_noPack':'3220',
                                            'fixed_reduceAxis1_packAxis1':'1250',
                                            'fixed_reduceAxis1_packAxis2':'900',
                                            'fixed_reduceAxis2_noPack':'2120',
                                            'fixed_reduceAxis2_packAxis1':'770',
                                            'fixed_reduceAxis2_packAxis2':'1360',
                                            'ranked_reduceAxis1_noPack':'1700',
                                            'ranked_reduceAxis1_packAxis1':'670',
                                            'ranked_reduceAxis1_packAxis2':'660',
                                            'ranked_reduceAxis2_noPack':'3130',
                                            'ranked_reduceAxis2_packAxis1':'690',
            ...
            self.roofline_dict = {'binary': {'add': '2.0',
                                  ...
                                  'reduce': {'Add_reduceM_PackM': '0.0',
                                            'Add_reduceMN_PackM': '0.0',
                                            'Add_reduceMN_PackN': '0.0',
                                            'Add_reduceN_PackN': '0.0',
                                            'Max_reduceM_PackM': '0.0',
                                            'Max_reduceMN_PackM': '0.0',
                                            'Max_reduceMN_PackN': '0.0',
                                            'Max_reduceN_PackN': '0.0',
                                            'Mean_reduceM_PackM': '0.0',
                                            'Mean_reduceMN_PackM': '0.0',
                                            'Mean_reduceMN_PackN': '0.0',
                                            'Mean_reduceN_PackN': '0.0',
                                            'Min_reduceM_PackM': '0.0',
                                            'Min_reduceMN_PackM': '0.0',
                                            'Min_reduceMN_PackN': '0.0',
                                            'Min_reduceN_PackN': '0.0',
                                            },
                                  'scatterND': {'unpack': '0.0', },
                                  'slice': {'contiguous_step_1': '0.0',
                                            'contiguous_step_2': '0.0',
                                            'contiguous_step_4': '0.0',
                                            'no_contiguous_step_1': '0.0',
                                            'no_contiguous_step_2': '0.0',
                                            'no_contiguous_step_4': '0.0',
                                            },
                                  'transpose': {"NCHW": '0.0',
                                                "NCWH": '0.0',
                                                "NHCW": '0.0',
                                  ...
                                  'layernorm': {'fixed_reduceAxis1_noPack':'0.0',
                                  ...
                                  'rmsnorm': {'fixed_reduceAxis1_noPack':'0.0',
                                            'fixed_reduceAxis1_packAxis1':'0.0',
                                            'fixed_reduceAxis1_packAxis2':'0.0',
                                            'fixed_reduceAxis2_noPack':'0.0',
                                            'fixed_reduceAxis2_packAxis1':'0.0',
    ...
    def __init__(self, target: str, bin_path: str, data_type: str = "f32"):
        ...
        if data_type == "f32":
            self.roofline_dict = {'binary': {'add': '7.3',
                                ...
                                'softmax': {'fixed_reduceAxis1_noPack': '61940', 
                                            'fixed_reduceAxis2_noPack': '54120', 
                                            'fixed_reduceAxis1_packAxis1': '21790', 
                                            'fixed_reduceAxis2_packAxis2': '24160', 
                                            'fixed_reduceAxis2_packAxis1': '23890', 
                                            'fixed_reduceAxis1_packAxis2': '23900',
                                            'ranked_reduceAxis1_noPack': '55610', 
                                            'ranked_reduceAxis2_noPack': '48900', 
                                            'ranked_reduceAxis1_packAxis1': '20680', 
                                            'ranked_reduceAxis2_packAxis2': '24470', 
                                            'ranked_reduceAxis2_packAxis1': '23760', 
                                            'ranked_reduceAxis1_packAxis2': '23760',},
                                'layernorm': {'fixed_reduceAxis1_noPack':'17140',
                                                'fixed_reduceAxis1_packAxis1':'23320',
                                                'fixed_reduceAxis1_packAxis2':'23270',
                                                'fixed_reduceAxis2_noPack':'13240',
                                                'fixed_reduceAxis2_packAxis1':'18270',
                                                'fixed_reduceAxis2_packAxis2':'22130',
                                                'ranked_reduceAxis1_noPack':'17050',
                                                'ranked_reduceAxis1_packAxis1':'23260',
                                                'ranked_reduceAxis1_packAxis2':'23250',
                                                'ranked_reduceAxis2_noPack':'13930',
                                                'ranked_reduceAxis2_packAxis1':'22230',
                                                'ranked_reduceAxis2_packAxis2':'22230',},
                                'rmsnorm': {'fixed_reduceAxis1_noPack':'13050',
                                            'fixed_reduceAxis1_packAxis1':'17310',
                                            'fixed_reduceAxis1_packAxis2':'17340',
                                            'fixed_reduceAxis2_noPack':'11320',
                                            'fixed_reduceAxis2_packAxis1':'12670',
                                            'fixed_reduceAxis2_packAxis2':'15930',
                                            'ranked_reduceAxis1_noPack':'13000',
                                            'ranked_reduceAxis1_packAxis1':'17330',
                                            'ranked_reduceAxis1_packAxis2':'17360',
                                            'ranked_reduceAxis2_noPack':'11240',
                                            'ranked_reduceAxis2_packAxis1':'16830',
...
class BenchmarkNTTMatmul(Benchmark):
    def __init__(self, arch: str, target: str, bin_path: str):
        Benchmark.__init__(self, arch, target, bin_path, 'benchmark_ntt_f32_matmul_primitive_size')
