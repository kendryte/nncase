...
class BenchmarkNTT_x86_64(BenchmarkNTT):
    def __init__(self, target: str, bin_path: str):
        ...
        self.roofline_dict = {'binary': {'add': '2.0',
                              ...
                              'softmax': {'fixed_reduceAxis1_noPack': '6710', 
                                          'fixed_reduceAxis2_noPack': '5710', 
                                          'fixed_reduceAxis1_packAxis1': '1160', 
                                          'fixed_reduceAxis2_packAxis2': '910', 
                                          'fixed_reduceAxis2_packAxis1': '830', 
                                          'fixed_reduceAxis1_packAxis2': '830',
                                          'ranked_reduceAxis1_noPack': '7800', 
                                          'ranked_reduceAxis2_noPack': '5980', 
                                          'ranked_reduceAxis1_packAxis1': '1150', 
                                          'ranked_reduceAxis2_packAxis2': '920', 
                                          'ranked_reduceAxis2_packAxis1': '830', 
                                          'ranked_reduceAxis1_packAxis2': '830',},
                              'layernorm': {'fixed_reduceAxis1_noPack': '2890', 
                                          'fixed_reduceAxis2_noPack': '2120', 
                                          'fixed_reduceAxis1_packAxis1': '690', 
                                          'fixed_reduceAxis2_packAxis2': '690', 
                                          'fixed_reduceAxis2_packAxis1': '430', 
                                          'fixed_reduceAxis1_packAxis2': '750',
                                          'ranked_reduceAxis1_noPack': '3700', 
                                          'ranked_reduceAxis2_noPack': '7680', 
                                          'ranked_reduceAxis1_packAxis1': '1650', 
                                          'ranked_reduceAxis2_packAxis2': '7230', 
                                          'ranked_reduceAxis2_packAxis1': '1520', 
                                          'ranked_reduceAxis1_packAxis2': '1890',},
                              'rmsnorm': {'fixed_reduceAxis1_noPack': '2880', 
                                          'fixed_reduceAxis2_noPack': '2130', 
                                          'fixed_reduceAxis1_packAxis1': '690', 
                                          'fixed_reduceAxis2_packAxis2': '690', 
                                          'fixed_reduceAxis2_packAxis1': '430', 
                                          'fixed_reduceAxis1_packAxis2': '750',
                                          'ranked_reduceAxis1_noPack': '3680', 
                                          'ranked_reduceAxis2_noPack': '7600', 
                                          'ranked_reduceAxis1_packAxis1': '1660', 
                                          'ranked_reduceAxis2_packAxis2': '6480', 
                                          'ranked_reduceAxis2_packAxis1': '1350', 
                                          'ranked_reduceAxis1_packAxis2': '1680',},
                              }
