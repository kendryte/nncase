...
int main(int argc, char *argv[]) {
    ...
    constexpr size_t N = NTT_VLEN / (sizeof(half) * 8);
    {
        ...
        benchmark_ntt_slice<half, N, in_dim0, in_dim1, 0, 0, in_dim0 / 2,
                            in_dim1, 1, 1>(half(-100.f), half(100.f),
                                           "contiguous_step_1");
    }
    {
        constexpr size_t in_dim0 = 12;
        constexpr size_t in_dim1 = 64;
        benchmark_ntt_slice<half, N, in_dim0, in_dim1, 0, 0, in_dim0 / 2,
                            in_dim1, 2, 2>(half(-100.f), half(100.f),
                                           "contiguous_step_2");
    }
    {
        constexpr size_t in_dim0 = 12;
        constexpr size_t in_dim1 = 64;
        benchmark_ntt_slice<half, N, in_dim0, in_dim1, 0, 0, in_dim0 / 2,
                            in_dim1, 4, 4>(half(-100.f), half(100.f),
                                           "contiguous_step_4");
    }
    {
#if __riscv
...
#endif
        benchmark_ntt_slice<half, N, in_dim0, in_dim1, 0, 0, in_dim0 / 2,
                            in_dim1 / 2, 1, 1>(half(-100.f), half(100.f),
...
#endif
        benchmark_ntt_slice<half, N, in_dim0, in_dim1, 0, 0, in_dim0 / 2,
                            in_dim1 / 2, 2, 2>(half(-100.f), half(100.f),
...
#endif
        benchmark_ntt_slice<half, N, in_dim0, in_dim1, 0, 0, in_dim0 / 2,
                            in_dim1 / 2, 4, 4>(half(-100.f), half(100.f),
