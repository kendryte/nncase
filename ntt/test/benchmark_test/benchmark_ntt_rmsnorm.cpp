...
// no pack
void benchmark_ntt_rmsnorm_reduceAxis1_noPack() {
...
void benchmark_ntt_rmsnorm_reduceAxis2_noPack() {
    constexpr size_t warmup_num = 10;
    constexpr size_t run_num = 3000;
#if __riscv
    constexpr size_t D0 = 3;
...
void benchmark_ntt_rmsnorm_reduceAxis1_packAxis1() {
    constexpr size_t warmup_num = 10;
    constexpr size_t run_num = 3000;
#if __riscv
    constexpr size_t D0 = 3;
...
void benchmark_ntt_rmsnorm_reduceAxis2_packAxis2() {
    constexpr size_t warmup_num = 10;
    constexpr size_t run_num = 3000;
#if __riscv
    constexpr size_t D0 = 3;
    ...
    // no pack
    for (size_t i = 0; i < warmup_num; i++) {
        packed_rms_norm<2>(input_packed, scale_packed, bias_packed,
                           output_packed,
                           ntt::vector<float, P>::from_scalar(1E-06),
...
void benchmark_ntt_rmsnorm_reduceAxis2_packAxis1() {
    constexpr size_t warmup_num = 10;
    constexpr size_t run_num = 3000;
#if __riscv
    constexpr size_t D0 = 3;
...
void benchmark_ntt_rmsnorm_reduceAxis1_packAxis2() {
    constexpr size_t warmup_num = 10;
    constexpr size_t run_num = 3000;
#if __riscv
    constexpr size_t D0 = 3;
    ...
    // no pack
    for (size_t i = 0; i < warmup_num; i++) {
        packed_rms_norm<1>(packed_input, packed_scale, packed_bias,
                           packed_output,
                           ntt::vector<float, P>::from_scalar(1E-06),
                           ntt::fixed_shape<1>{}, ntt::fixed_shape<0>{});
    }
...
int main() {
    ...
    benchmark_ntt_rmsnorm_reduceAxis1_noPack();
    benchmark_ntt_rmsnorm_reduceAxis2_noPack();
    benchmark_ntt_rmsnorm_reduceAxis1_packAxis1();
    benchmark_ntt_rmsnorm_reduceAxis2_packAxis2();
    benchmark_ntt_rmsnorm_reduceAxis2_packAxis1();
    benchmark_ntt_rmsnorm_reduceAxis1_packAxis2();
