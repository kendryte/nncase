...
std::string module = "benchmark_ntt_reduce_half";
constexpr size_t warmup_num = 10;
constexpr size_t run_num = 3000;
constexpr size_t P = NTT_VLEN / (sizeof(_Float16) * 8);

// 0,Add_reduceN_NoPack
template <size_t M, size_t N>
std::string benchmark_ntt_reduce_half_add_reduceN_noPack() {
    std::string reduce_mode = "Add";
    std::string reduce_direction = "reduceN";
    std::string pack_mode = "NoPack";

    ntt::tensor<_Float16, ntt::fixed_shape<M, N>> ta;
    NttTest::init_tensor(ta, -static_cast<_Float16>(10.f),
                         static_cast<_Float16>(10.f));

    ntt::tensor<_Float16, ntt::fixed_shape<M, 1>> tb[warmup_num + run_num];
...
// 1,Add_reduceN_PackN
template <size_t M, size_t N>
std::string benchmark_ntt_reduce_half_add_reduceN_packN() {
    std::string reduce_mode = "Add";
    std::string reduce_direction = "reduceN";
    ...
    NttTest::init_tensor(ta, -static_cast<_Float16>(10.f),
                         static_cast<_Float16>(10.f));
    ntt::tensor<ntt::vector<_Float16, P>, ntt::fixed_shape<M, N / P>> taP;
...
template <size_t M, size_t N>
std::string benchmark_ntt_reduce_half_add_reduceM_noPack() {
    std::string reduce_mode = "Add";
    ...
    ntt::tensor<_Float16, ntt::fixed_shape<1, N>> tb[warmup_num + run_num];
...
// 3,Add_reduceM_PackM
template <size_t M, size_t N>
std::string benchmark_ntt_reduce_half_add_reduceM_packM() {
    std::string reduce_mode = "Add";
    std::string reduce_direction = "reduceM";
    ...
    NttTest::init_tensor(ta, -static_cast<_Float16>(10.f),
                         static_cast<_Float16>(10.f));
    ntt::tensor<ntt::vector<_Float16, P>, ntt::fixed_shape<M / P, N>> taP;
...
template <size_t M, size_t N>
std::string benchmark_ntt_reduce_half_add_reduceMN_noPack() {
    std::string reduce_mode = "Add";
    ...
    ntt::tensor<_Float16, ntt::fixed_shape<1, 1>> tb[warmup_num + run_num];
...
template <size_t M, size_t N>
std::string benchmark_ntt_reduce_half_add_reduceMN_packN() {
    std::string reduce_mode = "Add";
    std::string reduce_direction = "reduceMN";
    std::string pack_mode = "PackN";
...
template <size_t M, size_t N>
std::string benchmark_ntt_reduce_half_add_reduceMN_packM() {
    std::string reduce_mode = "Add";
    std::string reduce_direction = "reduceMN";
    std::string pack_mode = "PackM";
...
template <size_t M, size_t N>
std::string benchmark_ntt_reduce_half_max_reduceN_noPack() {
...
// 8,Max_reduceN_PackN
template <size_t M, size_t N>
std::string benchmark_ntt_reduce_half_max_reduceN_packN() {
    std::string reduce_mode = "Max";
    std::string reduce_direction = "reduceN";
    std::string pack_mode = "PackN";
...
template <size_t M, size_t N>
std::string benchmark_ntt_reduce_half_max_reduceM_noPack() {
    std::string reduce_mode = "Max";
    std::string reduce_direction = "reduceM";
    std::string pack_mode = "NoPack";
...
template <size_t M, size_t N>
std::string benchmark_ntt_reduce_half_max_reduceM_packM() {
    std::string reduce_mode = "Max";
    std::string reduce_direction = "reduceM";
    std::string pack_mode = "PackM";
...
template <size_t M, size_t N>
std::string benchmark_ntt_reduce_half_max_reduceMN_noPack() {
    std::string reduce_mode = "Max";
    std::string reduce_direction = "reduceMN";
    std::string pack_mode = "NoPack";
...
template <size_t M, size_t N>
std::string benchmark_ntt_reduce_half_max_reduceMN_packN() {
    std::string reduce_mode = "Max";
    std::string reduce_direction = "reduceMN";
    std::string pack_mode = "PackN";
...
template <size_t M, size_t N>
std::string benchmark_ntt_reduce_half_max_reduceMN_packM() {
    std::string reduce_mode = "Max";
    std::string reduce_direction = "reduceMN";
    std::string pack_mode = "PackM";
...
template <size_t M, size_t N>
std::string benchmark_ntt_reduce_half_min_reduceN_noPack() {
...
template <size_t M, size_t N>
std::string benchmark_ntt_reduce_half_min_reduceN_packN() {
    std::string reduce_mode = "Min";
    std::string reduce_direction = "reduceN";
    std::string pack_mode = "PackN";
...
template <size_t M, size_t N>
std::string benchmark_ntt_reduce_half_min_reduceM_noPack() {
    std::string reduce_mode = "Min";
    std::string reduce_direction = "reduceM";
    std::string pack_mode = "NoPack";
...
template <size_t M, size_t N>
std::string benchmark_ntt_reduce_half_min_reduceM_packM() {
    std::string reduce_mode = "Min";
    std::string reduce_direction = "reduceM";
    std::string pack_mode = "PackM";
...
template <size_t M, size_t N>
std::string benchmark_ntt_reduce_half_min_reduceMN_noPack() {
    std::string reduce_mode = "Min";
    std::string reduce_direction = "reduceMN";
    std::string pack_mode = "NoPack";
...
template <size_t M, size_t N>
std::string benchmark_ntt_reduce_half_min_reduceMN_packN() {
    std::string reduce_mode = "Min";
    std::string reduce_direction = "reduceMN";
    std::string pack_mode = "PackN";
...
template <size_t M, size_t N>
std::string benchmark_ntt_reduce_half_min_reduceMN_packM() {
    std::string reduce_mode = "Min";
    std::string reduce_direction = "reduceMN";
    std::string pack_mode = "PackM";
...
template <size_t M, size_t N>
std::string benchmark_ntt_reduce_half_mean_reduceN_noPack() {
...
template <size_t M, size_t N>
std::string benchmark_ntt_reduce_half_mean_reduceN_packN() {
    std::string reduce_mode = "Mean";
    std::string reduce_direction = "reduceN";
    std::string pack_mode = "PackN";
...
template <size_t M, size_t N>
std::string benchmark_ntt_reduce_half_mean_reduceM_noPack() {
    std::string reduce_mode = "Mean";
    std::string reduce_direction = "reduceM";
    std::string pack_mode = "NoPack";
...
template <size_t M, size_t N>
std::string benchmark_ntt_reduce_half_mean_reduceM_packM() {
    std::string reduce_mode = "Mean";
    std::string reduce_direction = "reduceM";
    std::string pack_mode = "PackM";
...
template <size_t M, size_t N>
std::string benchmark_ntt_reduce_half_mean_reduceMN_noPack() {
    std::string reduce_mode = "Mean";
    std::string reduce_direction = "reduceMN";
    std::string pack_mode = "NoPack";
...
template <size_t M, size_t N>
std::string benchmark_ntt_reduce_half_mean_reduceMN_packN() {
    std::string reduce_mode = "Mean";
    std::string reduce_direction = "reduceMN";
    std::string pack_mode = "PackN";
...
template <size_t M, size_t N>
std::string benchmark_ntt_reduce_half_mean_reduceMN_packM() {
    std::string reduce_mode = "Mean";
    std::string reduce_direction = "reduceMN";
    std::string pack_mode = "PackM";
...
#define BENCHMARK_NTT_REDUCE(OP, REDUCE_AXIS, PACK_MODE, M, N)                 \
    benchmark_ntt_reduce_half_##OP##_reduce##REDUCE_AXIS##_##PACK_MODE<M,      \
                                                                       N>();   \
    benchmark_ntt_reduce_half_##OP##_reduce##REDUCE_AXIS##_##PACK_MODE<M,      \
                                                                       N>();   \
    benchmark_ntt_reduce_half_##OP##_reduce##REDUCE_AXIS##_##PACK_MODE<M,      \
                                                                       N>();   \
    result =                                                                   \
        benchmark_ntt_reduce_half_##OP##_reduce##REDUCE_AXIS##_##PACK_MODE<    \
            M, N>();                                                           \
