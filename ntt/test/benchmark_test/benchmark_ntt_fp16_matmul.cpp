...
#define MATMUL_INPUTS_INIT                                                     \
    [[maybe_unused]] auto ta =                                                 \
        ntt::make_tensor<half>(ntt::fixed_shape_v<M, K>);                      \
    [[maybe_unused]] auto tb =                                                 \
        ntt::make_tensor<half>(ntt::fixed_shape_v<K, N>);                      \
    [[maybe_unused]] auto tc =                                                 \
        ntt::make_tensor<float>(ntt::fixed_shape_v<M, N>);                     \
    NttTest::init_tensor(ta, (half)0.f, (half)1.f);                            \
    NttTest::init_tensor(tb, (half)0.f, (half)1.f);
...
void benchmark_ntt_matmul_pack_K() {
    ...
    MATMUL_INPUTS_INIT
    auto pa =
        ntt::make_tensor<ntt::vector<half, P>>(ntt::fixed_shape_v<M, K / P>);
    auto pb =
        ntt::make_tensor<ntt::vector<half, P>>(ntt::fixed_shape_v<K / P, N>);
...
void benchmark_ntt_matmul_pack_M() {
    ...
    MATMUL_INPUTS_INIT
    auto pa =
        ntt::make_tensor<ntt::vector<half, P1>>(ntt::fixed_shape_v<M / P1, K>);
    auto pc =
...
void benchmark_ntt_matmul_pack_N() {
    ...
    MATMUL_INPUTS_INIT
    auto pb =
        ntt::make_tensor<ntt::vector<half, P1>>(ntt::fixed_shape_v<K, N / P1>);
    auto pc =
...
void benchmark_ntt_matmul_pack_M_N() {
    ...
    auto pb =
        ntt::make_tensor<ntt::vector<half, P1>>(ntt::fixed_shape_v<K, N / P1>);
    auto pc = ntt::make_tensor<ntt::vector<float, P2, P2>>(
...
#endif
    MATMUL_INPUTS_INIT
    auto pa = ntt::make_tensor<ntt::vector<half, P1, P1>>(
        ntt::fixed_shape_v<M / P1, K / P1>);
    auto pb =
        ntt::make_tensor<ntt::vector<half, P1>>(ntt::fixed_shape_v<K / P1, N>);
    auto pc =
        ntt::make_tensor<ntt::vector<float, P2>>(ntt::fixed_shape_v<M / P2, N>);
...
void benchmark_ntt_matmul_pack_K_N() {
    ...
    MATMUL_INPUTS_INIT
    auto pa =
        ntt::make_tensor<ntt::vector<half, P1>>(ntt::fixed_shape_v<M, K / P1>);
    auto pb = ntt::make_tensor<ntt::vector<half, P1, P1>>(
