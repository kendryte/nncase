...
TEST(ReduceSumTestFloat, ReduceM_NoPack) {
    ...
    // init
    using tensor_type1 = ntt::tensor<_Float16, ntt::fixed_shape<M, N>>;
    ...
    // ntt
    using tensor_type2 = ntt::tensor<_Float16, ntt::fixed_shape<1, N>>;
...
TEST(ReduceSumTestFloat, ReduceM_PackM) {
    ...
    ntt::tensor<ntt::vector<_Float16, P>, ntt::fixed_shape<M / P, N>>
        ntt_input_pack;
...
TEST(ReduceSumTestFloat, ReduceN_NoPack) {
    ...
    // ntt
    using tensor_type2 = ntt::tensor<_Float16, ntt::fixed_shape<M, 1>>;
    std::unique_ptr<tensor_type2> ntt_output1(new tensor_type2);
...
TEST(ReduceSumTestFloat, ReduceN_PackN) {
    ...
    ntt::tensor<ntt::vector<_Float16, P>, ntt::fixed_shape<M, N / P>>
        ntt_input_pack;
...
TEST(ReduceSumTestFloat, ReduceMN_NoPack) {
    ...
    // ntt
    using tensor_type2 = ntt::tensor<_Float16, ntt::fixed_shape<1, 1>>;
    std::unique_ptr<tensor_type2> ntt_output1(new tensor_type2);
