...
TEST(CompareTestGreater, fixed_fixed_fixed) {
    // init
    ...
    ntt::compare<ntt::ops::greater>(*ntt_lhs, *ntt_rhs, *ntt_output1);
...
TEST(CompareTestGreater, fixed_fixed_fixed_broadcast_lhs_scalar) {
    // init
...
TEST(CompareTestGreater, fixed_fixed_fixed_broadcast_rhs_scalar) {
    // init
...
TEST(CompareTestGreater, fixed_fixed_fixed_broadcast_lhs_vector) {
    // init
...
TEST(CompareTestGreater, fixed_fixed_fixed_broadcast_rhs_vector) {
    // init
    using tensor_type1 = ntt::tensor<float, ntt::fixed_shape<1, 3, 16, 16>>;
    std::unique_ptr<tensor_type1> ntt_lhs(new tensor_type1);
    NttTest::init_tensor(*ntt_lhs, -10.f, 10.f);
...
TEST(CompareTestGreater, fixed_fixed_fixed_broadcast_multidirectional) {
    // init
...
TEST(CompareTestGreater, fixed_ranked_ranked) {
    // init
    using tensor_type1 = ntt::tensor<float, ntt::fixed_shape<1, 3, 16, 16>>;
    std::unique_ptr<tensor_type1> ntt_lhs(new tensor_type1);
    NttTest::init_tensor(*ntt_lhs, -10.f, 10.f);
...
TEST(CompareTestGreater, fixed_ranked_ranked_broadcast_lhs_scalar) {
    // init
    using tensor_type1 = ntt::tensor<float, ntt::fixed_shape<1>>;
    std::unique_ptr<tensor_type1> ntt_lhs(new tensor_type1);
    NttTest::init_tensor(*ntt_lhs, -10.f, 10.f);
...
TEST(CompareTestGreater, fixed_ranked_ranked_broadcast_rhs_scalar) {
    // init
    using tensor_type1 = ntt::tensor<float, ntt::fixed_shape<1, 3, 16, 16>>;
    std::unique_ptr<tensor_type1> ntt_lhs(new tensor_type1);
    NttTest::init_tensor(*ntt_lhs, -10.f, 10.f);
...
TEST(CompareTestGreater, fixed_ranked_ranked_broadcast_lhs_vector) {
    // init
    using tensor_type1 = ntt::tensor<float, ntt::fixed_shape<16>>;
    std::unique_ptr<tensor_type1> ntt_lhs(new tensor_type1);
    NttTest::init_tensor(*ntt_lhs, -10.f, 10.f);
...
TEST(CompareTestGreater, fixed_ranked_ranked_broadcast_rhs_vector) {
    // init
    using tensor_type1 = ntt::tensor<float, ntt::fixed_shape<1, 3, 16, 16>>;
    std::unique_ptr<tensor_type1> ntt_lhs(new tensor_type1);
    NttTest::init_tensor(*ntt_lhs, -10.f, 10.f);
...
TEST(CompareTestGreater, fixed_ranked_ranked_broadcast_multidirectional) {
    // init
    using tensor_type1 = ntt::tensor<float, ntt::fixed_shape<1, 3, 1, 16>>;
    std::unique_ptr<tensor_type1> ntt_lhs(new tensor_type1);
    NttTest::init_tensor(*ntt_lhs, -10.f, 10.f);
...
TEST(CompareTestGreater, ranked_fixed_ranked) {
    // init
...
TEST(CompareTestGreater, ranked_fixed_ranked_broadcast_lhs_scalar) {
    // init
...
TEST(CompareTestGreater, ranked_fixed_ranked_broadcast_rhs_scalar) {
    // init
    using tensor_type1 = ntt::tensor<float, ntt::ranked_shape<4>>;
...
TEST(CompareTestGreater, ranked_fixed_ranked_broadcast_lhs_vector) {
    // init
    using tensor_type1 = ntt::tensor<float, ntt::ranked_shape<1>>;
    auto shape1 = ntt::make_ranked_shape(16);
    std::unique_ptr<tensor_type1> ntt_lhs(new tensor_type1(shape1));
...
TEST(CompareTestGreater, ranked_fixed_ranked_broadcast_rhs_vector) {
    // init
    using tensor_type1 = ntt::tensor<float, ntt::ranked_shape<4>>;
    auto shape1 = ntt::make_ranked_shape(1, 3, 16, 16);
    std::unique_ptr<tensor_type1> ntt_lhs(new tensor_type1(shape1));
...
TEST(CompareTestGreater, ranked_fixed_ranked_broadcast_multidirectional) {
    // init
    using tensor_type1 = ntt::tensor<float, ntt::ranked_shape<4>>;
...
TEST(CompareTestGreater, ranked_ranked_ranked) {
    // init
...
TEST(CompareTestGreater, ranked_ranked_ranked_broadcast_lhs_scalar) {
    // init
    using tensor_type1 = ntt::tensor<float, ntt::ranked_shape<1>>;
    auto shape1 = ntt::make_ranked_shape(1);
    std::unique_ptr<tensor_type1> ntt_lhs(new tensor_type1(shape1));
...
TEST(CompareTestGreater, ranked_ranked_ranked_broadcast_rhs_scalar) {
    // init
    using tensor_type1 = ntt::tensor<float, ntt::ranked_shape<4>>;
    auto shape1 = ntt::make_ranked_shape(1, 3, 16, 16);
    std::unique_ptr<tensor_type1> ntt_lhs(new tensor_type1(shape1));
...
TEST(CompareTestGreater, ranked_ranked_ranked_broadcast_lhs_vector) {
    // init
    using tensor_type1 = ntt::tensor<float, ntt::ranked_shape<1>>;
    auto shape1 = ntt::make_ranked_shape(16);
    std::unique_ptr<tensor_type1> ntt_lhs(new tensor_type1(shape1));
...
TEST(CompareTestGreater, ranked_ranked_ranked_broadcast_rhs_vector) {
    // init
    using tensor_type1 = ntt::tensor<float, ntt::ranked_shape<4>>;
    auto shape1 = ntt::make_ranked_shape(1, 3, 16, 16);
    std::unique_ptr<tensor_type1> ntt_lhs(new tensor_type1(shape1));
...
TEST(CompareTestGreater, ranked_ranked_ranked_broadcast_multidirectional) {
    // init
    using tensor_type1 = ntt::tensor<float, ntt::ranked_shape<4>>;
    auto shape1 = ntt::make_ranked_shape(1, 3, 1, 16);
    std::unique_ptr<tensor_type1> ntt_lhs(new tensor_type1(shape1));
