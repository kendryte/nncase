...
TEST(BinaryTestAddFloat16, fixed_fixed_fixed) {
    // init
    ...
    NttTest::init_tensor(*ntt_lhs, -static_cast<_Float16>(10.f),
                         static_cast<_Float16>(10.f));
    NttTest::init_tensor(*ntt_rhs, -static_cast<_Float16>(10.f),
                         static_cast<_Float16>(10.f));
...
TEST(BinaryTestAddFloat16, fixed_fixed_fixed_broadcast_lhs_scalar) {
    // init
...
TEST(BinaryTestAddFloat16, fixed_fixed_fixed_broadcast_rhs_scalar) {
    // init
...
TEST(BinaryTestAddFloat16, fixed_fixed_fixed_broadcast_lhs_vector) {
    // init
...
TEST(BinaryTestAddFloat16, fixed_fixed_fixed_broadcast_rhs_vector) {
    // init
    using tensor_type1 = ntt::tensor<_Float16, ntt::fixed_shape<1, 3, 16, 16>>;
    std::unique_ptr<tensor_type1> ntt_lhs(new tensor_type1);
    NttTest::init_tensor(*ntt_lhs, -static_cast<_Float16>(10.f),
...
TEST(BinaryTestAddFloat16, fixed_fixed_fixed_broadcast_multidirectional) {
    // init
...
TEST(BinaryTestAddFloat16, fixed_ranked_ranked) {
    // init
    using tensor_type1 = ntt::tensor<_Float16, ntt::fixed_shape<1, 3, 16, 16>>;
    std::unique_ptr<tensor_type1> ntt_lhs(new tensor_type1);
    NttTest::init_tensor(*ntt_lhs, -static_cast<_Float16>(10.f),
...
TEST(BinaryTestAddFloat16, fixed_ranked_ranked_broadcast_lhs_scalar) {
    // init
    using tensor_type1 = ntt::tensor<_Float16, ntt::fixed_shape<1>>;
    std::unique_ptr<tensor_type1> ntt_lhs(new tensor_type1);
    NttTest::init_tensor(*ntt_lhs, -static_cast<_Float16>(10.f),
...
TEST(BinaryTestAddFloat16, fixed_ranked_ranked_broadcast_rhs_scalar) {
    // init
    using tensor_type1 = ntt::tensor<_Float16, ntt::fixed_shape<1, 3, 16, 16>>;
    std::unique_ptr<tensor_type1> ntt_lhs(new tensor_type1);
    NttTest::init_tensor(*ntt_lhs, -static_cast<_Float16>(10.f),
...
TEST(BinaryTestAddFloat16, fixed_ranked_ranked_broadcast_lhs_vector) {
    // init
    using tensor_type1 = ntt::tensor<_Float16, ntt::fixed_shape<16>>;
    std::unique_ptr<tensor_type1> ntt_lhs(new tensor_type1);
    NttTest::init_tensor(*ntt_lhs, -static_cast<_Float16>(10.f),
...
TEST(BinaryTestAddFloat16, fixed_ranked_ranked_broadcast_rhs_vector) {
    // init
    using tensor_type1 = ntt::tensor<_Float16, ntt::fixed_shape<1, 3, 16, 16>>;
    std::unique_ptr<tensor_type1> ntt_lhs(new tensor_type1);
    NttTest::init_tensor(*ntt_lhs, -static_cast<_Float16>(10.f),
...
TEST(BinaryTestAddFloat16, fixed_ranked_ranked_broadcast_multidirectional) {
    // init
    using tensor_type1 = ntt::tensor<_Float16, ntt::fixed_shape<1, 3, 1, 16>>;
    std::unique_ptr<tensor_type1> ntt_lhs(new tensor_type1);
    NttTest::init_tensor(*ntt_lhs, -static_cast<_Float16>(10.f),
...
TEST(BinaryTestAddFloat16, ranked_fixed_ranked) {
    // init
...
TEST(BinaryTestAddFloat16, ranked_fixed_ranked_broadcast_lhs_scalar) {
    // init
...
TEST(BinaryTestAddFloat16, ranked_fixed_ranked_broadcast_rhs_scalar) {
    // init
    using tensor_type1 = ntt::tensor<_Float16, ntt::ranked_shape<4>>;
...
TEST(BinaryTestAddFloat16, ranked_fixed_ranked_broadcast_lhs_vector) {
    // init
    using tensor_type1 = ntt::tensor<_Float16, ntt::ranked_shape<1>>;
    auto shape1 = ntt::make_ranked_shape(16);
    std::unique_ptr<tensor_type1> ntt_lhs(new tensor_type1(shape1));
...
TEST(BinaryTestAddFloat16, ranked_fixed_ranked_broadcast_rhs_vector) {
    // init
    using tensor_type1 = ntt::tensor<_Float16, ntt::ranked_shape<4>>;
    auto shape1 = ntt::make_ranked_shape(1, 3, 16, 16);
    std::unique_ptr<tensor_type1> ntt_lhs(new tensor_type1(shape1));
...
TEST(BinaryTestAddFloat16, ranked_fixed_ranked_broadcast_multidirectional) {
    // init
    using tensor_type1 = ntt::tensor<_Float16, ntt::ranked_shape<4>>;
...
TEST(BinaryTestAddFloat16, ranked_ranked_ranked) {
    // init
...
TEST(BinaryTestAddFloat16, ranked_ranked_ranked_broadcast_lhs_scalar) {
    // init
    using tensor_type1 = ntt::tensor<_Float16, ntt::ranked_shape<1>>;
    auto shape1 = ntt::make_ranked_shape(1);
    std::unique_ptr<tensor_type1> ntt_lhs(new tensor_type1(shape1));
...
TEST(BinaryTestAddFloat16, ranked_ranked_ranked_broadcast_rhs_scalar) {
    // init
    using tensor_type1 = ntt::tensor<_Float16, ntt::ranked_shape<4>>;
    auto shape1 = ntt::make_ranked_shape(1, 3, 16, 16);
    std::unique_ptr<tensor_type1> ntt_lhs(new tensor_type1(shape1));
...
TEST(BinaryTestAddFloat16, ranked_ranked_ranked_broadcast_lhs_vector) {
    // init
    using tensor_type1 = ntt::tensor<_Float16, ntt::ranked_shape<1>>;
    auto shape1 = ntt::make_ranked_shape(16);
    std::unique_ptr<tensor_type1> ntt_lhs(new tensor_type1(shape1));
...
TEST(BinaryTestAddFloat16, ranked_ranked_ranked_broadcast_rhs_vector) {
    // init
    using tensor_type1 = ntt::tensor<_Float16, ntt::ranked_shape<4>>;
    auto shape1 = ntt::make_ranked_shape(1, 3, 16, 16);
    std::unique_ptr<tensor_type1> ntt_lhs(new tensor_type1(shape1));
...
TEST(BinaryTestAddFloat16, ranked_ranked_ranked_broadcast_multidirectional) {
    // init
    using tensor_type1 = ntt::tensor<_Float16, ntt::ranked_shape<4>>;
    auto shape1 = ntt::make_ranked_shape(1, 3, 1, 16);
    std::unique_ptr<tensor_type1> ntt_lhs(new tensor_type1(shape1));
