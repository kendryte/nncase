...
TEST(MatmulTestFloat, NoVectorize) {
    ...
    ntt::matmul<false>(ntt_lhs, ntt_rhs, ntt_output1, std::nullopt, ntt::fixed_shape_v<>,
...
TEST(MatmulTestFloat, Vectorize_K) {
    ...
    // ntt
    auto ntt_output1 = ntt::make_tensor<float>(ntt::fixed_shape_v<32, 32>);
    ntt::matmul<false>(p_ntt_lhs, p_ntt_rhs, ntt_output1, std::nullopt, ntt::fixed_shape_v<1>,
...
TEST(MatmulTestFloat, Vectorize_M) {
    ...
    auto tmp =
        ntt::make_tensor<ntt::vector<float, P>>(ntt::fixed_shape_v<32 / P, 32>);
    ntt::matmul<false>(p_ntt_lhs, ntt_rhs, tmp, std::nullopt, ntt::fixed_shape_v<0>,
                       ntt::fixed_shape_v<>, ntt::fixed_shape_v<>,
                       ntt::fixed_shape_v<>);
...
TEST(MatmulTestFloat, Vectorize_N) {
    ...
    auto tmp =
        ntt::make_tensor<ntt::vector<float, P>>(ntt::fixed_shape_v<32, 32 / P>);
    ntt::matmul<false>(ntt_lhs, p_ntt_rhs, tmp, std::nullopt, ntt::fixed_shape_v<>,
...
TEST(MatmulTestFloat, Vectorize_M_N) {
    ...
    ntt::matmul<false>(p_ntt_lhs, p_ntt_rhs, tmp, std::nullopt, ntt::fixed_shape_v<0>,
                       ntt::fixed_shape_v<>, ntt::fixed_shape_v<1>,
                       ntt::fixed_shape_v<>);
...
TEST(MatmulTestFloat, Vectorize_M_K) {
    ...
    auto tmp =
        ntt::make_tensor<ntt::vector<float, P>>(ntt::fixed_shape_v<32 / P, 32>);
    ntt::matmul<false>(p_ntt_lhs, p_ntt_rhs, tmp, std::nullopt, ntt::fixed_shape_v<0, 1>,
                       ntt::fixed_shape_v<>, ntt::fixed_shape_v<0>,
                       ntt::fixed_shape_v<>);
    unpack(tmp, ntt_output1, ntt::fixed_shape_v<0>);
...
TEST(MatmulTestFloat, Vectorize_K_N) {
    ...
    auto tmp =
        ntt::make_tensor<ntt::vector<float, P>>(ntt::fixed_shape_v<32, 32 / P>);
    ntt::matmul<false>(p_ntt_lhs, p_ntt_rhs, tmp, std::nullopt, ntt::fixed_shape_v<1>,
...
TEST(MatmulTestFloatE4M3Float32, Vectorize_M0) {
    ...
    ntt::matmul<false>(p_ntt_lhs, p_ntt_rhs, ntt_output_f32, std::nullopt,
...
TEST(MatmulTestFloatE4M3Bfloat16, Vectorize_M0) {
    ...
    ntt::matmul<false>(p_ntt_lhs, p_ntt_rhs, ntt_output_out, std::nullopt,
                       ntt::fixed_shape_v<0>, ntt::fixed_shape_v<>,
                       ntt::fixed_shape_v<>, ntt::fixed_shape_v<>);
