...
TEST(MatmulTestFloatE4M3Float32Scale, NoPack) {
    // init
    using tensorA_F8_type = ntt::tensor<float_e4m3_t, ntt::fixed_shape<64, 64>>;
    using tensorB_F8_type = ntt::tensor<float_e4m3_t, ntt::fixed_shape<64, 64>>;
    using tensorA_F32_type = ntt::tensor<float, ntt::fixed_shape<64, 64>>;
    ...
    tensorA_F8_type ntt_f8_lhs;
    tensorB_F8_type ntt_f8_rhs;
    NttTest::init_tensor(ntt_f8_lhs, (float_e4m3_t)-1.f, (float_e4m3_t)1.f);
    NttTest::init_tensor(ntt_f8_rhs, (float_e4m3_t)-1.f, (float_e4m3_t)1.f);
    ...
    ntt::tensor<float, ntt::fixed_shape<1>> scaleOutput;
    scaleOutput(0) = scaleRhs * scaleLhs;
    auto scaleOrt = NttTest::ntt2ort(scaleOutput);
    ort_output = ortki_Mul(ort_output, scaleOrt);
...
TEST(MatmulTestFloatE4M3Float32Scale, Pack_K0) {
    constexpr size_t P = NTT_VLEN / (sizeof(float_e4m3_t) * 8);
    ...
    ntt::matmul<false>(p_ntt_lhs, p_ntt_rhs, ntt_output1, ntt::fixed_shape<1>{},
                       ntt::fixed_shape<0>{}, ntt::fixed_shape<0>{},
                       ntt::fixed_shape<0>{}, scaleLhs, scaleRhs);
...
TEST(MatmulTestFloatE4M3Float32Scale, Pack_K1) {
    constexpr size_t P = NTT_VLEN / (sizeof(float) * 8);
...
TEST(MatmulTestFloatE4M3Float32Scale, Pack_M0) {
    constexpr size_t P1 = NTT_VLEN / (sizeof(float_e4m3_t) * 8);
    constexpr size_t P2 = NTT_VLEN / (sizeof(float) * 8);
    ...
    ntt::matmul<false>(p_ntt_lhs, p_ntt_rhs, ntt_output_f32,
                       ntt::fixed_shape<0>{}, ntt::fixed_shape<0>{},
                       ntt::fixed_shape<>{}, ntt::fixed_shape<0>{}, scaleLhs,
                       scaleRhs);
    tensor_type_f32_out ntt_output1;
    unpack<0>(ntt_output_f32, ntt_output1);
...
TEST(MatmulTestFloatE4M3Float32Scale, Pack_M1) {
    constexpr size_t P1 = NTT_VLEN / (sizeof(float) * 8);
    constexpr size_t P2 = NTT_VLEN / (sizeof(float) * 8);
...
TEST(MatmulTestFloatE4M3Float32Scale, Pack_N0) {
    constexpr size_t P1 = NTT_VLEN / (sizeof(float_e4m3_t) * 8);
    constexpr size_t P2 = NTT_VLEN / (sizeof(float) * 8);
    ...
    ntt::matmul<false>(p_ntt_lhs, p_ntt_rhs, ntt_output_f32,
                       ntt::fixed_shape<>{}, ntt::fixed_shape<0>{},
                       ntt::fixed_shape<1>{}, ntt::fixed_shape<0>{}, scaleLhs,
                       scaleRhs);
    tensor_type_f32_out ntt_output1;
    unpack<1>(ntt_output_f32, ntt_output1);
...
TEST(MatmulTestFloatE4M3Float32Scale, Pack_N1) {
    constexpr size_t P1 = NTT_VLEN / (sizeof(float) * 8);
    constexpr size_t P2 = NTT_VLEN / (sizeof(float) * 8);
...
TEST(MatmulTestFloatE4M3Float32Scale, Pack_M_K0) {
    constexpr size_t P1 = NTT_VLEN / (sizeof(float_e4m3_t) * 8);
    constexpr size_t P2 = NTT_VLEN / (sizeof(float) * 8);
    ...
    ntt::matmul<false>(p_ntt_lhs, p_ntt_rhs, ntt_output_f32,
                       ntt::fixed_shape<0, 1>{}, ntt::fixed_shape<0>{},
                       ntt::fixed_shape<0>{}, ntt::fixed_shape<0>{}, scaleLhs,
                       scaleRhs);
    tensor_type_f32_out ntt_output1;
    unpack<0>(ntt_output_f32, ntt_output1);
...
TEST(MatmulTestFloatE4M3Float32Scale, Pack_M_K1) {
    constexpr size_t P1 = NTT_VLEN / (sizeof(float) * 8);
    constexpr size_t P2 = NTT_VLEN / (sizeof(float) * 8);
...
TEST(MatmulTestFloatE4M3Float32Scale, Pack_K_N0) {
    constexpr size_t P1 = NTT_VLEN / (sizeof(float_e4m3_t) * 8);
    constexpr size_t P2 = NTT_VLEN / (sizeof(float) * 8);
...
TEST(MatmulTestFloatE4M3Float32Scale, Pack_K_N1) {
    constexpr size_t P1 = NTT_VLEN / (sizeof(float) * 8);
    constexpr size_t P2 = NTT_VLEN / (sizeof(float) * 8);
...
TEST(MatmulTestFloatE4M3Float32Scale, Pack_M_N0) {
    constexpr size_t P1 = NTT_VLEN / (sizeof(float_e4m3_t) * 8);
    constexpr size_t P2 = NTT_VLEN / (sizeof(float) * 8);
...
TEST(MatmulTestFloatE4M3Float32Scale, Pack_M_N1) {
    constexpr size_t P1 = NTT_VLEN / (sizeof(float) * 8);
    constexpr size_t P2 = NTT_VLEN / (sizeof(float) * 8);
...
TEST(MatmulTestFloatE4M3Float32Scale, Pack_M_K_N0) {
    constexpr size_t P1 = NTT_VLEN / (sizeof(float_e4m3_t) * 8);
    constexpr size_t P2 = NTT_VLEN / (sizeof(float) * 8);
...
TEST(MatmulTestFloatE4M3Float32Scale, Pack_M_K_N1) {
    constexpr size_t P1 = NTT_VLEN / (sizeof(float) * 8);
    constexpr size_t P2 = NTT_VLEN / (sizeof(float) * 8);
