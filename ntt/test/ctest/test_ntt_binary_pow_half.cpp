...
TEST(BinaryTestPowFloat, fixed_fixed_fixed) {
    ...
    NttTest::init_tensor(*ntt_lhs, static_cast<_Float16>(0.f), static_cast<_Float16>(3.f));
    NttTest::init_tensor(*ntt_rhs, static_cast<_Float16>(0.f), static_cast<_Float16>(3.f));
...
template <typename T, size_t vl> void test_vector() {
    ...
    NttTest::init_tensor(ntt_lhs, static_cast<T>(0), static_cast<T>(3));
    NttTest::init_tensor(ntt_rhs, static_cast<T>(0), static_cast<T>(3));
    auto ntt_output1 = ntt::pow(ntt_lhs, ntt_rhs);
    auto ort_lhs = NttTest::ntt2ort(ntt_lhs);
    auto ort_rhs = NttTest::ntt2ort(ntt_rhs);
    auto ort_output = ortki_Pow(ort_lhs, ort_rhs);
