...
add_library(
  xpu_cmodel STATIC
  {solutionPath}/modules/xpu/src/runtime/cmodel/src/dummy.cpp)
...
target_include_directories(
  xpu_cmodel
  PUBLIC
    {solutionPath}/modules/xpu/src/runtime/cmodel/include
)
target_include_directories(
  xpu_cmodel
  PUBLIC {solutionPath}/modules/xpu/include)
target_include_directories(
  xpu_cmodel
  PUBLIC {solutionPath}/modules/xpu/src/runtime/)
...
add_link_options(
  ...
  -fno-stack-protector
  -static
  -Wl,-e,_Z6_startPN6nncase7runtime3xpu19hardware_context_mtEPNS1_15runtime_util_mtEPNS1_19nncase_method_tableEPPhS8_
)
