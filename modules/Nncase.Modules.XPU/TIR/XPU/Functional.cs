...
public partial class XPU
{
    ...
    {
        return new Call(new TIR.XPU.Gather(axis), input, indices, output);
    }
    ...
    {
        return new Call(new TIR.XPU.Softmax(axis, distributedType), input, output);
    }

    public static Call Transpose(int[] perm, Expr input, Expr output)
    {
        return new Call(new TIR.XPU.Transpose(perm), input, output);
    }

    public static Call ReShape(Expr input, Expr output)
    {
        return new Call(new TIR.XPU.ReShape(), input, output);
    }

    public static Call SwishB(Expr input, Expr output, float beta)
    {
        return new Call(new TIR.XPU.SwishB(beta), input, output);
    }
    ...
    {
        return new Call(new TIR.XPU.Clamp(min, max), input, output);
    }
}
