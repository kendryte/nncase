...
/// <summary>
/// XPU application part extensions.
/// </summary>
public static class XPUApplicationPart
{
    /// <summary>
    /// Add XPU assembly.
    /// </summary>
    ...
    {
        return registrator.RegisterModule<XPUModule>()
            .RegisterModule<Evaluator.IR.CPU.CPUModule>()
            .RegisterModule<Evaluator.TIR.XPU.XPUModule>();
    }
}
