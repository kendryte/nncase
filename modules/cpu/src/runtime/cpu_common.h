...
[[maybe_unused]] static nncase_mt_t nncase_mt = {
    ...
    .float_binary_add = float_binary_add,
    .float_binary_sub = float_binary_sub,
    .float_binary_mul = float_binary_mul,
    .float_binary_div = float_binary_div,
    .float_binary_min = float_binary_min,
    .float_binary_max = float_binary_max,
    .float_binary_pow = float_binary_pow,
    .float_binary_logical_and = float_binary_logical_and,
    .float_binary_mod = float_binary_mod,
    .int32_binary_add = int32_binary_add,
    .int32_binary_sub = int32_binary_sub,
    .int32_binary_mul = int32_binary_mul,
    .int32_binary_div = int32_binary_div,
    .int32_binary_min = int32_binary_min,
    .int32_binary_max = int32_binary_max,
    .int32_binary_pow = int32_binary_pow,
    .int32_binary_logical_and = int32_binary_logical_and,
    .int32_binary_mod = int32_binary_mod,
    .int64_binary_add = int64_binary_add,
    .int64_binary_sub = int64_binary_sub,
    .int64_binary_mul = int64_binary_mul,
    .int64_binary_div = int64_binary_div,
    .int64_binary_min = int64_binary_min,
    .int64_binary_max = int64_binary_max,
    .int64_binary_pow = int64_binary_pow,
    .int64_binary_logical_and = int64_binary_logical_and,
    .int64_binary_mod = int64_binary_mod,
    .bool_binary_and = bool_binary_logical_and,
    .bool_binary_or = bool_binary_logical_or,
    .bool_binary_xor = bool_binary_logical_xor};
