...
{
class NNCASE_MODULES_K210_API fold_kpu_upload_transform : public transform
{
public:
...
class NNCASE_MODULES_K210_API fold_input_kpu_upload_transform : public transform
{
public:
    void process(transform_context &context) override;
