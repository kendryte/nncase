...
public:
    ...
    int32_t input_channels() const noexcept { return is_depthwise() ? (int32_t)weights().shape()[0] : (int32_t)weights().shape()[1]; }
    ...
    fake_kpu_conv2d(shape_t input_shape, bool is_depthwise, shape_t weights_shape, runtime::k210::kpu_filter_type_t filter_type, runtime::k210::kpu_pool_type_t pool_type, value_range<float> fused_activation);
