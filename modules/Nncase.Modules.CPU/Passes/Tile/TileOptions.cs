...
public sealed record TileOptions(int[] TargetTileSize, int[] Hierarchy, long[] HierarchySizes)
{
    public static TileOptions Default { get; } = new(Array.Empty<int>(), new[] { 1 }, new[] { 64 * (long)MathF.Pow(2, 30) });
}
