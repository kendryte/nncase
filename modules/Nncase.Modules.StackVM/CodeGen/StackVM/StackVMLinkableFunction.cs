...
{
    public StackVMLinkableFunction(uint id, BaseFunction sourceFunction, IEnumerable<FunctionRef> functionRefs, ushort maxLocals, Stream text, IReadOnlySet<ModuleType> custom_call_modules)
    {
        Id = id;
