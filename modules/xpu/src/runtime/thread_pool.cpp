...
using namespace nncase::runtime::xpu::thread_pool;
...
uintptr_t nncase::runtime::xpu::thread_pool::paddr_offset;

void *nncase::runtime::xpu::thread_pool::thread_start(thread_func callable,
                                                      void *user,
                                                      size_t user_size) {
...
void *nncase::runtime::xpu::thread_pool::thread_end() {
    if (threads_size) {
