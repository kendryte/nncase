...
#define gsl_lite_VERSION                                                       \
    gsl_STRINGIFY(gsl_lite_MAJOR) "." gsl_STRINGIFY(                           \
        gsl_lite_MINOR) "." gsl_STRINGIFY(gsl_lite_PATCH)
...
#define gsl_CONFIG_ALLOWS_UNCONSTRAINED_SPAN_CONTAINER_CTOR                    \
    gsl_CONFIG_ALLOWS_SPAN_CONTAINER_CTOR
#pragma message(                                                               \
...
#pragma message(                                                               \
    "gsl_CONFIG_CONTRACT_LEVEL_EXPECTS_ONLY is deprecated since gsl-lite 0.36; replace with gsl_CONFIG_CONTRACT_CHECKING_ENSURES_OFF.")
#define gsl_CONFIG_CONTRACT_CHECKING_ON
#define gsl_CONFIG_CONTRACT_CHECKING_ENSURES_OFF
#elif defined(gsl_CONFIG_CONTRACT_LEVEL_ENSURES_ONLY)
#pragma message(                                                               \
    "gsl_CONFIG_CONTRACT_LEVEL_ENSURES_ONLY is deprecated since gsl-lite 0.36; replace with gsl_CONFIG_CONTRACT_CHECKING_EXPECTS_OFF.")
#define gsl_CONFIG_CONTRACT_CHECKING_ON
...
// Configuration: Other
    ...
    defined(gsl_CONFIG_NOT_NULL_GET_BY_CONST_REF)
...
#define gsl_CONFIG_NARROW_THROWS_ON_TRUNCATION                                 \
    (gsl_CONFIG_DEFAULTS_VERSION >= 1)
#endif

#if 1 < defined(gsl_CONFIG_CONTRACT_CHECKING_AUDIT) +                          \
            defined(gsl_CONFIG_CONTRACT_CHECKING_ON) +                         \
...
#define gsl_CPLUSPLUS_V                                                        \
    (gsl_CPLUSPLUS / 100 - (gsl_CPLUSPLUS > 200000 ? 2000 : 1994))
...
#define gsl_COMPILER_MSVC_VERSION_FULL                                         \
    (_MSC_VER - 100 * (5 + (_MSC_VER < 1900)))
#else
...
#define gsl_COMPILER_VERSION(major, minor, patch)                              \
...
// gsl_COMPILER_APPLECLANG_VERSION ==  700  (Xcode 7.1) (LLVM 3.7.0)
// AppleClang  7.0.2  __apple_build_version__ ==  7000181
// gsl_COMPILER_APPLECLANG_VERSION ==  702  (Xcode 7.2, 7.2.1) (LLVM 3.7.0)
// AppleClang  7.3.0  __apple_build_version__ ==  7030029
// gsl_COMPILER_APPLECLANG_VERSION ==  730  (Xcode 7.3) (LLVM 3.8.0)
// AppleClang  7.3.0  __apple_build_version__ ==  7030031
// gsl_COMPILER_APPLECLANG_VERSION ==  730  (Xcode 7.3.1) (LLVM 3.8.0)
// AppleClang  8.0.0  __apple_build_version__ ==  8000038
// gsl_COMPILER_APPLECLANG_VERSION ==  800  (Xcode 8.0) (LLVM 3.9.0)
// AppleClang  8.0.0  __apple_build_version__ ==  8000042
// gsl_COMPILER_APPLECLANG_VERSION ==  800  (Xcode 8.1, 8.2, 8.2.1) (LLVM 3.9.0)
// AppleClang  8.1.0  __apple_build_version__ ==  8020038
// gsl_COMPILER_APPLECLANG_VERSION ==  810  (Xcode 8.3) (LLVM 3.9.0)
// AppleClang  8.1.0  __apple_build_version__ ==  8020041
// gsl_COMPILER_APPLECLANG_VERSION ==  810  (Xcode 8.3.1) (LLVM 3.9.0)
// AppleClang  8.1.0  __apple_build_version__ ==  8020042
// gsl_COMPILER_APPLECLANG_VERSION ==  810  (Xcode 8.3.2, 8.3.3) (LLVM 3.9.0)
// AppleClang  9.0.0  __apple_build_version__ ==  9000037
// gsl_COMPILER_APPLECLANG_VERSION ==  900  (Xcode 9.0) (LLVM 4.0.0?) AppleClang
// 9.0.0  __apple_build_version__ ==  9000038  gsl_COMPILER_APPLECLANG_VERSION
// ==  900  (Xcode 9.1)                 (LLVM 4.0.0?) AppleClang  9.0.0
...
// (Xcode 11.1, 11.2, 11.3)    (LLVM 8.0.0?)
...
// Presence of language & library features:
    ...
    gsl_BETWEEN(gsl_COMPILER_CLANG_VERSION, 1, 360) ||                         \
...
#define gsl_CPP11_140_CPP0X_90                                                 \
    (gsl_CPP11_140 || (gsl_COMPILER_MSVC_VER >= 1500 && gsl_HAS_CPP0X))
#define gsl_CPP11_140_CPP0X_100                                                \
    (gsl_CPP11_140 || (gsl_COMPILER_MSVC_VER >= 1600 && gsl_HAS_CPP0X))
...
#define gsl_HAVE_FUNCTION_REF_QUALIFIER                                        \
    (gsl_CPP14_140 && !gsl_BETWEEN(gsl_COMPILER_GNUC_VERSION, 1, 481))
...
#define gsl_HAVE_NORETURN                                                      \
    (gsl_CPP11_140 && !gsl_BETWEEN(gsl_COMPILER_GNUC_VERSION, 1, 480))
...
#define gsl_HAVE_CONSTEXPR_14                                                  \
    (gsl_CPP14_000 && !gsl_BETWEEN(gsl_COMPILER_GNUC_VERSION, 1, 600))
#define gsl_HAVE_DECLTYPE_AUTO gsl_CPP14_140
#define gsl_HAVE_DEPRECATED                                                    \
    (gsl_CPP14_140 && !gsl_BETWEEN(gsl_COMPILER_MSVC_VERSION, 1, 142))
...
#else
#define gsl_HAVE_STD_SSIZE                                                     \
    (gsl_COMPILER_GNUC_VERSION >= 1000 && __cplusplus > 201703L)
#endif
...
#define gsl_DEFINE_ENUM_BITMASK_OPERATORS_(ENUM)                               \
    gsl_NODISCARD gsl_api inline gsl_constexpr ENUM operator~(ENUM val)        \
        gsl_noexcept {                                                         \
        typedef typename ::gsl::std11::underlying_type<ENUM>::type U;          \
        return ENUM(~U(val));                                                  \
    }                                                                          \
    gsl_NODISCARD gsl_api inline gsl_constexpr ENUM operator|(                 \
        ENUM lhs, ENUM rhs) gsl_noexcept {                                     \
        typedef typename ::gsl::std11::underlying_type<ENUM>::type U;          \
    ...
    gsl_api inline gsl_constexpr14 ENUM &operator|=(ENUM &lhs, ENUM rhs)       \
        gsl_noexcept {                                                         \
        return lhs = lhs | rhs;                                                \
    }                                                                          \
    gsl_api inline gsl_constexpr14 ENUM &operator&=(ENUM &lhs, ENUM rhs)       \
...
#define gsl_DEFINE_ENUM_RELATIONAL_OPERATORS_(ENUM)                            \
    gsl_NODISCARD gsl_api inline gsl_constexpr bool operator<(                 \
        ENUM lhs, ENUM rhs) gsl_noexcept {                                     \
        typedef typename ::gsl::std11::underlying_type<ENUM>::type U;          \
        return U(lhs) < U(rhs);                                                \
    }                                                                          \
...
//
#define gsl_DEFINE_ENUM_BITMASK_OPERATORS(ENUM)                                \
    gsl_DEFINE_ENUM_BITMASK_OPERATORS_(ENUM)
...
//
#define gsl_DEFINE_ENUM_RELATIONAL_OPERATORS(ENUM)                             \
    gsl_DEFINE_ENUM_RELATIONAL_OPERATORS_(ENUM)
...
gsl_DISABLE_MSVC_WARNINGS(
    26432 26410 26415 26418 26472 26439 26440 26455 26473 26481 26482 26446 26490 26487)
    ...
    template <class T> struct remove_cv {
        typedef
            typename remove_volatile<typename remove_const<T>::type>::type type;
    };
    ...
    template <bool V0, class T0, class... Ts> struct conjunction_ {
        using type = T0;
    };
    template <class T0, class T1, class... Ts>
    struct conjunction_<true, T0, T1, Ts...>
        : conjunction_<T1::value, T1, Ts...> {};
    template <bool V0, class T0, class... Ts> struct disjunction_ {
        using type = T0;
    };
    template <class T0, class T1, class... Ts>
    struct disjunction_<false, T0, T1, Ts...>
        : disjunction_<T1::value, T1, Ts...> {};
    ...
    struct conjunction<T0, Ts...>
        : detail::conjunction_<T0::value, T0, Ts...>::type {};
    template <class... Ts> struct disjunction;
    template <> struct disjunction<> : std11::false_type {};
    template <class T0, class... Ts>
    struct disjunction<T0, Ts...>
        : detail::disjunction_<T0::value, T0, Ts...>::type {};
    template <class T>
    ...
    gsl_api inline gsl_constexpr auto size(T const (&)[N]) gsl_noexcept
        -> size_t {
        return N;
    }
    ...
    template <class E>
    inline gsl_constexpr auto data(std::initializer_list<E> il) gsl_noexcept
        -> E const * {
        return il.begin();
    }
    ...
    template <class C>
    gsl_constexpr auto ssize(C const &c) -> typename std::common_type<
        std::ptrdiff_t,
    ...
    template <class T> struct remove_cvref {
        typedef typename std11::remove_cv<
            typename std11::remove_reference<T>::type>::type type;
    };
    ...
    template <class Q> struct is_span_oracle : std::false_type {};
    ...
    template <class Q> struct is_std_array_oracle : std::false_type {};
    ...
    template <class Q>
    struct is_std_array
        : is_std_array_oracle<typename std::remove_cv<Q>::type> {};

    template <class Q> struct is_array : std::false_type {};
    ...
    struct has_size_and_data<
        C, std17::void_t<decltype(std17::size(std::declval<C>())),
    ...
    struct is_compatible_container
        : std17::bool_constant<is_container<C>::value &&
    ...
    template <class C, class E,
              typename = typename std::enable_if<
                  !is_span<C>::value && !is_array<C>::value &&
                      !is_std_array<C>::value &&
                      (std::is_convertible<
                          typename std::remove_pointer<decltype(
                              std17::data(std::declval<C &>()))>::type (*)[],
    ...
    template <class C, class E>
    struct is_compatible_container
        : decltype(is_compatible_container_f<C, E>(0)) {};
...
#define gsl_ASSUME(x)                                                          \
    gsl_ELIDE_CONTRACT_(                                                       \
        x) /* there is no assume intrinsic in CUDA device code */
#elif gsl_COMPILER_MSVC_VERSION
...
#define gsl_CONTRACT_CHECK_(str, x)                                            \
    ((x) ? static_cast<void>(0)                                                \
         : ::gsl::detail::fail_fast_throw("GSL: " str " at " __FILE__          \
...
#else
#define gsl_ExpectsAudit(x)                                                    \
    gsl_CONTRACT_CHECK_("Precondition failure (audit)", x)
#endif
...
#else
#define gsl_EnsuresAudit(x)                                                    \
    gsl_CONTRACT_CHECK_("Postcondition failure (audit)", x)
#endif
...
#define gsl_STRINGIFY_(x) #x
    ...
    gsl_api void fail_fast_assert_handler(char const *const expression,
...
#if gsl_HAVE(EXCEPTIONS)
    gsl_DEPRECATED_MSG("don't call gsl::fail_fast_assert() directly; use "
                       "contract checking macros instead")
    ...
    gsl_DEPRECATED_MSG("don't call gsl::fail_fast_assert() directly; use "
        ...
        fail_fast_assert(bool cond, char const *const expression,
                         char const *const message, char const *const file,
                         int line) {
        if (!cond)
    ...
    inline unsigned char uncaught_exceptions() gsl_noexcept {
        return detail::to_uchar(*reinterpret_cast<unsigned *>(
    ...
    template <class F> class final_action_return : public final_action<F> {
      public:
        ...
        final_action_return &
        operator=(final_action_return const &) gsl_is_delete;
    ...
    template <class F> class final_action_error : public final_action<F> {
      public:
    ...
    template <class F> inline final_action finally(F const &f) {
    ...
    template <class F> inline final_action_return on_return(F const &action) {
    ...
    template <class F> inline final_action_error on_error(F const &action) {
    ...
    template <class T, class U> gsl_api inline T narrow_cast(U u) gsl_noexcept {
...
#if defined(__NVCC__)
    // We do this to circumvent NVCC warnings about pointless unsigned
    // comparisons with 0.
    template <class T>
    gsl_constexpr gsl_api bool
    is_negative(T value, std::true_type /*isSigned*/) gsl_noexcept {
        return value < T();
    }
    template <class T>
    gsl_constexpr gsl_api bool
    is_negative(T /*value*/, std::false_type /*isUnsigned*/) gsl_noexcept {
        return false;
    }
    template <class T, class U>
    gsl_constexpr gsl_api bool
    have_same_sign(T t, U u, std::true_type /*isSameSignedness*/) gsl_noexcept {
        return true;
    }
    template <class T, class U>
    gsl_constexpr gsl_api bool
    have_same_sign(T t, U u,
    ...
    !defined(gsl_CONFIG_CONTRACT_VIOLATION_THROWS)
    gsl_api
#endif // !gsl_CONFIG_NARROW_THROWS_ON_TRUNCATION && !defined(
    ...
    defined(gsl_CONFIG_CONTRACT_VIOLATION_THROWS)
        ...
        gsl_SUPPRESS_MSVC_WARNING(
            4127,
            "conditional expression is constant") if (!detail::
                                                          is_same_signedness<
                                                              T, U>::value &&
                                                      (t < T()) != (u < U()))
#endif
        ...
        gsl_SUPPRESS_MSVC_WARNING(
            4127, "conditional expression is constant") if ((t < 0) != (u < 0))
#endif
        {
#if gsl_CONFIG_NARROW_THROWS_ON_TRUNCATION ||                                  \
    defined(gsl_CONFIG_CONTRACT_VIOLATION_THROWS)
    ...
    template <class T, class U> gsl_api inline T narrow_failfast(U u) {
        T t = static_cast<T>(u);
...
#if gsl_HAVE(TYPE_TRAITS)
#if defined(__NVCC__)
        gsl_Expects(::gsl::detail::have_same_sign(
            t, u, ::gsl::detail::is_same_signedness<T, U>()));
#else
        gsl_SUPPRESS_MSVC_WARNING(4127, "conditional expression is constant")
            gsl_Expects((::gsl::detail::is_same_signedness<T, U>::value ||
                         (t < T()) == (u < U())));
#endif
#else
        // Don't assume T() works:
    ...
    inline gsl_constexpr14 typename Container::value_type &at(Container & cont,
                                                              size_t pos) {
    ...
    template <class Container>
    inline gsl_constexpr14 typename Container::value_type const &at(
    ...
    template <class T>
    inline const gsl_constexpr14 T at(std::initializer_list<T> cont,
                                      size_t pos) {
        gsl_Expects(pos < cont.size());
...
// helper class to figure out the pointed-to type of a pointer
#if gsl_CPP11_OR_GREATER
    template <class T, class E = void> struct element_type_helper {
        // For types without a member element_type (this will handle raw
        // pointers)
        typedef
    ...
    template <class T> struct element_type_helper<T *> { typedef T type; };
#endif

    template <class T> struct is_not_null_oracle : std11::false_type {};
    template <class T>
    struct is_not_null_oracle<not_null<T>> : std11::true_type {};

    template <class T, bool IsCopyable = true> struct not_null_data;
    ...
    template <class T> struct not_null_data<T, false> {
        ...
        gsl_constexpr14 not_null_data &
        operator=(not_null_data &&other) gsl_noexcept {
            ptr_ = std::move(other.ptr_);
            return *this;
        }
    ...
    template <class T> struct not_null_data<T, true> {
        T ptr_;

        gsl_constexpr14 not_null_data(T const &_ptr) gsl_noexcept : ptr_(_ptr) {
        }
    ...
    struct is_copyable
#if gsl_HAVE(TYPE_TRAITS)
        : std11::integral_constant<bool, std::is_copy_constructible<T>::value &&
    ...
    gsl_BETWEEN(gsl_COMPILER_MSVC_VERSION, 1, 140)
    // Type traits are buggy in VC++ 2013, so we explicitly declare
...
#if gsl_HAVE(RVALUE_REFERENCE)
        template <class U
        // In Clang 3.x, `is_constructible<not_null<unique_ptr<X>>,
        // unique_ptr<X>>` tries to instantiate the copy constructor of
        // `unique_ptr<>`, triggering an error. Note that Apple Clang's
        // `__clang_major__` etc. are different from regular Clang.
#if gsl_HAVE(TYPE_TRAITS) && gsl_HAVE(DEFAULT_FUNCTION_TEMPLATE_ARG) &&        \
    !gsl_BETWEEN(gsl_COMPILER_CLANG_VERSION, 1, 400) &&                        \
    !gsl_BETWEEN(gsl_COMPILER_APPLECLANG_VERSION, 1, 1001)
                  // We *have* to use SFINAE with an NTTP arg here, otherwise
        ...
        template <class U>
        gsl_constexpr14 explicit not_null(U const &other) : data_(T(other)) {
            gsl_Expects(data_.ptr_ != gsl_nullptr);
        }
#endif // gsl_HAVE( RVALUE_REFERENCE )
    ...
    !gsl_BETWEEN(gsl_COMPILER_APPLECLANG_VERSION, 1, 1001)
       ...
       // && !gsl_BETWEEN( gsl_COMPILER_CLANG_VERSION, 1, 400 ) && !gsl_BETWEEN(
       // gsl_COMPILER_APPLECLANG_VERSION, 1, 1001 )
#else  // a.k.a. !gsl_HAVE( RVALUE_REFERENCE )
        template <class U>
        gsl_constexpr14 not_null(U const &other) : data_(T(other)) {
            gsl_Expects(data_.ptr_ != gsl_nullptr);
        }
#endif // gsl_HAVE( RVALUE_REFERENCE )
    ...
    !gsl_BETWEEN(gsl_COMPILER_APPLECLANG_VERSION, 1, 1001)
       ...
       // gsl_COMPILER_APPLECLANG_VERSION, 1, 1001 )
        ...
        // We want an implicit conversion operator that can be used to convert
        // from both lvalues (by const reference or by copy) and rvalues (by
        // move). So it seems like we could define
        //
        //     template< class U >
        ...
        // operator return `U` rather than `U const &` or `U &&`. This implies
        // that converting an lvalue always induces a copy, which can cause
        // unnecessary copies or even fail to compile in some situations:
        //
    ...
    gsl_HAVE(DEFAULT_FUNCTION_TEMPLATE_ARG) && gsl_HAVE(EXPLICIT)
        ...
        template <class U
                  ...
                  typename std::enable_if<
                      (std::is_constructible<U, T const &>::value &&
                       !std::is_convertible<T, U>::value &&
                       !detail::is_not_null_oracle<U>::value),
                      int>::type = 0>
        gsl_constexpr14 explicit operator U() const
        ...
        template <
            ...
            typename std::enable_if<(std::is_constructible<U, T>::value &&
                                     ...
                                     !detail::is_not_null_oracle<U>::value),
                                    int>::type = 0>
        gsl_constexpr14 explicit operator U() && {
            gsl_Ensures(data_.ptr_ != gsl_nullptr);
        ...
        template <class U
                  ...
                  typename std::enable_if<
                      (std::is_constructible<U, T const &>::value &&
                       ...
                       !detail::is_not_null_oracle<U>::value),
                      int>::type = 0>
        gsl_constexpr14 operator U() const
#if gsl_HAVE(FUNCTION_REF_QUALIFIER)
            &
#endif
        {
        ...
        template <
            ...
            typename std::enable_if<(std::is_convertible<T, U>::value &&
                                     !detail::is_not_null_oracle<U>::value),
                                    int>::type = 0>
        gsl_constexpr14 operator U() && {
            gsl_Ensures(data_.ptr_ != gsl_nullptr);
            return std::move(data_.ptr_);
        }
#endif
#else  // a.k.a. #if !( gsl_HAVE( RVALUE_REFERENCE ) && gsl_HAVE( TYPE_TRAITS )
       // && gsl_HAVE( DEFAULT_FUNCTION_TEMPLATE_ARG ) && gsl_HAVE( EXPLICIT ) )
        template <class U> gsl_constexpr14 operator U() const {
            gsl_Ensures(data_.ptr_ != gsl_nullptr);
            return data_.ptr_;
        }
#endif // gsl_HAVE( RVALUE_REFERENCE ) && gsl_HAVE( TYPE_TRAITS ) && gsl_HAVE(
       // DEFAULT_FUNCTION_TEMPLATE_ARG ) && gsl_HAVE( EXPLICIT )

        gsl_constexpr14 T const &operator->() const {
            gsl_Ensures(data_.ptr_ != gsl_nullptr);
            return data_.ptr_;
        }

        gsl_constexpr14 element_type &operator*() const {
            gsl_Ensures(data_.ptr_ != gsl_nullptr);
            return *data_.ptr_;
        }

#if gsl_HAVE(RVALUE_REFERENCE)
        // Visual C++ 2013 doesn't generate default move constructors, so we
    ...
    template <class U> not_null(U) -> not_null<U>;
    template <class U> not_null(not_null<U>) -> not_null<U>;
#endif
...
#if gsl_HAVE(RVALUE_REFERENCE)
    template <class U> not_null<U> make_not_null(U u) {
        return not_null<U>(std::move(u));
    }
    template <class U> not_null<U> make_not_null(not_null<U> u) {
        return std::move(u);
    }
#else  // a.k.a. !gsl_HAVE( RVALUE_REFERENCE )
    template <class U> not_null<U> make_not_null(U const &u) {
        return not_null<U>(u);
    }
    template <class U> not_null<U> make_not_null(not_null<U> const &u) {
        return u;
    }
#endif // gsl_HAVE( RVALUE_REFERENCE )
    ...
    template <class T> class not_null_ic : public not_null<T> {
      public:
    ...
    template <class T, class U>
    inline gsl_constexpr gsl_DECLTYPE_(bool, std::declval<T const>() ==
                                                 std::declval<U const>())
    ...
    template <class T, class U>
    inline gsl_constexpr gsl_DECLTYPE_(
        bool, !(std::declval<T const>() == std::declval<U const>()))
    operator!=(not_null<T> const &l, not_null<U> const &r) {
        return !(l == r);
    }
    template <class T, class U>
    ...
    template <class T, class U>
    inline gsl_constexpr gsl_DECLTYPE_(
        bool, !(std::declval<U const>() < std::declval<T const>()))
    operator<=(not_null<T> const &l, not_null<U> const &r) {
        return !(r < l);
    }
    template <class T, class U>
    ...
    template <class T, class U>
    inline gsl_constexpr gsl_DECLTYPE_(bool, std::declval<U const>() <
                                                 std::declval<T const>())
    operator>(not_null<T> const &l, not_null<U> const &r) {
        return r < l;
    }
    ...
    std::basic_ostream<CharType, Traits> &operator<<(
        std::basic_ostream<CharType, Traits> &os, not_null<T> const &p) {
...
//
    ...
    template <class IntegerType gsl_ENABLE_IF_(
    ...
    template <class IntegerType gsl_ENABLE_IF_(
        (std::is_integral<IntegerType>::value))>
    gsl_api inline gsl_constexpr14 byte &operator<<=(byte &b, IntegerType shift)
        gsl_noexcept {
#if gsl_HAVE(ENUM_CLASS_CONSTRUCTION_FROM_UNDERLYING_TYPE)
    ...
    template <class IntegerType gsl_ENABLE_IF_(
        (std::is_integral<IntegerType>::value))>
    gsl_api inline gsl_constexpr byte operator<<(byte b, IntegerType shift)
        gsl_noexcept {
    ...
    gsl_api inline gsl_constexpr14 byte &operator|=(byte &l, byte r)
        gsl_noexcept {
        l.v |= r.v;
        return l;
    }
    ...
    template <class T> class span {
      ...
      public:
        ...
        gsl_api gsl_constexpr14 span() gsl_noexcept : first_(gsl_nullptr),
                                                      last_(gsl_nullptr) {}
...
#if gsl_HAVE(IS_DELETE)
        gsl_DEPRECATED gsl_api gsl_constexpr span(reference data_in)
            : span(&data_in, 1) {}
        ...
        gsl_constexpr span(Container &cont)
            : first_(cont.size() == 0 ? gsl_nullptr : gsl_ADDRESSOF(cont[0])),
              last_(cont.size() == 0 ? gsl_nullptr
                                     : gsl_ADDRESSOF(cont[0]) + cont.size()) {}
        ...
        template <class ArrayElementType =
                      typename std::add_pointer<element_type>::type>
#else
        template <class ArrayElementType>
#endif
        gsl_DEPRECATED gsl_constexpr
    ...
    template< class U > operator=();
        ...
        gsl_api gsl_constexpr14 span subspan(index_type offset,
                                             index_type count) const {
            gsl_Expects(std::size_t(offset) <= std::size_t(this->size()) &&
                        std::size_t(count) <=
                            std::size_t(this->size() - offset));
        ...
        gsl_DEPRECATED_MSG("use subscript indexing instead") gsl_api
            gsl_constexpr14 reference
            operator()(index_type pos) const {
            return (*this)[pos];
        }

        gsl_DEPRECATED_MSG("use subscript indexing instead") gsl_api
            gsl_constexpr14 reference at(index_type pos) const {
            return (*this)[pos];
        }
#endif // deprecate
        ...
        gsl_DEPRECATED_MSG("use size() instead") gsl_api gsl_constexpr
            index_type length() const gsl_noexcept {
            return size();
        }

        // member length_bytes() deprecated since 0.29.0

        gsl_DEPRECATED_MSG("use size_bytes() instead") gsl_api gsl_constexpr
            index_type length_bytes() const gsl_noexcept {
            return size_bytes();
        }
#endif
        ...
        template <class U> gsl_api span<U> as_span() const {
    ...
    template <class T, class U>
    gsl_SUPPRESS_MSGSL_WARNING(stl .1) inline gsl_constexpr bool operator==(
    ...
    template <class T>
    gsl_api inline gsl_constexpr span<T> make_span(
        T * ptr, typename span<T>::index_type count) {
        return span<T>(ptr, count);
    }

    template <class T>
    gsl_api inline gsl_constexpr span<T> make_span(T * first, T * last) {
        return span<T>(first, last);
    }

    template <class T, size_t N>
    gsl_api inline gsl_constexpr span<T> make_span(T(&arr)[N]) {
    ...
    template <class T, size_t N>
    inline gsl_constexpr span<T> make_span(std::array<T, N> & arr) {
        return span<T>(arr);
    }

    template <class T, size_t N>
    inline gsl_constexpr span<const T> make_span(std::array<T, N> const &arr) {
    ...
    inline gsl_constexpr auto make_span(Container & cont)
    ...
    template <class Container,
              class EP = decltype(std17::data(std::declval<Container &>()))>
    inline gsl_constexpr auto make_span(Container const &cont)
    ...
    template <class T> inline span<T> make_span(std::vector<T> & cont) {
    ...
    template <class Container>
    inline gsl_constexpr span<typename Container::value_type> make_span(
        with_container_t, Container & cont) gsl_noexcept {
        return span<typename Container::value_type>(with_container, cont);
    }

    template <class Container>
    inline gsl_constexpr span<const typename Container::value_type> make_span(
...
#if !gsl_DEPRECATE_TO_LEVEL(4)
    template <class Ptr>
    gsl_DEPRECATED inline span<typename Ptr::element_type> make_span(Ptr &
                                                                     ptr) {
    ...
    template <class T>
    gsl_api inline gsl_constexpr span<byte> byte_span(T & t) gsl_noexcept {
        return span<byte>(reinterpret_cast<byte *>(&t), sizeof(T));
    }

    template <class T>
    gsl_api inline gsl_constexpr span<const byte> byte_span(T const &t)
        gsl_noexcept {
    ...
    template <class T> class basic_string_span;
    ...
    template <class T>
    struct is_basic_string_span_oracle<basic_string_span<T>>
        : std11::true_type {};

    template <class T>
    struct is_basic_string_span
        : is_basic_string_span_oracle<typename std11::remove_cv<T>::type> {};

    template <class T>
    gsl_api inline gsl_constexpr14 std::size_t string_length(T *ptr,
                                                             std::size_t max) {
    ...
    template <class T> class basic_string_span {
      public:
        ...
        typedef
            typename span_type::const_reverse_iterator const_reverse_iterator;
        ...
        gsl_api gsl_constexpr basic_string_span(pointer firstElem,
                                                pointer lastElem)
        ...
        gsl_constexpr basic_string_span(
            std::array<typename std11::remove_const<element_type>::type, N>
                &arr)
            : span_(remove_z(arr)) {}

        template <std::size_t N>
        gsl_constexpr basic_string_span(
            std::array<typename std11::remove_const<element_type>::type,
                       N> const &arr)
            : span_(remove_z(arr)) {}
...
#else
        gsl_constexpr
        basic_string_span(basic_string_span const &rhs) gsl_noexcept = default;

        gsl_constexpr
        basic_string_span(basic_string_span &&rhs) gsl_noexcept = default;
#endif
#endif

        template <class U gsl_ENABLE_IF_(
            (std::is_convertible<typename basic_string_span<U>::pointer,
                                 pointer>::value))>
        gsl_api gsl_constexpr basic_string_span(basic_string_span<U> const &rhs)
            : span_(reinterpret_cast<pointer>(rhs.data()),
                    rhs.length()) // NOLINT
        {}
        ...
        gsl_constexpr basic_string_span(
            std::basic_string<typename std11::remove_const<element_type>::type,
                              CharTraits, Allocator> &str)
            : span_(gsl_ADDRESSOF(str[0]), str.length()) {}

        template <class CharTraits, class Allocator>
        gsl_constexpr basic_string_span(
            std::basic_string<typename std11::remove_const<element_type>::type,
                              CharTraits, Allocator> const &str)
            : span_(gsl_ADDRESSOF(str[0]), str.length()) {}

        // assignment:

#if gsl_HAVE(IS_DEFAULT)
        gsl_constexpr14 basic_string_span &
        operator=(basic_string_span const &rhs) gsl_noexcept = default;

        gsl_constexpr14 basic_string_span &
        operator=(basic_string_span &&rhs) gsl_noexcept = default;
#endif
        ...
        /*gsl_api*/ // currently disabled due to an apparent NVCC bug
        gsl_constexpr14 basic_string_span subspan(index_type offset,
                                                  index_type count) const {
        ...
        gsl_api gsl_constexpr14 reference back() const { return span_.back(); }
      ...
      private:
        gsl_api static gsl_constexpr14 span_type remove_z(pointer const &sz,
                                                          std::size_t max) {
...
#if gsl_HAVE(ARRAY)
        template <size_t N>
        static gsl_constexpr14 span_type
        remove_z(std::array<typename std11::remove_const<element_type>::type, N>
                     &arr) {
        ...
        template <size_t N>
        static gsl_constexpr14 span_type
        remove_z(std::array<typename std11::remove_const<element_type>::type,
                            N> const &arr) {
            return remove_z(gsl_ADDRESSOF(arr[0]), narrow_cast<std::size_t>(N));
        }
#endif
    ...
    template <class T, class U>
    gsl_SUPPRESS_MSGSL_WARNING(stl .1) inline gsl_constexpr14 bool operator==(
    ...
    template <class T,
              class U gsl_ENABLE_IF_((!detail::is_basic_string_span<U>::value))>
    gsl_SUPPRESS_MSGSL_WARNING(stl .1) inline gsl_constexpr14 bool operator==(
    ...
    template <class T>
    gsl_SUPPRESS_MSGSL_WARNING(stl .1) inline gsl_constexpr14 bool operator==(
        basic_string_span<T> const &l, basic_string_span<T> const &r)
        gsl_noexcept {
        return l.size() == r.size() &&
               std::equal(l.begin(), l.end(), r.begin());
    }
    ...
    template <class T, class U>
    inline gsl_constexpr14 bool operator!=(basic_string_span<T> const &l,
                                           U const &r) gsl_noexcept {
        return !(l == r);
    }
    ...
    inline gsl_constexpr14 bool operator<=(basic_string_span<T> const &l,
                                           U const &r) gsl_noexcept {
#if gsl_HAVE(DEFAULT_FUNCTION_TEMPLATE_ARG) ||                                 \
    !gsl_CONFIG(ALLOWS_NONSTRICT_SPAN_COMPARISON)
        return !(r < l);
#else
    ...
    template <class T,
              class U gsl_ENABLE_IF_((!detail::is_basic_string_span<U>::value))>
    inline gsl_constexpr14 bool operator!=(
        U const &l, basic_string_span<T> const &r) gsl_noexcept {
        return !(l == r);
    }
    ...
    template <class T>
    gsl_api inline span<const byte> as_bytes(basic_string_span<T> spn)
        gsl_noexcept {
        return span<const byte>(reinterpret_cast<const byte *>(spn.data()),
                                spn.size_bytes()); // NOLINT
    }
...
inline std::basic_string< typename std::remove_const<T>::type > to_string( basic_string_span<T> spn )
{
    ...
    Stream &write_to_stream(Stream &os, Span const &spn) {
        ...
        const bool left_pad =
            pad &&
            (os.flags() & std::ios_base::adjustfield) == std::ios_base::right;
    ...
    std::basic_ostream<char, Traits> &operator<<(
        std::basic_ostream<char, Traits> &os, string_span const &spn) {
        return detail::write_to_stream(os, spn);
    }

    template <typename Traits>
    std::basic_ostream<char, Traits> &operator<<(
        std::basic_ostream<char, Traits> &os, cstring_span const &spn) {
        return detail::write_to_stream(os, spn);
    }
    ...
    template <typename Traits>
    std::basic_ostream<wchar_t, Traits> &operator<<(
        std::basic_ostream<wchar_t, Traits> &os, wstring_span const &spn) {
        return detail::write_to_stream(os, spn);
    }

    template <typename Traits>
    std::basic_ostream<wchar_t, Traits> &operator<<(
        std::basic_ostream<wchar_t, Traits> &os, cwstring_span const &spn) {
        return detail::write_to_stream(os, spn);
    }
    ...
    gsl_api static span<T>
    ensure_sentinel(T *seq,
                    SizeType max = (std::numeric_limits<SizeType>::max)()) {
        typedef T *pointer;

        gsl_SUPPRESS_MSVC_WARNING(
            26429, "f.23: symbol 'cur' is never tested for nullness, it can be "
                   "marked as not_null") pointer cur = seq;
        ...
        return span<T>(seq,
                       narrow_cast<typename span<T>::index_type>(cur - seq));
    }
    } // namespace detail
    ...
    template <typename T> class basic_zstring_span {
      public:
        typedef T element_type;
        typedef span<T> span_type;
...
#if gsl_HAVE(IS_DEFAULT)
        gsl_constexpr
        basic_zstring_span(basic_zstring_span const &other) = default;
        gsl_constexpr basic_zstring_span(basic_zstring_span &&other) = default;
        gsl_constexpr14 basic_zstring_span &
        operator=(basic_zstring_span const &other) = default;
        gsl_constexpr14 basic_zstring_span &
        operator=(basic_zstring_span &&other) = default;
#else
        gsl_api gsl_constexpr
        basic_zstring_span(basic_zstring_span const &other)
            : span_(other.span_) {}
        gsl_api gsl_constexpr basic_zstring_span &
        operator=(basic_zstring_span const &other) {
            span_ = other.span_;
            return *this;
        }
#endif
        ...
        gsl_api gsl_constexpr string_span_type
        as_string_span() const gsl_noexcept {
            return string_span_type(span_.data(),
                                    span_.size() > 1 ? span_.size() - 1 : 0);
        }
