...
public partial class NTT
{
    ...
    public static Expr Qwen3MoE(Expr hiddenStates, Expr moeGateW, Expr moeExpertGateProjW, Expr moeExpertGateProjScale, Expr moeExpertDownProjW, Expr moeExpertDownProjScale, Expr moeExpertUpProjW, Expr moeExpertUpProjScale, Expr ret, long layerId, long hiddenSize, long intermediateSize, long moeIntermediateSize, long numExpert, long numTopK, long isNormTopkProb)
    {
        return new Call(new TIR.NTT.Qwen3MoE(layerId, hiddenSize, intermediateSize, moeIntermediateSize, numExpert, numTopK, isNormTopkProb), hiddenStates, moeGateW, moeExpertGateProjW, moeExpertGateProjScale, moeExpertDownProjW, moeExpertDownProjScale, moeExpertUpProjW, moeExpertUpProjScale, ret);
    }
}
