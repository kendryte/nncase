...
public partial class NTT
{
    ...
    {
        return new Call(new PackedMatMul(DataTypes.Float32, QuantizedWeightsInfo.Default, lhsPackedAxes, lhsPadedNums, rhsPackedAxes, rhsPadedNums, transA, transB, fusedReduce), lhs, rhs);
    }

    public static Expr PackedMatMul(Expr lhs, Expr rhs, IRArray<int> lhsPackedAxes, IRArray<int> lhsPadedNums, IRArray<int> rhsPackedAxes, IRArray<int> rhsPadedNums, bool transA = false, bool transB = false, bool fusedReduce = false, DataType outDataType = null!)
    {
        return new Call(new PackedMatMul(outDataType, QuantizedWeightsInfo.Default, lhsPackedAxes, lhsPadedNums, rhsPackedAxes, rhsPadedNums, transA, transB, fusedReduce), lhs, rhs);
    }

    public static Expr PackedMatMul(Expr lhs, Expr rhs, IRArray<int> lhsPackedAxes, IRArray<int> lhsPadedNums, IRArray<int> rhsPackedAxes, IRArray<int> rhsPadedNums, bool transA = false, bool transB = false, bool fusedReduce = false, DataType outDataType = null!, QuantizedWeightsInfo quantizedWeightsInfo = null!)
    {
        return new Call(new PackedMatMul(outDataType, quantizedWeightsInfo, lhsPackedAxes, lhsPadedNums, rhsPackedAxes, rhsPadedNums, transA, transB, fusedReduce), lhs, rhs);
    }
