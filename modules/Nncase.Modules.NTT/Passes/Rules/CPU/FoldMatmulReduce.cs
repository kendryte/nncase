...
public sealed partial class FoldPackedMatmulReduce : IRewriteRule
{
    ...
    public Expr? GetReplace(Call call, PackedMatMul mm, Expr lhs, Expr rhs)
    {
        ...
        {
            var newMatmul = new IR.NTT.PackedMatMul(mm.OutputDataType, mm.QuantizedWeightsInfo, mm.LhsPackedAxes, mm.LhsPadedNums, mm.RhsPackedAxes, mm.RhsPadedNums, mm.TransposeA, mm.TransposeB, true);
