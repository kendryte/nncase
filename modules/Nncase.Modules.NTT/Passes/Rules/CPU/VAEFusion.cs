...
public sealed partial class FuseVAEDecMHA : FusionMaker
{
    ...
    private static Pattern CreatePattern()
    {
        ...
        var v8 = IsMatMul(DataTypes.Float32, QuantizedWeightsInfo.Default, v7, IsTensorConst());
        var v9 = IsBinary(BinaryOp.Add, IsTensorConst(), v8);
        var v10 = IsMatMul(DataTypes.Float32, QuantizedWeightsInfo.Default, v7, IsTensorConst());
        var v11 = IsBinary(BinaryOp.Add, IsTensorConst(), v10);
        var v12 = IsTranspose(v11, IsTensorConst());
        var v13 = IsMatMul(DataTypes.Float32, QuantizedWeightsInfo.Default, v9, v12);
        ...
        var v17 = IsMatMul(DataTypes.Float32, QuantizedWeightsInfo.Default, v7, IsTensorConst());
        var v18 = IsBinary(BinaryOp.Add, IsTensorConst(), v17);
        var v19 = IsMatMul(DataTypes.Float32, QuantizedWeightsInfo.Default, v16, v18);
        var v20 = IsMatMul(DataTypes.Float32, QuantizedWeightsInfo.Default, v19, IsTensorConst());
