...
template <>
struct op_reader<comp_shape_op_t>
{
    comp_shape_op_t operator()(span_reader &reader) const
    {
        comp_shape_op_t op(default_init);
        op.opcode = static_cast<opcode_t>(reader.read_unaligned<uint8_t>());
...
template <>
struct op_reader<comp_paddings_op_t>
{
    comp_paddings_op_t operator()(span_reader &reader) const
    {
        comp_paddings_op_t op(default_init);
        op.opcode = static_cast<opcode_t>(reader.read_unaligned<uint8_t>());
...
public:
    ...
    virtual std::error_condition visit(const comp_shape_op_t &op) noexcept { return {}; }
    virtual std::error_condition visit(const comp_paddings_op_t &op) noexcept { return {}; }
