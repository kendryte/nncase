/* This file is generated by tools/stackvm_gen/IsaGen at 8/15/2022 1:28:41 PM +08:00.
 *
...
template <>
struct op_reader<tensor_cumsum_op_t>
{
    tensor_cumsum_op_t operator()(span_reader &reader) const
    {
        tensor_cumsum_op_t op(default_init);
        op.opcode = static_cast<opcode_t>(reader.read_unaligned<uint8_t>());
        op.funct = static_cast<tensor_function_t>(reader.read_unaligned<uint16_t>());
        op.datatype = static_cast<datatype_t>(reader.read_unaligned<uint8_t>());
        op.rshape_src = reader.read_unaligned<uint8_t>();
        op.axis = reader.read_unaligned<int32_t>();
        op.exclusive = reader.read_unaligned<bool>();
        op.reverse = reader.read_unaligned<bool>();
        return op;
    }
};
...
{
    tensor_hardmax_op_t operator()(span_reader &reader) const
    {
        tensor_hardmax_op_t op(default_init);
        op.opcode = static_cast<opcode_t>(reader.read_unaligned<uint8_t>());
        op.funct = static_cast<tensor_function_t>(reader.read_unaligned<uint16_t>());
        op.datatype = static_cast<datatype_t>(reader.read_unaligned<uint8_t>());
        op.rshape_src = reader.read_unaligned<uint8_t>();
...
template <>
struct op_reader<tensor_matmul_op_t>
{
    tensor_matmul_op_t operator()(span_reader &reader) const
    {
        tensor_matmul_op_t op(default_init);
        op.opcode = static_cast<opcode_t>(reader.read_unaligned<uint8_t>());
        op.funct = static_cast<tensor_function_t>(reader.read_unaligned<uint16_t>());
        op.rshape_src1 = reader.read_unaligned<uint8_t>();
        op.rstride_src1 = reader.read_unaligned<uint8_t>();
...
template <>
struct op_reader<tensor_random_normal_op_t>
{
    tensor_random_normal_op_t operator()(span_reader &reader) const
    {
        tensor_random_normal_op_t op(default_init);
        op.opcode = static_cast<opcode_t>(reader.read_unaligned<uint8_t>());
        op.funct = static_cast<tensor_function_t>(reader.read_unaligned<uint16_t>());
        op.datatype_dest = static_cast<datatype_t>(reader.read_unaligned<uint8_t>());
        op.rshape_dest = reader.read_unaligned<uint8_t>();
        op.mean = reader.read_unaligned<float>();
        op.std = reader.read_unaligned<float>();
        op.seed = reader.read_unaligned<float>();
        return op;
    }
};

template <>
struct op_reader<tensor_random_uniform_op_t>
{
    tensor_random_uniform_op_t operator()(span_reader &reader) const
    {
        tensor_random_uniform_op_t op(default_init);
        op.opcode = static_cast<opcode_t>(reader.read_unaligned<uint8_t>());
        op.funct = static_cast<tensor_function_t>(reader.read_unaligned<uint16_t>());
        op.datatype_dest = static_cast<datatype_t>(reader.read_unaligned<uint8_t>());
        op.rshape_dest = reader.read_unaligned<uint8_t>();
        op.low = reader.read_unaligned<float>();
        op.high = reader.read_unaligned<float>();
        op.seed = reader.read_unaligned<float>();
        return op;
    }
};
...
{
    tensor_reduce_arg_op_t operator()(span_reader &reader) const
    {
        tensor_reduce_arg_op_t op(default_init);
        op.opcode = static_cast<opcode_t>(reader.read_unaligned<uint8_t>());
        op.funct = static_cast<tensor_function_t>(reader.read_unaligned<uint16_t>());
        op.datatype_src = static_cast<datatype_t>(reader.read_unaligned<uint8_t>());
        op.rshape_src = reader.read_unaligned<uint8_t>();
        op.rstride_src = reader.read_unaligned<uint8_t>();
        op.datatype_dest = static_cast<datatype_t>(reader.read_unaligned<uint8_t>());
        op.rstride_dest = reader.read_unaligned<uint8_t>();
        ...
        op.rshape_axis = reader.read_unaligned<uint8_t>();
        op.keep_dims = reader.read_unaligned<bool>();
        op.select_last_idx = reader.read_unaligned<bool>();
        return op;
    }
};

template <>
struct op_reader<tensor_reduce_prod_op_t>
{
    tensor_reduce_prod_op_t operator()(span_reader &reader) const
    {
        ...
        op.rstride_src = reader.read_unaligned<uint8_t>();
        op.rstride_dest = reader.read_unaligned<uint8_t>();
        op.rshape_axes = reader.read_unaligned<uint8_t>();
        op.keep_dims = reader.read_unaligned<bool>();
        return op;
    }
};
...
template <>
struct op_reader<tensor_roi_align_op_t>
{
    tensor_roi_align_op_t operator()(span_reader &reader) const
    {
        tensor_roi_align_op_t op(default_init);
        op.opcode = static_cast<opcode_t>(reader.read_unaligned<uint8_t>());
        op.funct = static_cast<tensor_function_t>(reader.read_unaligned<uint16_t>());
        op.datatype = static_cast<datatype_t>(reader.read_unaligned<uint8_t>());
        op.rshape_src = reader.read_unaligned<uint8_t>();
        op.rshape_dest = reader.read_unaligned<uint8_t>();
        op.mode = static_cast<roi_align_mode_t>(reader.read_unaligned<uint8_t>());
        op.spatial_scale = reader.read_unaligned<float>();
        op.sampling_ratio = reader.read_unaligned<int64_t>();
        return op;
    }
};
...
{
    tensor_sigmoid_op_t operator()(span_reader &reader) const
    {
        tensor_sigmoid_op_t op(default_init);
        op.opcode = static_cast<opcode_t>(reader.read_unaligned<uint8_t>());
        op.funct = static_cast<tensor_function_t>(reader.read_unaligned<uint16_t>());
        op.datatype = static_cast<datatype_t>(reader.read_unaligned<uint8_t>());
        op.rshape_src = reader.read_unaligned<uint8_t>();
...
{
    tensor_softmax_op_t operator()(span_reader &reader) const
    {
        tensor_softmax_op_t op(default_init);
        op.opcode = static_cast<opcode_t>(reader.read_unaligned<uint8_t>());
        op.funct = static_cast<tensor_function_t>(reader.read_unaligned<uint16_t>());
        op.datatype = static_cast<datatype_t>(reader.read_unaligned<uint8_t>());
        op.rshape_src = reader.read_unaligned<uint8_t>();
        ...
        op.rstride_dest = reader.read_unaligned<uint8_t>();
        op.axis = reader.read_unaligned<int32_t>();
        op.beta = reader.read_unaligned<float>();
        return op;
    }
};
...
struct op_reader<tensor_ternary_op_t>
{
    ...
    {
        tensor_ternary_op_t op(default_init);
        op.opcode = static_cast<opcode_t>(reader.read_unaligned<uint8_t>());
        op.funct = static_cast<tensor_function_t>(reader.read_unaligned<uint16_t>());
        op.datatype = static_cast<datatype_t>(reader.read_unaligned<uint8_t>());
        op.rshape_src1 = reader.read_unaligned<uint8_t>();
        ...
        op.rshape_src2 = reader.read_unaligned<uint8_t>();
        op.rstride_src2 = reader.read_unaligned<uint8_t>();
        op.rshape_src3 = reader.read_unaligned<uint8_t>();
        op.rstride_src3 = reader.read_unaligned<uint8_t>();
        op.rstride_dest = reader.read_unaligned<uint8_t>();
        return op;
    }
};
...
template <>
struct op_reader<tensor_topk_op_t>
{
    tensor_topk_op_t operator()(span_reader &reader) const
    {
        tensor_topk_op_t op(default_init);
        op.opcode = static_cast<opcode_t>(reader.read_unaligned<uint8_t>());
        op.funct = static_cast<tensor_function_t>(reader.read_unaligned<uint16_t>());
        op.datatype = static_cast<datatype_t>(reader.read_unaligned<uint8_t>());
        op.rshape_src = reader.read_unaligned<uint8_t>();
        op.rstride_src = reader.read_unaligned<uint8_t>();
        op.rshape_dest1 = reader.read_unaligned<uint8_t>();
        op.rstride_dest1 = reader.read_unaligned<uint8_t>();
        op.rshape_dest2 = reader.read_unaligned<uint8_t>();
        op.rstride_dest2 = reader.read_unaligned<uint8_t>();
        op.k = reader.read_unaligned<int64_t>();
        op.axis = reader.read_unaligned<int32_t>();
        op.largest = reader.read_unaligned<bool>();
        op.sorted = reader.read_unaligned<bool>();
        return op;
    }
};

template <>
struct op_reader<tensor_trilu_op_t>
{
    tensor_trilu_op_t operator()(span_reader &reader) const
    {
        tensor_trilu_op_t op(default_init);
        op.opcode = static_cast<opcode_t>(reader.read_unaligned<uint8_t>());
        op.funct = static_cast<tensor_function_t>(reader.read_unaligned<uint16_t>());
        op.datatype = static_cast<datatype_t>(reader.read_unaligned<uint8_t>());
        op.rshape_src = reader.read_unaligned<uint8_t>();
        op.upper = reader.read_unaligned<bool>();
        op.k = reader.read_unaligned<int64_t>();
        return op;
    }
};
...
struct op_reader<tensor_compress_op_t>
{
    tensor_compress_op_t operator()(span_reader &reader) const
    {
        ...
        op.output_shape_src = reader.read_unaligned<uint8_t>();
...
public:
    ...
    virtual result<void> visit(NNCASE_UNUSED const tensor_matmul_op_t &op) noexcept { return ok(); }
    ...
    virtual result<void> visit(NNCASE_UNUSED const tensor_random_normal_op_t &op) noexcept { return ok(); }
    virtual result<void> visit(NNCASE_UNUSED const tensor_random_uniform_op_t &op) noexcept { return ok(); }
    virtual result<void> visit(NNCASE_UNUSED const tensor_reduce_op_t &op) noexcept { return ok(); }
    virtual result<void> visit(NNCASE_UNUSED const tensor_reduce_arg_op_t &op) noexcept { return ok(); }
    virtual result<void> visit(NNCASE_UNUSED const tensor_reduce_prod_op_t &op) noexcept { return ok(); }
    ...
    virtual result<void> visit(NNCASE_UNUSED const tensor_roi_align_op_t &op) noexcept { return ok(); }
