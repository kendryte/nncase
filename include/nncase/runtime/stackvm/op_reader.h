/* This file is generated by tools/stackvm_gen/IsaGen at 2021/3/12 19:28:13 +08:00.
 *
...
public:
    ...
    virtual result<void> visit(const conv_i1_op_t &op) noexcept { return ok(); }
    virtual result<void> visit(const conv_i2_op_t &op) noexcept { return ok(); }
    virtual result<void> visit(const conv_i4_op_t &op) noexcept { return ok(); }
    virtual result<void> visit(const conv_i_op_t &op) noexcept { return ok(); }
    ...
    virtual result<void> visit(const tensor_broadcast_op_t &op) noexcept { return ok(); }
    virtual result<void> visit(const tensor_binary_op_t &op) noexcept { return ok(); }
    virtual result<void> visit(const tensor_call_op_t &op) noexcept { return ok(); }
    virtual result<void> visit(const tensor_concat_op_t &op) noexcept { return ok(); }
    virtual result<void> visit(const tensor_conv2d_op_t &op) noexcept { return ok(); }
    virtual result<void> visit(const tensor_dequantize_op_t &op) noexcept { return ok(); }
    virtual result<void> visit(const tensor_pad_op_t &op) noexcept { return ok(); }
    virtual result<void> visit(const tensor_quantize_op_t &op) noexcept { return ok(); }
    virtual result<void> visit(const tensor_reduce_op_t &op) noexcept { return ok(); }
    virtual result<void> visit(const tensor_slice_op_t &op) noexcept { return ok(); }
    virtual result<void> visit(const tensor_unary_op_t &op) noexcept { return ok(); }
    virtual result<void> visit(const tensor_transpose_op_t &op) noexcept { return ok(); }
