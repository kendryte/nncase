/* This file is generated by tools/stackvm_gen/IsaGen at 2023/2/3 下午4:34:08 +08:00.
 *
...
struct tensor_gru_op_t
{
    ...
    explicit tensor_gru_op_t(uint8_t input_shape_src, uint8_t w_shape_src, uint8_t direction, bool LBR) noexcept
        : opcode(opcode_t::TENSOR), funct(tensor_function_t::GRU), input_shape_src(input_shape_src), w_shape_src(w_shape_src), direction(direction), LBR(LBR)
    {
    }
};
