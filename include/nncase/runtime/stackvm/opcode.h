...
struct tensor_matmul_op_t
{
    ...
    explicit tensor_matmul_op_t(uint8_t rshape_src1, uint8_t rshape_src2, float fused_clamp_low, float fused_clamp_high) noexcept
        : opcode(opcode_t::TENSOR), funct(tensor_function_t::MATMUL), rshape_src1(rshape_src1), rshape_src2(rshape_src2), fused_clamp_low(fused_clamp_low), fused_clamp_high(fused_clamp_high)
    {
    }
};
