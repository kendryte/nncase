...
enum class tensor_function_t
{
    ...
    REDUCE = 0x0014,
    REDUCEARG = 0x0015,
    REDUCE_WINDOW2D = 0x0016,
    RESIZE_IMAGE = 0x0017,
    SLICE = 0x0018,
    SOFTMAX = 0x0019,
    SPACE_TO_BATCH = 0x001A,
    TAKE = 0x001B,
    TRANSPOSE = 0x001C,
    UNARY = 0x001D,
};
...
struct tensor_hardmax_op_t
{
    ...
    explicit tensor_hardmax_op_t(datatype_t datatype, uint8_t rshape_src, uint8_t rstride_src, uint8_t rstride_dest, int32_t axis) noexcept
        : opcode(opcode_t::TENSOR), funct(tensor_function_t::HARDMAX), datatype(datatype), rshape_src(rshape_src), rstride_src(rstride_src), rstride_dest(rstride_dest), axis(axis)
    {
    }
};
