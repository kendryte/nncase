/* This file is generated by tools/stackvm_gen/IsaGen at 5/27/2022 12:28:49 AM +08:00.
 *
...
enum class tensor_function_t
{
    ...
    PAD = 0x0014,
    QUANTIZE = 0x0015,
    RANDOM_NORMAL = 0x0016,
    RANDOM_UNIFORM = 0x0017,
    REDUCE = 0x0018,
    REDUCE_ARG = 0x0019,
    REDUCE_PROD = 0x001A,
    REDUCE_WINDOW2D = 0x001B,
    RESIZE_IMAGE = 0x001C,
    ROI_ALIGN = 0x001D,
    SIGMOID = 0x001E,
    SLICE = 0x001F,
    SOFTMAX = 0x0020,
    SPACE_TO_BATCH = 0x0021,
    TAKE = 0x0022,
    TERNARY = 0x0023,
    TOPK = 0x0024,
    TRANSPOSE = 0x0025,
...
struct tensor_gru_op_t
{
    ...
    explicit tensor_gru_op_t(uint8_t input_shape_src, uint8_t w_shape_src) noexcept
        : opcode(opcode_t::TENSOR), funct(tensor_function_t::GRU), input_shape_src(input_shape_src), w_shape_src(w_shape_src)
    {
    }
};
