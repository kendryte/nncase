...
struct tensor_compress_op_t
{
    ...
    uint8_t output_shape_src;
    float axis;

    tensor_compress_op_t(default_init_t) noexcept { }
    explicit tensor_compress_op_t(uint8_t input_shape_src, uint8_t condition_shape_src, uint8_t output_shape_src, float axis) noexcept
        : opcode(opcode_t::TENSOR), funct(tensor_function_t::COMPRESS), input_shape_src(input_shape_src), condition_shape_src(condition_shape_src), output_shape_src(output_shape_src), axis(axis)
    {
    }
};
