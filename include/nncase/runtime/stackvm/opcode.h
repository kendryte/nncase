/* This file is generated by tools/stackvm_gen/IsaGen at 1/14/2022 2:00:38 PM +08:00.
 *
...
struct tensor_sigmoid_op_t
{
    ...
    explicit tensor_sigmoid_op_t(datatype_t datatype, uint8_t rshape_src, uint8_t rstride_src) noexcept
        : opcode(opcode_t::TENSOR), funct(tensor_function_t::SIGMOID), datatype(datatype), rshape_src(rshape_src), rstride_src(rstride_src)
    {
    }
};
