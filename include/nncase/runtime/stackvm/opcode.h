...
struct tensor_reduce_prod_op_t
{
    ...
    explicit tensor_reduce_prod_op_t(uint8_t rshape_src, uint8_t rshape_dest, uint8_t rshape_axes) noexcept
        : opcode(opcode_t::TENSOR), funct(tensor_function_t::REDUCE_PROD), rshape_src(rshape_src), rshape_dest(rshape_dest), rshape_axes(rshape_axes)
    {
    }
};
