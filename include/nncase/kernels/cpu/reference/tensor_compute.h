...
NNCASE_API result<void> gather(datatype_t in_type, datatype_t indices_type, const gsl::byte *input, gsl::byte *output, const runtime_shape_t &in_shape, const runtime_shape_t &out_shape,
    const runtime_shape_t &in_strides, const runtime_shape_t &out_strides, const gsl::byte *indices, const runtime_shape_t &indices_shape, int32_t axis, int32_t batch_dims, kernel_context &context = default_kernel_context()) noexcept;
