...
public:
    ...
    virtual void register_quantize_passes(const module_type_t &type, ir::transforms::pass_manager &pass_mgr, datatype_t quant_type, datatype_t w_quant_type, bool use_mse_quant_w);
