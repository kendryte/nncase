...
public:
    ...
    virtual std::unique_ptr<codegen::module_builder> create_module_builder(const module_type_t &type, std::string_view module_name, const module_builder_params &params);
