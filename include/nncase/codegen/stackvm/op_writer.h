...
public:
    ...
    void conv_br2_();
    void conv_r4_();
    void tensor_batch_to_space_(datatype_t datatype, uint8_t rshape_src, uint8_t rshape_block, uint8_t rpaddings);
    void tensor_conv2d_(datatype_t datatype, uint8_t rshape_src, uint8_t rshape_kernel, uint16_t groups, uint16_t stride_h, uint16_t stride_w, uint16_t dilation_h, uint16_t dilation_w, float fused_clamp_low, float fused_clamp_high);
    void tensor_reduce_(datatype_t datatype, uint8_t rshape_src, reduce_op_t reduce_op, uint8_t rshape_axis);
    void tensor_binary_(datatype_t datatype, uint8_t rshape_src1, uint8_t rshape_src2, binary_op_t binary_op, float fused_clamp_low, float fused_clamp_high);
    void tensor_unary_(datatype_t datatype, uint8_t rshape_src, unary_op_t unary_op);
