...
void import_pnnx(ir::graph &graph, std::span<const uint8_t> paramfile, std::span<const uint8_t> binfile, const import_options &options, std::string &real_inlayout, std::string &real_outlayout);
}
